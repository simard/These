	...
	\begin{mychapter}[cha-sota-EtudeBibliographique]{Étude bibliographique}
		...
		\begin{mysection}[sec-sota-ContexteDeTravail-LaModelisationMoleculaire]{Contexte de travail : la modélisation moléculaire}
			...
			\begin{mysubsection}[sse-sota-PlateformesCollaborativesPourLaBiologieMoleculaire]{Plateformes collaboratives pour la biologie moléculaire}
				...
				\mycite[author]{Chastine-2005} sont parmis les premiers à identifier les problématiques de communication entre les sujets au sein des applications collaboratives et interactives \myref*{sss-sota-LaConscienceDeGroupe}.
		...
		\begin{mysection}[sec-sota-ConfigurationCollaborativePourLaResolutionDesTachesComplexes]{Configuration collaborative pour la résolution des tâches complexes}
			...
			\begin{mysubsection}[sse-sota-LaParesseSociale]{La paresse sociale}
				...
				Cependant, \mycite[author]{Chidambaram-2005} constatent un effet parallèle : certains membres du groupe donne simplement l'impression qu'ils travaillent sans être réellement efficaces.
		...
		\begin{mysection}[sec-sota-CollaborationEnEnvironnementVirtuel]{Collaboration en environnement virtuel}
			...
			\begin{mysubsection}[sse-sota-StrategiesDeCollaboration]{Stratégies de collaboration}
				...
				\begin{mysubsubsection}[sss-sota-CollaborationAPlusieursUtilisateurs]{Collaboration à plusieurs utilisateurs}
					...
					En proposant des rôles strictement identiques aux utilisateurs, ce type de scénario tend à favoriser la \myglos{glo-ParesseSociale} en ne fournissant pas d'éléments pour une identification distincte de rôles différents.
					...
					Toutefois, \mycite[author]{Buisine-2011} soulignent qu'un accès aux artefacts équitablement distribué entre les utilisateurs permet de réduire la \myglos{glo-ParesseSociale} en évitant l'isolement d'un des membres du groupe.
				\end{mysubsubsection}
				\begin{mysubsubsection}[sss-sota-CollaborationAPlusieursExperts]{Collaboration à plusieurs experts}
					Dans cette configuration illustrée sur la \myref*{fig-sota-CollaborationAPlusieursExperts}, chaque utilisateur est expert d'un domaine de compétence différent de ces collaborateurs.
...
vmd> set mysel [atomselect "top" "name C or name O or name N or name CA"]
	...
	\begin{mychapter+}[cha-ConclusionEtPerspectives]{Conclusion et perspectives}
		...
		Cette novuelle configuration de travail a montré son efficacité dans la dernière expérimentation \myref*{cha-TravailCollaboratifAssisteParHaptique} dans laquelle des évolutions significatives en terme de communication ont été observées.
	...
	\begin{mychapter}[cha-Questionnaires]{Questionnaires}
		...
		\begin{mysection}[sec-q-SecondeExperimentation]{Seconde expérimentation}
			...
			\begin{mysubsection}[sse-q-SecondeExperimentation-QuestionnairePourLesMonomes]{Questionnaire pour les monômes}
				...
				\end{enumerate}
			\end{mysubsection}
			\begin{mysubsection}[sse-q-SecondeExperimentation-QuestionnairePourLesBinomes]{Questionnaire pour les binôme}
