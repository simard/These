\documentclass[ngerman,english,french,12pt,minitoc,smarttab]{mythesis}
\usepackage{my}
\usepackage{mydate}
...
\jury{%
	\jurymember{Directeur de recherche}{Jean-Daniel}{Fekete}{président}{Université de \myname{Paris}-Sud -- Pôle Commun de Recherche en Informatique (\myPCRI)}
...
\begin{document}
	\loadgeometry{LIMSI}
	\pagestyle{empty}
	\Reference{2012 - 11}{Mars 2012}

	\TitreEtAuteurs{Collaboration haptique étroitement couplée pour la déformation moléculaire interactive}
	{J. \textsc{Simard}}
	...
	\begin{myabstract}[french]
		Le \myglos{glo-DockingMoleculaire} consiste à assembler deux molécules pour former une structure stable.
		...
		Nous identifions les apports et les contraintes de cette configuration de travail afin de caractériser des stratégies de travail.
		Les résultats mettent en avant de nombreux problèmes de communication liés à des \myglos*{glo-ConflitDeCoordination}.

		Sur la base de ces résultats, une nouvelle configuration de travail a été proposée pour favoriser et améliorer la communication et la coordination haptique.
	...
	\begin{mychapter+}{Publications}
		...
		\nocite{Girard-2012b}
		\nocite{Albert-2010}
		\vspace{-1.2ex plus -0.8ex minus -0.2ex}
		\defbibheading{bibliography}{\large\bfseries\sffamily Journaux internationaux avec comité de relecture}
		\printbibliography[type=article,category=myrefs]
		\vspace{2.3ex plus .2ex}
		\defbibheading{bibliography}{\large\bfseries\sffamily Conférences internationales avec comité de relecture}
		\printbibliography[type=inproceedings,category=myrefs]
	\end{mychapter+}
	\begin{mychapter+}{Remerciements}
		Facile, me direz vous, de se souvenir et de remercier un ensemble de collègues et d'amis avec lesquels j'ai travaillé, j'ai échangé voire même débattu ?
		Sans nul doute !
		Mais comment remercier les témoins de cette aventure avec la générosité et l'attention qu'ils ont eu pour moi.

		Vaguement impliqué\footnote{Humour, évidemment.}, Mehdi \myname{Ammi} a, avec une grande détermination, un engagement certain et une persévérance inébranlable, encadré ce projet avec un optimisme à toute épreuve.
		Malgré un rythme de travail plutôt asphy-xiant, le résultat est à la hauteur de l'ambition. Merci.

		Toutefois, restreindre ces remerciements à mon encadrant scientifique serait une erreur.

		Rares sont les doctorants qui ont pu se trouver dans une situation de travail exceptionnelle comme celle qu'a été la mienne.
		Un laboratoire traitant de spécialités aussi diverses et variées est une chance.
		C'est avec plaisir que j'ai tissé des liens et créer des collaborations avec ces autres chercheurs qui m'ont enseigné (ou tenté) leur discipline.
		Ce sont ces collègues qui m'ont permis de réussir mon travail.
		Merci Sonia, Maxime, Malika, Anaïs, Céline, Nicolas\dots{}

		Avec presque quatre ans passés au laboratoire du \myacro-{acr-LIMSI}, ce sont de vrais amis que j'ai aussi rencontré.
		Les liens durables se sont vraiment forgés en travaillant mais aussi lors de soirées ou encore de weekends entier de camping alpin ou de villégiature en Normandie.

		Musicovore barbu, chevelu révolutionnaire, dramaphile japonisante, éternel optimiste multicolore, chauve dynamique\footnote{\dots des fluides !}, défenseur des pythons, casse-cou invétéré, danseuse de tradition, merci à vous.

		Pour terminer, c'est l'ensemble de mes proches et la famille que je souhaite ouvertement remercier.
		Leur présence et leur soutien se sont révélés autant utile à ce projet que le travail accompli.
		Mes parents, mon frère et sa moitié restent les principaux acteurs de ces encouragements. Merci.

		Les dernières lignes de ces remerciements sont adressées à ma tendre bien-aimée pour un soutien sans faille malgré un quotidien parfois difficile.

		Véritable pilier de mon équilibre instable lié à une charge de travail trop importante,
		elle a toujours su quand me réconforter ou quand me bousculer en fonction des situations mais toujours avec justesse.
		\mychinese{真心感谢你。}
	\end{mychapter+}
	\mytoc
	\mylof
	...
	\ifintro
	\mainmatter
	\begin{mychapter+}[cha-IntroductionGenerale]{Introduction générale}
		...
		Puis, la complexité du \myglos{glo-DockingMoleculaire} amène les biologistes à proposer des solutions collaboratives.
		La collaboration permet de distribuer la charge de travail ou de tirer parti de différentes expertises.
		Des \myacro*{acr-EVC}, distants ou colocalisés, ont été proposées mais ce sont principalement les aspects techniques ou technologiques qui sont présentés; l'aspect social de la collaboration est peu abordé.
		De plus, la grande majorité des \myacro*{acr-EVC} étudiés proposent des collaborations faiblement couplées limitant ainsi une partie du potentiel collaboratif (communication instantanée, interaction immédiate, \myetc).
		...
		Nous commencerons par y présenter le \myglos{glo-DockingMoleculaire} et la complexité que représente ce problème ainsi que les différentes plateformes, collaboratives ou non, qui ont contribué à faire avancer le domaine.
		...
		Dans le \myref{cha-Shaddock-ManipulationCollaborativeDeMolecules}, nous présenterons la plateforme \myShaddock développée dans le cadre de cette thèse pour répondre aux contraintes identifiées au cours de l'étude bibliographique.
		...
		Le \myref{cha-RechercheCollaborativeDeResiduSurUneMolecule} s'intéresse aux processus d'exploration et de sélection collaborative de structures moléculaires afin d'identifier des stratégies de groupe et d'étudier l'évolution des performances.
		Puis, le \myref{cha-DeformationCollaborativeDeMolecule} propose de comparer les performances de différentes répartitions des ressources entre les utilisateurs sur une tâche de déformation moléculaire.
		Enfin, la dernière étude exposée dans le \myref{cha-LaDynamiqueDeGroupe} étudie différentes configurations collaboratives pour observer les phénomènes de groupe apparaissant lors d'une déformation coordonnée de molécule.

		Sur la base des résultats de ces trois études de cas, le \myref{cha-TravailCollaboratifAssisteParHaptique} expose une nouvelle configuration de travail assistée par de nouveaux outils haptiques destinés à améliorer le processus de coordination et de communication.
	...
	\begin{mychapter}[cha-sota-EtudeBibliographique]{Étude bibliographique}
		\begin{mysection}[sec-sota-Introduction]{Introduction}
			Ce travail de thèse aborde de nombreux concepts, de la biologie moléculaire au système interactif temps-réel en passant par la psychologie sociale.
		...
		\begin{mysection}[sec-sota-ContexteDeTravail-LaModelisationMoleculaire]{Contexte de travail : la modélisation moléculaire}
			...
			\begin{mysubsection}[sse-sota-LeDockingMoleculaire]{Le \textit{docking} moléculaire}
				En modélisation moléculaire, le \myglos{glo-DockingMoleculaire} consiste à prédire la conformation optimale entre deux molécules afin de créer un complexe de molécules stable \myref*{fig-sota-ComplexeDeMoleculesAssembleAPartirDeDeuxMolecules}.
				Le \myglos{glo-DockingMoleculaire} permet soit de découvrir de nouvelles molécules (par assemblage de deux ou plusieurs molécules), soit de comprendre la nature d'un complexe de molécules obtenu par cristallographie\footnote{La cristallographie permet de déterminer les molécules présentes dans un complexe de molécules mais ne permet pas de déterminer avec précision comment elles sont assemblées.}.
				...
				\begin{myfigure}
					\psset{xunit=0.06666666\textwidth,yunit=0.05\textwidth}
					\def\mycircleletter(#1,#2)#3{%
						\rput(#1,#2){\pscirclebox*[fillcolor=myblue70]{\white #3}}%
					}
					\begin{myps}(-7.5,-9.5)(7.5,7.5)
						...
						\psline[linewidth=10pt,linecolor=myblue70]{->}(0,1)(0,-2)
			...
			\end{mysubsection}
			\begin{mysubsection}[sse-sota-RechercheDeSolutionsDeDockingMoleculaire]{Recherche de solutions de \textit{docking} moléculaire}
				...
				\begin{itemize}
					...
					\item Utiliser différentes conformations rigides d'une molécule \mycite{Meagher-2004};
				...
				\begin{mytable}
					\begin{mytabular}{^>{\hsize=0.2\textwidth}C->{\hsize=0.3\textwidth}C->{\hsize=0.4\textwidth}C}
						...
						\myAutoDock & Algorithme génétique & \mycite{Morris-1998} \mycite{Osterberg-2002} \\
						\mymiddlerule
						\myDOCK & Reconstruction incrémentale & \mycite{Ewing-2001} \\
						\mymiddlerule
						\myICMDocking & Méthode \myacro{acr-ICM} & \mycite{Abagyan-1994a} \mycite{Abagyan-1994b} \\
						\mymiddlerule
						\myGOLD & Algorithme génétique & \mycite{Jones-1997} \\
						\mymiddlerule
						\myFlexX & Reconstruction incrémentale & \mycite{Rarey-1997} \mycite{Rarey-1999} \\
						\mymiddlerule
						\myGlide & Méthode de \myname{Monte-Carlo} & \mycite{Friesner-2004} \mycite{Halgren-2004} \\
						\mymiddlerule
						\myBoxSearch & Méthode de \myname{Monte-Carlo} & \mycite{Hart-1992} \mycite{Cummings-1995} \\
						\mybottomrule
					\end{mytabular}
			...
			\end{mysubsection}
			\begin{mysubsection}[sse-sota-DockingMoleculaireEnEnvironnementVirtuel]{\textit{Docking} moléculaire en environnement virtuel}
				Malgré une communauté scientifique très active pour améliorer les solutions de \myglos{glo-DockingMoleculaire} existantes et se rapprocher toujours plus près de conditions biologiques réalistes, la complexité du problème rend difficile la découverte de solutions robustes.
				...
				\mycite[author]{Batter-1972} proposent les premières solutions d'immersion visuelle dans le cadre du projet \myGROPE.
				...
				En effet, les biologistes ont également éprouvé le besoin d'interagir avec les champs de force en action au sein d'une molécule (forces électrostatiques, forces de \myname[van der]{Waals}, \myetc).
				Le projet \myGROPEHaptic\footnote{Le projet \myGROPEHaptic a été réalisé dans le prolongement du projet \myGROPE.} se propose d'utiliser la modalité haptique pour interagir avec les molécules \mycite{Ouh-Young-1988,Brooks-1990}.
				Des plateformes immersives modulables pour la modélisation moléculaire sont apparues telle que \myHIMM (\textit{Highly Immersive Molecular Modeling}) \mycite{Drees-1996,Drees-1998}; cette plateforme permet entre autre de connecter des interfaces haptiques.
				...
				En tenant compte de la flexibilité des molécules, les besoins en interaction se sont affinés; il n'est plus question de modifier la position d'une molécule, on cherche à présent à modifier la position d'un atome ou d'un groupe d'atomes dans la molécule.
				...
				Puis \mycite[author]{Lee-2004} proposent de baser les modèles d'interactions haptiques sur l'approximation du champ de force décrit dans \mycite{Lennard-Jones-1924a,Lennard-Jones-1924b} \myref*{eq-sota-PotentielDeLennardJones}; ce modèle de force a l'avantage de permettre une bonne stabilité du retour haptique \myref*{fig-sota-PotentielDeLennardJones1924}.
				\begin{eqnarray}\label{eq-sota-PotentielDeLennardJones}
					V_{LJ} &=&\displaystyle 4\varepsilon \left[\left(\frac{\sigma}{r}\right)^{12} - \left(\frac{\sigma}{r}\right)^6\right] \\
					V_{LJ} &=&\displaystyle \varepsilon \left[\left(\frac{r_m}{r}\right)^{12} - 2 \left(\frac{r_m}{r}\right)^6\right]
				\end{eqnarray}
				...
				\begin{myfigure}
					...
					\begin{myps}(-0.5,-1)(5,2.25)
						...
						\uput[60](\myrm,0){\textcolor{myblue}{$r_m = 2^{\frac{1}{6}} \sigma$}}
				...
				Par exemple, \mycite[author]{Lai-Yuen-2005} proposent une interface haptique avec cinq \myacro*{acr-DDL} \myref*{fig-sota-DockingMoleculaireALAideDUneInterfaceACinqDDLsLaiYuen2006} afin de manipuler et d'interagir avec des molécules durant un processus de \myglos{glo-DockingMoleculaire} \mycite{Lai-Yuen-2006}.
				Puis, à l'aide d'interfaces haptiques comme le \myVirtuose (six \myacro*{acr-DDL}), \mycite[author]{Daunay-2007} proposent de faire de la manipulation moléculaire puis du \myglos{glo-DockingMoleculaire} \mycite{Daunay-2009} avec une évaluation temps-réel de l'équilibre du complexe de molécules.
				Le \myglos{glo-DockingMoleculaire} faisant intervenir des champs de force spécifiques, \mycite[author]{Hou-2010} proposent des modèles haptiques permettant de ressentir les moments\footnote{Utilisé ici dans le sens mécanique, force autour d'un pivot (moment ou couple).} que subit le ligand au niveau des liaisons intra-moléculaires ou inter-moléculaires.
				...
				D'un côté, \mycite[author]{Redon-2005} développent des algorithmes pour la simulation en temps-réel de corps articulés avec un grand nombre de \myacro*{acr-DDL}.
				À partir de ce travail, il créé un moteur de simulation moléculaire permettant d'obtenir des simulations temps-réel \mycite{Rossi-2007}, utilisable pour la manipulation haptique \mycite{Bolopion-2009}.
				Parallèlement à ces travaux, \mycite[author]{Delalande-2009} proposent un outil permettant d'obtenir des simulations moléculaires en temps-réel en utilisant les moteurs de simulation existants.
				\mycite[author]{Delalande-2010} utilisent cette plateforme pour la manipulation haptique temps-réel de molécules en proposant la déformation des structures au niveau atomique.
				...
				En fournissant tous ces outils de visualisation et d'interaction avec des environnement moléculaires virtuels, les biologistes peuvent à présent interagir en temps-réel avec des molécules \mycite{Stone-2010}.
				Cependant, la complexité du problème de \myglos{glo-DockingMoleculaire} est suffisamment importante pour nécessiter la présence de plusieurs collaborateurs au sein de l'environnement de travail; on parle de travail collaboratif.
			...
			\begin{mysubsection}[sse-sota-PlateformesCollaborativesPourLaBiologieMoleculaire]{Plateformes collaboratives pour la biologie moléculaire}
				Les applications collaboratives en biologie moléculaire ont commencé à être développées pour principalement répondre à deux contraintes : le travail à distance et la multi-expertise que nécessite le problème de \myglos{glo-DockingMoleculaire}.
				L'une des premières applications a été proposée par \mycite[author]{Casher-1995} sous le nom de \myEyeChem.
				...
				Sur le même principe, \mycite[author]{Bourne-1998} développent \myMICE (\textit{Molecular Interactive Collaborative Environment}), permettant de visualiser des molécules en collaboration distante et d'éditer textuellement les fichiers de description.
				...
				\mycite[author]{Tate-2001} étendent les possibilités de \myMICE en permettant l'édition, la manipulation et l'interaction de molécules par restriction des accès concurrents entre les utilisateurs.
				Avec \myChimera, \mycite[author]{Pettersen-2004} permet l'édition des paramètres d'affichage \myThreeD pour des molécules de quelques centaines d'atomes par plusieurs utilisateurs de manière simultanée; les modifications effectuées par un utilisateur sont immédiatement reportées vers les autres, l'objectif étant d'explorer une molécule.

				Sur la base de la plateforme de \mycite[author]{Kim-2004b} utilisant les gestes pour manipuler les structures moléculaires, \mycite[author]{Park-2006} proposent un système distribué de collaboration distante.
				C'est l'une des premières applications qui aborde le problème du \myglos{glo-DockingMoleculaire} en collaboration.
				...
				Plus récemment, le projet \myeMinerals de \mycite[author]{Dove-2005} fournit une solution pour la collaboration entre biologistes (messagerie instantanée, vidéo-conférence, serveur centralisé, \myetc) comme on peut le voir sur la \myref{fig-sota-PlateformePourLaCollaborationEntreUniversiteProposeeParDove2005}.
				...
				\begin{myfigure}
					...
					\mycaption[fig-sota-PlateformePourLaCollaborationEntreUniversiteProposeeParDove2005]{Plateforme pour la collaboration entre universités proposée par \mycite{Dove-2005}}
				\end{myfigure}

				\mycite[author]{Chastine-2005} sont parmi les premiers à identifier les problématiques de communication entre les sujets au sein des applications collaboratives et interactives \myref*{sss-sota-LaConscienceDeGroupe}.
				À travers l'application \myAMMPVis, ils proposent des outils pour désigner des zones d'intérêt sur des molécules.
				Afin d'améliorer la communication, les mains de chaque utilisateur sont représentées dans l'environnement virtuel pour que chacun ait conscience des actions des partenaires \myref*{fig-sota-ManipulationCollaborativeDeMoleculeAvecRepresentationDesMainsDesParticipantsChastine2005}.
				...
				Pour éviter les conflits entre les utilisateurs (accès simultané, modification d'un même élément, \myetc), les différentes strates d'informations (paramètres de visualisation, modélisation, modification des données) ont été soumises à différents droits de visualisation et de modification \mycite{Ma-2007,Ma-2007a}.
				...
				L'application \myPaulingWorld \mycite{Su-2000,Su-2001} propose une des premières applications de collaboration colocalisée pour la visualisation de molécules et l'interaction à l'aide de menus.
				La visualisation s'effectue sur un \myWorkbench ce qui permet aux utilisateurs d'avoir des niveaux d'interaction similaires dans l'application (même accès aux ressources, même outil de visualisation, \myetc).
				Pour améliorer l'immersion, \mycite[author]{Kriz-2003} proposent avec leur application \myDIVERSE d'immerger plusieurs utilisateurs dans \myCAVE pour explorer des molécules.

				Nous venons de présenter plusieurs plateformes logicielles et matérielles permettant de créer un espace de collaboration pour la modélisation moléculaire et le \myglos{glo-DockingMoleculaire}.
			...
			\end{mysubsection}
		\end{mysection}
		\begin{mysection}[sec-sota-ConfigurationCollaborativePourLaResolutionDesTachesComplexes]{Configuration collaborative pour la résolution des tâches complexes}
			...
			Pour distinguer ces deux termes, nous nous appuierons sur la définition proposée par \mycite[author]{Roschelle-1995}.
			...
			Cette section a pour but de comprendre pourquoi la configuration collaborative est particulièrement pertinente dans le cas de la résolution d'une tâche complexe telle que le \myglos{glo-DockingMoleculaire}.
			Cependant, les nombreux travaux sur la collaboration montrent que cette configuration de travail permet de générer des effets de groupe très différents; la \myglos{glo-FacilitationSociale} est un phénomène social stimulant les groupes et améliorant ainsi les performances; la \myglos{glo-ParesseSociale} a tendance à provoquer les effets inverses.
			...
			\begin{mysubsection}[sse-sota-LaDistributionCognitiveDesChargesDeTravail]{La distribution cognitive des charges de travail}
				\mycite[author]{Bandura-1986} puis \mycite[author]{Foushee-1987} sont parmi les premiers à avoir constater que le travail collaboratif apporte plus qu'une simple multiplication des ressources : les interactions entre les individus font émerger des compétences propre au groupe.
				...
				\mycite[author]{George-1990} souligne également la distribution de l'état émotionnel de chaque participant sur tous les membres du groupe\footnote{\mycite[author]{Yammarino-1992} ont remis en cause les conclusions obtenues mais le travail de \mycite[author]{George-1990} a été de nouveau confirmé par \mycite[author]{George-1993}.}.
				\begin{mysubsubsection}[sss-sota-LaDistributionCognitiveDesChargesDeTravail-Definition]{Définition}
					...
					Des observations en terme de psychologie sociale et les connaissances en anthropologie de \mycite[author]{Hutchins-1996} ont permis de faire une distinction entre les propriétés cognitives d'un individu et les propriétés cognitives d'un groupe.
				...
				\end{mysubsubsection}
				\begin{mysubsubsection}[sss-sota-LaDistributionCognitiveDesChargesDeTravail-ModelisationDeLaDistributionCognitiveDesChargesDeTravail]{Modélisation de la distribution cognitive des charges de travail}
					...
					\end{myfigure}
				\end{mysubsubsection}
				\begin{mysubsubsection}[sss-sota-LaDistributionCognitiveDesChargesDeTravail-LesArtefacts]{Les artefacts}
					...
					Par exemple, \mycite[author]{Patel-1999} montrent une perte d'efficacité sur une application permettant la collaboration distante pour le partage de connaissances médicales entre groupes de spécialités différentes.
					...
					Nous allons voir dans les sections suivantes que différents phénomènes influent sur les performances d'un groupe comme la \myglos{glo-FacilitationSociale} qui stimule les groupes ou la \myglos{glo-ParesseSociale} qui provoque quasiment l'effet inverse.
				\end{mysubsubsection}
			\end{mysubsection}
			\begin{mysubsection}[sse-sota-LaFacilitationSociale]{La facilitation sociale}
				...
				\begin{myfigure}
					...
					\begin{myboxgraph}(3,0.8\textwidth)[10]{condition}(60,4cm){vitesse~(km/h)}
				...
				Déjà, \mycite[author]{Yerkes-1908} avaient constaté, dans un contexte non-collaboratif, que les performances d'un individu pouvait dépendre de la complexité de la tâche et du niveau de stimulation.
			...
			\begin{mysubsection}[sse-sota-LaParesseSociale]{La paresse sociale}
				\mycite[author]{Ringelmann-1913} est le premier à constater le phénomène de \myglos{glo-ParesseSociale}\footnote{Ce phénomène de \myglos{glo-ParesseSociale} est d'ailleurs parfois nommé \og effet de \mycite[author]{Ringelmann-1913} \fg.} dans un rapport technique qui sera signalé quelques années plus tard par \mycite[author]{Moede-1927} puis reprit de manière détaillée dans la littérature scientifique par \mycite[author]{Kravitz-1986}.
				...
				\begin{myfigure}
					...
					\begin{myboxgraph}(8,0.8\textwidth)[0.2]{taille du groupe}(1.0,4cm){performance}
				...
				Par la suite, d'autres travaux de recherche ont tenté de modéliser l'évolution de la \myglos{glo-ParesseSociale} en fonction du nombre de participants.
				...
				Dans une étude dans laquelle sont comparés entre autre une configuration de travail collaboratif distribuée avec une configuration colocalisée, \mycite[author]{Chidambaram-2005} montrent qu'un travail colocalisé permet de faciliter l'auto-évaluation et augmente cette pression sociale.
				...
				Cependant, \mycite[author]{Chidambaram-2005} constatent un effet parallèle : certains membres du groupe donnent simplement l'impression qu'ils travaillent sans être réellement efficaces.
				...
				Comme l'a montré \mycite[author]{Chidambaram-2005}, la collaboration colocalisée est une solution appropriée pour l'auto-évaluation.
		...
		\begin{mysection}[sec-sota-CollaborationEnEnvironnementVirtuel]{Collaboration en environnement virtuel}
			...
			\end{description}
			Dans cette section, nous allons décrire les différents types de communication qui ont lieu entre les différents acteurs d'un système collaboratif.
			...
			\begin{mysubsection}[sse-sota-CommunicationEnEnvironnementVirtuel]{Communication en environnement virtuel}
				...
				\begin{mysubsubsection}[sss-sota-CommunicationEnEnvironnementVirtuel-CommunicationDirecte]{Communication directe}
					...
					Elle est consciente la plupart du temps mais peut contenir une part de communication inconsciente d'après \mycite[author]{Gutwin-2000}.
				\end{mysubsubsection}
				...
				\begin{mysubsubsection}[sss-sota-CommunicationEnEnvironnementVirtuel-Grounding]{\myGrounding}
					Selon \mycite[author]{Dix-2004}, les participants doivent posséder un niveau de compréhension commun (même langue parlée, même base culturelle, même jargon, \myetc) afin de se comprendre.
					Cette aspect de la communication est inconscient mais nécessaire pour la collaboration \myref*{sss-sota-LeGrounding}.
				\end{mysubsubsection}
			\end{mysubsection}
			\begin{mysubsection}[sse-sota-MecanismesDeLaCommunicationDeGroupe]{Mécanismes de la communication de groupe}
				...
				\begin{mysubsubsection}[sss-sota-LaConscienceDeGroupe]{La conscience de groupe}
					...
					\mycite[author]{Gutwin-1996} propose quatre catégories pour segmenter les différents aspects de la conscience périphérique\footnote{Les catégories en anglais sont les suivantes : \textit{informal awareness}, \textit{social awareness}, \textit{group-structural awareness} et \textit{workspace awareness}.} :
					\begin{description}
					...
					Afin de répondre à cette problématique, \mycite[author]{Chastine-2007a} se proposent, dans un contexte de collaboration distante, d'utiliser des techniques de réalité augmentée pour désigner les éléments \myref*{fig-sota-InterReferencementVisuelProposeParChastineALAideDeTechniquesDeRealiteAugmentee}.
					Par la suite, \mycite[author]{Chastine-2008} montrent que les techniques qu'ils proposent pour améliorer l'inter-référencement permettent de limiter les ambiguïtés et d'améliorer les performances globales du groupe.
				...
				\begin{mysubsubsection}[sss-sota-LeGrounding]{Le \mygrounding}
					...
					Cependant, en observant le travail d'un hôpital où plusieurs médecins sont à la recherche de symptômes pour diagnostiquer un patient et fournir un traitement approprié, \mycite[author]{Hertzum-2010} s'est rendu compte que chaque médecin est capable individuellement de découvrir des symptômes mais que le manque d'échanges entre les différents médecins ne permettait pas toujours d'établir le bon diagnostic.
			...
			\begin{mysubsection}[sse-sota-StrategiesDeCollaboration]{Stratégies de collaboration}
				...
				Les trois scénarios exposés dans les sections qui suivent sont résumés dans la \myref{tab-sota-SyntheseDesStrategiesCollaboratives}.
				\begin{mysubsubsection}[sss-sota-CollaborationAPlusieursUtilisateurs]{Collaboration à plusieurs utilisateurs}
					Illustré sur la \myref{fig-sota-CollaborationAPlusieursUtilisateurs}, ce scénario place tous les utilisateurs au même niveau, sans distinction hiérarchique liée à la configuration.
					...
					\begin{myfigure}
						...
						\begin{myps}(-6,-1.5)(6,5.75)
							...
							\ncdiag[angleA=-45,outAngleA=-45,angleB=-135,outAngleB=-135,armA=4.25,armB=4.25,linestyle=dashed,linearc=.25]{<->}{alice}{bob}
							...
							\ncdiag[angleA=-45,outAngleA=-45,angleB=-135,outAngleB=-135,armA=4.25,armB=4.25,linestyle=dashed,linearc=.25,linecolor=black!25]{<->}{alice}{bob}
							\endpsclip
							\rput(0,0){\circlenode[style=nodestyle,fillstyle=none,shadow=false]{artefact}{\Large Artefact}}
							\ncangle[angleA=-90,outAngleA=-90,angleB=180,outAngleB=180,linearc=.25]{<->}{alice}{artefact}
							\ncput*[npos=0.67]{\begin{tabular}{@{}c@{}}Contrôle\\et retour\\sensoriel\end{tabular}}
							\ncangle[angleA=-90,outAngleA=-90,angleB=0,outAngleB=0,linearc=.25]{<->}{bob}{artefact}
							\ncput*[npos=0.67]{\begin{tabular}{@{}c@{}}Contrôle\\et retour\\sensoriel\end{tabular}}
							\ncline[angleA=0,outAngleA=0,angleB=180,outAngleB=180]{<->}{alice}{bob}
							\ncput*{\begin{tabular}{@{}c@{}}Communication\\directe\end{tabular}}
							\ncangle[angleA=90,outAngleA=90,angleB=90,outAngleB=90,arm=1,linearc=.25,linestyle=dashed]{<->}{alice}{bob}
					...
					La \myref{fig-sota-CollaborationAPlusieursUtilisateurs} illustre l'aspect le plus naturel de la distribution cognitive des charges que nous avons déjà découvert dans la \myref{sse-sota-LaDistributionCognitiveDesChargesDeTravail} : on souhaite diviser la tâche à réaliser entre plusieurs utilisateurs car elle trop complexe ou trop fastidieuse.
					Cette configuration permet de répartir équitablement le travail entre les membres du groupe.
					...
					Tout d'abord, nous avons vu dans la \myref{sse-sota-LaParesseSociale} sur la \myglos{glo-ParesseSociale} qu'une identification des rôles était préférable pour tirer profit d'une configuration collaborative.
					En proposant des rôles strictement identiques aux utilisateurs, ce type de scénario tend à favoriser la \myglos{glo-ParesseSociale} en ne fournissant pas d'élément pour une identification distincte de rôles différents.
					...
					Toutefois, \mycite[author]{Buisine-2011} soulignent qu'un accès aux artefacts équitablement distribués entre les utilisateurs permet de réduire la \myglos{glo-ParesseSociale} en évitant l'isolement d'un des membres du groupe.
				\end{mysubsubsection}
				\begin{mysubsubsection}[sss-sota-CollaborationAPlusieursExperts]{Collaboration à plusieurs experts}
					Dans cette configuration illustrée sur la \myref*{fig-sota-CollaborationAPlusieursExperts}, chaque utilisateur est expert d'un domaine de compétence différent de ses collaborateurs.
					...
					\begin{myfigure}
						...
						\begin{myps}(-6,-1.5)(6,5.75)
							...
							\ncdiag[offset=0.5,angleA=-90,outAngleA=-90,angleB=-90,outAngleB=-90,armA=3,armB=3,linestyle=dashed,linearc=.25]{<->}{alice}{bob}
							...
							\ncdiag[offset=0.5,angleA=-90,outAngleA=-90,angleB=-90,outAngleB=-90,armA=3,armB=3,linestyle=dashed,linearc=.25,linecolor=black!25]{<->}{alice}{bob}
							\endpsclip
							\psclip{%
							...
							\ncline[offset=-0.5,angleA=-90,outAngleA=-90,angleB=90,outAngleB=90,linearc=.25,nodesepB=-3pt]{<->}{alice}{artefact1}
							\ncput*[npos=0.5]{\begin{tabular}{@{}c@{}}Contrôle\\et retour\\sensoriel\end{tabular}}
							\ncline[offset=0.5,angleA=-90,outAngleA=-90,angleB=90,outAngleB=90,linearc=.25,nodesepB=-3pt]{<->}{bob}{artefact2}
							\ncput*[npos=0.5]{\begin{tabular}{@{}c@{}}Contrôle\\et retour\\sensoriel\end{tabular}}
							\ncline[angleA=0,outAngleA=0,angleB=180,outAngleB=180]{<->}{alice}{bob}
							\ncput*{\begin{tabular}{@{}c@{}}Communication\\directe\end{tabular}}
							\ncangle[angleA=90,outAngleA=90,angleB=90,outAngleB=90,arm=1,linearc=.25,linestyle=dashed]{<->}{alice}{bob}
							\ncput*[npos=1.5]{\myGrounding}
							\ncline[angleA=0,outAngleA=0,angleB=180,outAngleB=180]{<->}{artefact1}{artefact2}
					...
					On trouve par exemple ce type de scénarios en médecine où de nombreuses spécialités différentes peuvent être amenées à collaborer \mycite{Althoff-2007a,Althoff-2007b}.
					L'avantage est de répondre aux problématiques d'identification des rôles et de limiter ainsi la \myglos{glo-ParesseSociale}; chaque utilisateur doit se fier à lui-même puisqu'il est le seul à posséder les compétences et les artefacts nécessaires pour réaliser la tâche.
					...
					Par exemple, \mycite[author]{Barbic-2007} ainsi que \mycite[author]{Gautier-2008} abordent les problématiques de synchronisation en temps-réel pour des simulations d'objets déformables.

					Dans les scénarios à plusieurs experts, les bases de connaissances sont plutôt complémentaires.
					Selon \mycite[author]{Bach-2010}, la difficulté de cette configuration est l'identification des connaissances communes, notion déjà identifiée comme le \mygrounding dans la \myref{sss-sota-LeGrounding}.
				...
				\end{mysubsubsection}
				\begin{mysubsubsection}[sss-sota-CollaborationAvecAccesExclusifAuxArtefacts]{Collaboration avec accès exclusif aux artefacts}
					...
					La \myref{fig-sota-CollaborationAvecAccesExclusifAuxArtefacts} illustre cette configuration asymétrique.
					...
					\begin{myfigure}
						...
						\begin{myps}(-6,-1.5)(6,5.75)
							...
							\ncdiag[offset=0.5,angleA=-90,outAngleA=-90,angleB=-90,outAngleB=-90,armA=3.5,armB=0,linestyle=dashed,linearc=.25]{->}{alice}{bob}
							\ncput*[nrot=:U,npos=1.5]{\emph{Feedthrough}}
							\psclip{%
								\rput(-4,0){\circlenode[style=nodestyle,shadow=false]{artefact}{\Large Artefact}}
							}
							\ncdiag[offset=0.5,angleA=-90,outAngleA=-90,angleB=-90,outAngleB=-90,armA=3.5,armB=0,linestyle=dashed,linearc=.25,linecolor=black!25]{->}{alice}{bob}
							\endpsclip
							\rput(-4,0){\circlenode[style=nodestyle,fillstyle=none,shadow=false]{artefact}{\Large Artefact}}
							\ncline[offset=-0.5,angleA=-90,outAngleA=-90,angleB=90,outAngleB=90,linearc=.25,nodesepB=-3pt]{<->}{alice}{artefact}
							\ncput*[npos=0.5]{\begin{tabular}{@{}c@{}}Contrôle\\et retour\\sensoriel\end{tabular}}
							\ncangle[angleA=-90,outAngleA=-90,angleB=0,outAngleB=0,linearc=.25]{<-}{bob}{artefact}
							...
							\ncput*[npos=1.5]{\myGrounding}
						\end{myps}
						\mycaption[fig-sota-CollaborationAvecAccesExclusifAuxArtefacts]{Collaboration par manipulateur et observateur}
						\let\arraystretch\oldarraystretch
					\end{myfigure}
					...
					De plus, les utilisateurs restreints au rôle d'observateur possèdent une charge de travail plus faible; ils peuvent ainsi se consacrer de manière plus importante à l'analyse des données disponibles et à la proposition de solutions pertinentes.

					Cependant, en cherchant à caractériser le quotient intellectuel de groupe, \mycite[author]{Woolley-2010} concluent que le principal facteur d'intelligence de groupe est une répartition équitable des charges de travail entre les membres du groupe.
					...
					C'est à travers ce canal qu'il va pouvoir désigner des objectifs, renvoyant ainsi aux problématiques d'inter-référencement abordés dans la \myref{sss-sota-LaConscienceDeGroupe}.
				\end{mysubsubsection}
				\begin{mytable}
					\mycaption[tab-sota-SyntheseDesStrategiesCollaboratives]{Synthèse des stratégies collaboratives}
		...
		\begin{mysection}[sec-sota-Conclusion]{Conclusion}
			À travers ce chapitre, nous avons exposer la complexité que représente la tâche de \myglos{glo-DockingMoleculaire}.
			...
			Nous souhaitons utiliser ces possibilités pour proposer une plateforme collaborative synchrone et colocalisée pour le \myglos{glo-DockingMoleculaire} interactif et temps-réel.
			...
			Cependant, de nombreux facteurs (\myglos{glo-FacilitationSociale}, \myglos{glo-ParesseSociale}, \mygrounding, conscience de groupe, \myetc) interviennent et influent la communication et les interactions entre les acteurs de la collaboration.
			...
			Le \myglos{glo-DockingMoleculaire} peut être vu comme la succession d'une étape de déformation moléculaire et d'une étape d'assemblage des molécules.
			Nous nous intéresserons principalement au processus de déformation, l'étape d'assemblage étant brièvement abordée au cours de la dernière expérimentation \myref*{cha-TravailCollaboratifAssisteParHaptique}.
			...
			Pour fragmenter ce processus, nous nous basons sur les travaux de \mycite[author]{Bowman-1999} qui identifie quatre tâches élémentaires pour segmenter une interaction en environnement virtuel, nommées \myacro*{acr-PCV} par \mycite[author]{Fuchs-2006a}.
			Ces quatre \myacro*{acr-PCV}, illustrée dans la \myref{fig-sota-ProcessusDeDeformationMoleculaireEnQuatreEtapes}, sont expliquées ci-dessous :
			\begin{description}
				...
				\item[Déformation] Cette étape consiste à manipuler la cible précédemment sélectionnée pour déformer la structure moléculaire au niveau atomique, intra-moléculaire ou inter-moléculaire.
					L'objectif inhérent à cette tâche est d'atteindre l'objectif fixé (par exemple, minimiser l'énergie totale du système).
			...
			\begin{myfigure}
				...
				\def\mycirclenum(#1,#2)#3{%
					\uput{5em}[0](#1,#2){\pscirclebox*[fillcolor=myblue70]{\white #3}}%
				}
				\begin{myps}(-2.5,-1)(2.5,5)
					...
					\ncloop[loopsize=4em,angleA=-90,outAngleA=-90,angleB=90,outAngleB=90,linearc=0.05]{->}{Evaluation}{Exploration}
				\end{myps}
				\mycaption[fig-sota-ProcessusDeDeformationMoleculaireEnQuatreEtapes]{Processus de déformation moléculaire en quatre étapes}
			\end{myfigure}

			Sur la base de ces \myacro*{acr-PCV}, nous avons décomposé notre étude en trois parties distinctes.
			Tout d'abord, nous étudierons l'évolution des performances et les stratégies qui se dégagent entre un \myglos{glo-Monome} et un \myglos{glo-Binome} sur une tâche d'exploration et de sélection \myref*{cha-RechercheCollaborativeDeResiduSurUneMolecule}.
			Puis nous étudierons différentes répartitions des ressources entre les individus sur une tâche de manipulation et d'évaluation \myref*{cha-DeformationCollaborativeDeMolecule}.
			Enfin, nous proposerons d'analyser l'influence de la taille du groupe sur les performances et sur la communication \myref*{cha-LaDynamiqueDeGroupe}.
			Sur la base de ces trois études, des outils d'assistance haptique ont été développés.
			Ils seront évalués dans la dernière expérimentation \myref*{cha-TravailCollaboratifAssisteParHaptique}.
		\end{mysection}
	\end{mychapter}
	\fi
	\ifchaptertwo
	\begin{mychapter}[cha-Shaddock-ManipulationCollaborativeDeMolecules]{\myShaddock\ -- Plateforme de manipulation collaborative de molécules}
		\begin{mysection}[sec-Shaddock-Introduction]{Introduction}
			...
			Puis un module de simulation moléculaire est ajouté au module visualisation; plusieurs solutions sont possibles et le module retenu est présenté dans la \myref{sse-Shaddock-ModuleDeSimulationMoleculaire}.
				...
				\begin{myps}(-5,-10)(5,10)
					\rotateleft{%
						...
						\rput(-5,0){%
							...
							\rput(5,1){%
								\myumlnode<PHANToM1>[\myOmni]{Périphérique : Interface~\mynum{1}}%
							}
							...
							\rput(5,-6){%
								\myumlnode<PHANToMn>[\myOmni]{Périphérique : Interface~$n$}%
							}
							\rput(0,-5){%
							...
							\myumlrealization[angleA=-90,outAngleA=-90,angleB=90,outAngleB=90]{VRPNn}{PHANToMn}[nccurve]%
							\myumlinterface[angleA=-90,outAngleA=-90,angleB=90,outAngleB=90,ArrowInsidePos=0.666667]{VMD}{VideoProjecteur}[nccurve]
							...
							\myumlinterface[angleA=0,outAngleA=0,angleB=180,outAngleB=180,offsetB=-12pt,ArrowInsidePos=0.3]{NAMD}{VMD}[nccurve]
							...
							\myumlinterface[angleA=180,outAngleA=180,angleB=0,outAngleB=0,ncurvA=1.5,offsetA=12pt,ArrowInsidePos=0.5]{VRPN1}{VMD}[nccurve]
							...
							\myumlinterface[angleA=180,outAngleA=180,angleB=0,outAngleB=0,ncurvA=1.5,offsetA=12pt,ArrowInsidePos=0.5]{VRPNn}{VMD}[nccurve]
			...
			\begin{myfigure}
					...
					\begin{myps}(-10,-5)(10,4)
						...
						\myumlrealization[angleA=90,outAngleA=90,angleB=-90,outAngleB=-90]{Renderer}{IMD}[nccurve]%
						\myumlrelation[angleA=180,outAngleA=180,angleB=0,outAngleB=0,offsetA=12pt]{VRPNclient}[-135]<*>{IMD}[-45]<*>[nccurve]%
						\myumlinterface[angleA=180,outAngleA=180,angleB=180,outAngleB=0,offsetA=12pt,ArrowInside={}]{IMD}{VMD}[nccurve]
						\ncput[npos=1]{\uput[180](0,0){\tiny\begin{psmatrix}[rowsep=0]Chargement\\ des données\\ de simulation\end{psmatrix}}}
						\myumlinterface[angleA=0,outAngleA=0,angleB=0,outAngleB=180,ArrowInside={}]{VRPNclient}{VMD}[nccurve]
						\ncput[npos=1]{\uput[0](0,0){\tiny\begin{psmatrix}[rowsep=0]Communication\\ avec les outils\\ de manipulation\end{psmatrix}}}
						\myumlinterface[angleA=-90,outAngleA=-90,angleB=-90,outAngleB=90,offsetA=8pt,ArrowInside={}]{Renderer}{VMD}[nccurve]
		...
		\begin{mysection}[sec-Shaddock-PlateformeDeSimulationEtDeVisualisation]{Plateforme de simulation et de visualisation}
			...
			Afin de proposer une dynamique moléculaire interactive et temps-réel aux utilisateurs, un module présenté dans la \myref{sss-Shaddock-SimulationMoleculaireInteractiveEtTempsReel} permet de faire communiquer le module de visualisation avec le module de simulation.
			...
			\begin{mysubsection}[sse-Shaddock-ModuleDeVisualisationMoleculaire]{Module de visualisation moléculaire}
				...
				\begin{description}
					...
					\item[\myNewRibbon] produit une courbe sur les atomes $C_{\alpha}$ représentant l'armature principale de la molécule; la courbe est représentée sous forme de ruban \myref*{fig-simulation-NewRibbon};
			...
			\begin{mysubsection}[sse-Shaddock-ModuleDeSimulationMoleculaire]{Module de simulation moléculaire}
				...
				\mycite[author]{Hess-2008} montrent que \myGromacs est plus performant que \myacro{acr-NAMD}.
		...
		\begin{mysection}[sec-Shaddock-LesOutilsDInteraction]{Les outils d'interaction}
			\begin{mysubsection}[sse-Shaddock-OutilDInteractionUtilise]{Outil d'interaction utilisé}
				...
				Le \myDesktop, qui répond également aux contraintes, aurait permis des retours haptiques plus fidèles mais son prix élevé ne convient pas à notre plateforme collaborative où il faudra en déployer plusieurs.
			...
			\begin{mysubsection}[sse-Shaddock-OutilsDeManipulationAvances]{Outils de manipulation avancés}
				...
				\begin{mysubsubsection}[sss-Shaddock-OutilDeSelectionCollaboratif]{Outil de sélection collaboratif}
					Afin d'effectuer correctement une sélection, il est préférable de connaître \myapriori quelle cible sera sélectionnée en fonction de la position actuelle du curseur.
					C'est pourquoi, cet outil de sélection amélioré met continuellement en surbrillance la cible la plus proche du curseur.
					Afin de distinguer une cible \og sélectionnée \fg d'une cible \og non-sélectionnée \fg, ces dernières sont simplement surlignées de manière transparente alors que les cibles sélectionnées sont de couleurs opaques \myref*{fig-selection-improvement-DifferenceVisuelleEntreLesElementsPointesEtSelectionnes}.

					Cependant, dans un contexte de travail collaboratif, il doit être possible pour chacun des collaborateurs de distinguer sa sélection de la sélection des autres.
					...
					Pour que les utilisateurs aient une indication précise concernant les interactions haptiques, cet atome est agrandi par rapport au reste du groupe d'atome \myref*{fig-selection-improvement-DifferenceVisuelleEntreLesElementsPointesEtSelectionnes}.
				...
				\begin{mysubsubsection}[sss-Shaddock-OutilDeDesignation]{Outil de désignation}
					...
					\begin{description}
						...
						\item[Acceptation d'une cible] L'utilisateur~\myuser{B} peut alors accepter ou non cette désignation;
							s'il accepte la désignation, la cible est colorée de la couleur du curseur de l'utilisateur~\myuser{B} \myref*{fig-designation-CibleAcceptee};
	...
	\begin{mychapter}[cha-RechercheCollaborativeDeResiduSurUneMolecule]{Recherche collaborative de résidu sur une molécule}
		...
		\begin{mysection}[sec-exp1-ExplorationEtSelectionCollaborative]{Exploration et sélection collaborative}
			\begin{mysubsection}[sse-exp1-TravauxExistants]{Travaux existants}
				...
				Pourtant, des travaux en biologie moléculaire existent dans les environnements réels mais les contraintes techniques sont très différentes de celles en environnement virtuel; nous ne nous étendrons pas sur ce sujet.
				...
				À partir de ce travail, \mycite[author]{Hughes-2002} proposent une tâche de recherche basée sur le principe du guidage mais en supprimant la collaboration; le guide est un algorithme qui suggére à l'utilisateur les zones d'intérêt.
...
vmd> set mysel [atomselect "top" "name C or name O or name N or name CA"]
				...
				Cependant, les techniques de segmentation de la parole et des gestes sont encore imprécises.
				...
				Cependant, \mycite[author]{Delalande-2010} proposent une plateforme en utilisant des périphériques haptiques pour aider à la localisation de ponts ioniques au sein d'une simulation moléculaire en temps-réel sur des corps flexibles.
		...
		\begin{mysection}[sec-exp1-PresentationDeLExperimentation]{Présentation de l'expérimentation}
			...
			\begin{mysubsection}[sse-exp1-DescriptionDeLaTache]{Description de la tâche}
				...
				Chaque \myglos{glo-Residu} possède ses propres caractéristiques (position, couleur, \myetc) offrant des niveaux de complexité différents comme on peut le voir dans la \myref{tab-exp1-CriteresDeComplexiteDesResidus}.
				...
				\begin{description}
					...
					\item[Similarité] Certains \myglos*{glo-Residu} cherchés sont très similaires à d'autres \myglos*{glo-Residu} également présents sur la molécule.
				...
				\begin{mytable}
					...
					\mycaption[tab-exp1-CriteresDeComplexiteDesResidus]{Critères de complexité des \myglosnl*{glo-Residu} -- \myatomincolor{carbon}{arbone}{cyan}, \myatomincolor{nytrogen}{zote}{bleu}, \myatomincolor{oxygen}{xygène}{rouge} et \myatomincolor{sulfur}{oufre}{jaune}}
			...
			\begin{mysubsection}[sse-exp1-SpecificitesDuProtocoleExperimental]{Spécificités du protocole expérimental}
				...
				\begin{mysubsubsection}[sss-exp1-MaterielUtilise]{Matériel utilisé}
					...
					Cependant, un outil d'orientation de la molécule est mis à disposition pour des raisons détaillées dans la \myref{sss-exp1-OutilsDeManipulation}.
		...
		\begin{mysection}[sec-exp1-Resultats]{Résultats}
			...
			\begin{mysubsection}[sse-exp1-AmeliorationDesPerformancesEnBinome]{Amélioration des performances en binôme}
				...
				\begin{mysubsubsection}[sss-exp1-AmeliorationDesPerformancesEnBinome-DonneesEtStatistiques]{Données et statistiques}
					\begin{myfigure}
						...
						\begin{myboxgraph}[llx={-3em},yAxisLabelPos={-3em,c}](10,0.8\textwidth)[100]{\myglosnl*{glo-Residu}}(400,4cm){temps~(s)}
					...
					\begin{myfigure}
						\psset{xunit=0.0889\textwidth,yunit=0.01cm}
						\mylegend{%
							\myleg{\myglosnl{glo-Monome}}{myblue}%
							\myleg{\myglosnl{glo-Binome}}{myblue70}%
						}
						\begin{myboxgraph}[llx={-3em},yAxisLabelPos={-3em,c}](10,0.8\textwidth)[100]{\myglosnl*{glo-Residu}}(400,4cm){temps~(s)}
				...
				\begin{mysubsubsection}[sss-exp1-AmeliorationDesPerformancesEnBinome-AnalyseEtDiscussion]{Analyse et discussion}
					...
					Durant la phase d'exploration, les sujets construisent rapidement une carte mentale de la molécule ce qui leur permet d'identifier rapidement les \myglos*{glo-Residu} recherchés.
					...
					Les sujets n'étant jamais confrontés plus de deux fois à la même tâche (une fois en \myglos{glo-Monome} et une fois en \myglos{glo-Binome}), le phénomène d'apprentissage ne peut pas être effectué.
					...
					En effet, ces deux \myglos*{glo-Residu} sont en présence d'autres \myglos*{glo-Residu} similaires au sein de la même molécule \myref*{tab-exp1-CriteresDeComplexiteDesResidus}.
					...
					Cette particularité aisément identifiable malgré le nombre important d'atomes de la molécule.
			...
			\begin{mysubsection}[sse-exp1-StrategiesDeTravail]{Stratégies de travail}
				...
				\begin{mysubsubsection}[sss-exp1-StrategiesDeTravail-DonneesEtAnalyses]{Données et analyses}
					...
					\begin{myfigure}
						...
						\begin{myboxgraph}(12,0.8\textwidth)[4]{\myglosnl*{glo-Binome}}(20,4cm){distance~(mm)}
					...
					\begin{myfigure}
						...
						\begin{myboxgraph}[llx={-2em},yAxisLabelPos={-2em,c}](12,0.8\textwidth)[1]{\myglosnl*{glo-Binome}}(5,4cm){affinité~(\mynum{1}--\mynum{5})}
					...
					Les notes, comprises entre un et cinq, montrent que les \myglos*{glo-Binome} choisis ont des affinités relativement variées.
					...
					\begin{myfigure}
						...
						\begin{myboxgraph}[llx={-3em},yAxisLabelPos={-3em,c}](12,0.8\textwidth)[50]{\myglosnl*{glo-Binome}}(300,4cm){temps~(s)}
					...
					\begin{myfigure}
						...
						\begin{myboxgraph}(12,0.8\textwidth)[10]{\myglosnl*{glo-Binome}}(70,4cm){temps~(s)}
					...
					\mygroup{2}, \mygroup{3} et \mygroup{4} ont des temps inférieurs à \mynum[s]{20}.
					À l'opposé, \mygroup{1}, \mygroup{5} et \mygroup{11} ont des temps qui approche les \mynum[s]{60}.
					...
					\begin{myfigure}
						...
						\begin{myboxgraph}(12,0.8\textwidth)[25]{\myglosnl*{glo-Binome}}(100,4cm){temps~(\%)}
					...
					\begin{myfigure}
						...
						\mylegend{%
							\myleg{force moyenne}{myblue}%
							\myleg{différence de force}{myblue70}%
						}
						\begin{myboxgraph}[llx={-2em},yAxisLabelPos={-2em,c}](12,0.8\textwidth)[1]{\myglosnl*{glo-Binome}}(3,4cm){force~(N)}
					...
					\begin{myparagraph}[par-exp1-CollaborationEnChampVoisin-Caracteristiques]{Caractéristiques}
						...
						\begin{myfigure}
							...
							\begin{myps}(-1,-0.2)(1.15,1)
								...
								\nccurve[angleA=135,outAngleA=135,angleB=-90,outAngleB=-90]{->}{connected-residues-label}{connected-residues1}
								\nccurve[angleA=45,outAngleA=45,angleB=-90,outAngleB=-90]{->}{connected-residues-label}{connected-residues2}
								\nccurve[angleA=90,outAngleA=90,angleB=180,outAngleB=180]{->}{close-macro-label}{close-macro1}
								\nccurve[angleA=-90,outAngleA=-90,angleB=180,outAngleB=180]{->}{close-macro-label}{close-macro2}
							\end{myps}
				...
				\begin{mysubsubsection}[sss-exp1-SyntheseDesStrategiesDeTravail]{Synthèse des stratégies de travail}
					...
					Cependant, ce sont les interactions en champs voisins qui produisent les meilleures performances.
			...
			\begin{mysubsection}[sse-exp1-ResultatsQualitatifs]{Résultats qualitatifs}
				...
				\begin{mysubsubsection}[sss-exp1-EvaluationDuTravailEnCollaboration]{Évaluation du travail en collaboration}
					...
					À propos de la communication, les participants estiment qu'ils exploitent principalement la communication verbale (\mysummary{exp1-evaluation-verbal.tex}) et, dans une proportion plus faible mais tout de même importante, virtuelle (\mysummary{exp1-evaluation-virtual.tex}).
		...
		\begin{mysection}[sec-exp1-Conclusion]{Conclusion}
			\begin{mysubsection}[sse-exp1-ResumeDesResultats]{Résumé des résultats}
				...
				Au-delà des facteurs de position, de couleur ou de forme, le nombre d'atomes de la molécule (et donc le nombre de \myglos*{glo-Residu}) semble jouer un rôle important dans cette complexité.
				Un grand nombre d'atomes surcharge l'environnement virtuel qui est difficile à appréhender.
	...
	\begin{mychapter}[cha-DeformationCollaborativeDeMolecule]{Déformation collaborative de molécule}
		\begin{mysection}[sec-exp2-Introduction]{Introduction}
			...
			En effet, certains éléments de la première expérimentation semblent indiquer qu'une configuration collaborative stimule l'apprentissage, que ce soit pour l'utilisation des outils, de la plateforme ou encore pour la tâche à réaliser.
		\end{mysection}
		\begin{mysection}[sec-exp2-DeformationCollaborativeDansUnEnvironnementVirtuel]{Déformation collaborative dans un environnement virtuel}
		...
		\begin{mysection}[sec-exp2-PresentationDeLExperimentation]{Présentation de l'expérimentation}
			\begin{mysubsection}[sse-exp2-DescriptionDeLaTache]{Description de la tâche}
				...
				\myTRPZIPPER et \myTRPCAGE seront chacune utilisées dans deux scénarios distincts.
				...
				\begin{description}
					\item[Niveau de déformation] Deux niveaux différents de déformation sont proposés : inter-moléculaire et intra-moléculaire \myref*{sse-sota-RechercheDeSolutionsDeDockingMoleculaire};
				...
				\begin{description}
					\item[Scénario~\myscenario{1a}]
						...
						La forme générale de la molécule peut être comparée à un \myform{V} : la chaîne de \myglos*{glo-Residu} de la molécule contient une cassure.
					...
					\item[Scénario~\myscenario{1b}]
						...
						La forme générale de la molécule peut être comparée à un \myform{W} : la chaîne de \myglos*{glo-Residu} de la molécule contient deux cassures.
			...
			\begin{mysubsection}[sse-exp2-SpecificitesDuProtocoleExperimental]{Spécificités du protocole expérimental}
				...
				\begin{mysubsubsection}[sss-exp2-MaterielUtilise]{Matériel utilisé}
					...
					L'outil \mytool{grab} qui était assuré par un \myOmni et permettant d'orienter la molécule a été remplacée par une souris~\myThreeD \mySpaceNavigator.
				...
				\begin{mysubsubsection}[sss-exp2-VisualisationEtRepresentation]{Visualisation et représentation}
					...
					\begin{myfigure}
						\psset{xunit=0.027006961\textheight,yunit=0.02\textheight}
						\begin{myps}(-10,-10)(10,10)
							\rput(0,0){\myimage[width=0.4\textheight,angle=90]{exp2-scenario1A}}
							\psset{nodesepA=3pt,linewidth=1pt,linearc=0.1,arrowinset=.2,arrowsize=1pt 3}
							\myexptwolabel(-4,7)[exp2-1a-fixed-label]{mygray}{Structure fixe}
							\pnode(-1,2.7){exp2-1a-fixed}
							\ncdiagg[angleA=-90,linecolor=mygray]{c->}{exp2-1a-fixed-label}{exp2-1a-fixed}
							\myexptwolabel(-1,-9.5)[exp2-1a-deformed-label]{myred}{Structure à déformer}
							\pnode(-1,-4.6){exp2-1a-deformed}
							\ncdiagg[angleA=90,linecolor=myred]{c->}{exp2-1a-deformed-label}{exp2-1a-deformed}
							\myexptwolabel(-7,-8.5)[exp2-1a-stable-label]{myblue}{Structure stable}
							\pnode(-7,-3){exp2-1a-stable}
							\ncdiagg[angleA=90,linecolor=myblue]{c->}{exp2-1a-stable-label}{exp2-1a-stable}
						\end{myps}
					...
					\end{myfigure}
					\begin{myfigure}
						\psset{xunit=0.029285714\textheight,yunit=0.02\textheight}
						\begin{myps}(-10,-10)(10,10)
							\rput(0,0){\myimage[width=0.4\textheight,angle=90]{exp2-scenario1B}}
							\psset{nodesepA=3pt,linewidth=1pt,linearc=0.1,arrowinset=.2,arrowsize=1pt 3}
							\myexptwolabel(-7,9)[exp2-1b-fixed-label]{mygray}{Structure fixe}
							\pnode(-7,0.8){exp2-1b-fixed}
							\ncdiagg[angleA=-90,linecolor=mygray]{c->}{exp2-1b-fixed-label}{exp2-1b-fixed}
							\myexptwolabel(6,-7)[exp2-1b-deformed-label]{myred}{Structure à déformer}
							\pnode(6,-1){exp2-1b-deformed}
							\ncdiagg[angleA=90,linecolor=myred]{c->}{exp2-1b-deformed-label}{exp2-1b-deformed}
							\myexptwolabel(5.25,4.5)[exp2-1b-stable-label]{myblue}{Structure stable}
							\pnode(4.2,2){exp2-1b-stable}
							\ncdiagg[angleA=-90,linecolor=myblue]{c->}{exp2-1b-stable-label}{exp2-1b-stable}
						\end{myps}
					...
					\end{myfigure}
					\begin{myfigure}
						\psset{xunit=0.021117647\textheight,yunit=0.02\textheight}
						\begin{myps}(-11,-10)(10,10)
							\rput(0,0){\myimage[height=0.4\textheight]{exp2-scenario2A}}
							\psset{nodesepA=3pt,linewidth=1pt,linearc=0.1,arrowinset=.2,arrowsize=1pt 3}
							\myexptwolabel(-8.75,5.5)[exp2-2a-fixed-label]{mygray}{\myGlosnl{glo-Residu} fixe}
							\pnode(-7.4,8.2){exp2-2a-fixed}
							\ncdiagg[angleA=90,linecolor=mygray]{c->}{exp2-2a-fixed-label}{exp2-2a-fixed}
							\myexptwolabel(6,7.5)[exp2-2a-deformed-label]{myred}{Structure à déformer}
							\pnode(6.4,0){exp2-2a-deformed}
							\ncdiagg[angleA=-90,offsetA=30pt,armA=75pt,linecolor=myred]{c->}{exp2-2a-deformed-label}{exp2-2a-deformed}
							\myexptwolabel(-4,-9.5)[exp2-2a-stable-label]{myblue}{Structure stable}
							\pnode(-4,-7.8){exp2-2a-stable}
							\ncdiagg[angleA=90,linecolor=myblue]{c->}{exp2-2a-stable-label}{exp2-2a-stable}
						\end{myps}
					...
					\end{myfigure}
					\begin{myfigure}
						\psset{xunit=0.035694444\textheight,yunit=0.02\textheight}
						\begin{myps}(-10,-10)(10,10)
							\rput(0,0){\myimage[height=0.4\textheight]{exp2-scenario2B}}
							\psset{nodesepA=3pt,linewidth=1pt,linearc=0.1,arrowinset=.2,arrowsize=1pt 3}
							\myexptwolabel(-7.5,9.5)[exp2-2b-fixed-label]{mygray}{\myGlosnl{glo-Residu} fixe}
							\pnode(-8.7,6.4){exp2-2b-fixed}
							\ncdiagg[angleA=-90,armA=20pt,linecolor=mygray]{c->}{exp2-2b-fixed-label}{exp2-2b-fixed}
							\myexptwolabel(7,-6)[exp2-2b-deformed-label]{myred}{Structure à déformer}
							\pnode(7,-1.4){exp2-2b-deformed}
							\ncdiagg[angleA=90,linecolor=myred]{c->}{exp2-2b-deformed-label}{exp2-2b-deformed}
							\myexptwolabel(-6,-9.5)[exp2-2b-stable-label]{myblue}{Structure stable}
							\pnode(-6,-6.4){exp2-2b-stable}
							\ncdiagg[angleA=90,linecolor=myblue]{c->}{exp2-2b-stable-label}{exp2-2b-stable}
						\end{myps}
		...
		\begin{mysection}[sec-exp2-Resultats]{Résultats}
			...
			\begin{itemize}
				\item test de \mycite[author]{Friedman-1940} sur les \myglos*{glo-VariableIntraSujets} non-paramètriques;
				\item test de \mycite[author]{Kruskal-1952} sur les \myglos*{glo-VariableInterSujets} non-paramètriques.
			\end{itemize}
			\begin{mysubsection}[sse-exp2-AmeliorationDesPerformancesEnBinome]{Amélioration des performances en binôme}
				...
				\begin{mysubsubsection}[sss-exp2-AmeliorationDesPerformancesEnBinome-DonneesEtStatistiques]{Données et statistiques}
					\begin{myfigure}
						...
						\begin{myboxgraph}[llx={-3em},yAxisLabelPos={-3em,c}](2,0.8\textwidth)[50]{nombre de sujets}(200,4cm){temps~(s)}
					...
					\begin{myfigure}
						...
						\begin{myboxgraph}[llx={-2em},yAxisLabelPos={-2em,c}](2,0.8\textwidth)[1]{distance}(3,4cm){distance~(mm)}
					...
					On peut également comparer les distances passives et active en fonction du nombre de sujets \myvari{1}.
					...
					\begin{myfigure}
						...
						\mylegend{%
							...
							\myleg{main dominée}{myblue70}%
						}
						\begin{myboxgraph}(2,0.8\textwidth)[10]{nombre de sujets}(65,4cm){nombre de sélections~(nb)}
					...
					\begin{myfigure}
						...
						\begin{myboxgraph}(2,0.8\textwidth)[0.5]{nombre de sujets}(1.5,4cm){vitesse~(mm/s)}
				...
				\begin{mysubsubsection}[sss-exp2-AmeliorationDesPerformancesEnBinome-AnalyseEtDiscussion]{Analyse et discussion}
					...
					Les \myglos*{glo-Monome} couvrent un espace de travail plus restreint car ils ne peuvent pas focaliser visuellement sur plusieurs zones de travail simultanément.
					...
					Une analyse plus détaillée a mis en avant la difficulté du travail en configuration \myglos*{glo-Bimanuel} : la charge de travail à assumer avec deux outils est trop importante.
				...
				\end{mysubsubsection}
			\end{mysubsection}
			\begin{mysubsection}[sse-exp2-EvolutionDesPerformancesEnFonctionDesCriteresDeComplexiteDeLaTache]{Évolution des performances en fonction des critères de complexité de la tâche}
				...
				\begin{mysubsubsection}[sss-exp2-EvolutionDesPerformancesEnFonctionDeLaComplexiteDeLaTache-DonneesEtStatistiques]{Données et statistiques}
					\begin{myfigure}
						...
						\begin{myboxgraph}[llx={-3em},yAxisLabelPos={-3em,c}](4,0.8\textwidth)[50]{scénario}(250,4cm){temps~(s)}
					...
					\begin{myfigure}
						...
						\begin{myboxgraph}[llx={-3em},yAxisLabelPos={-3em,c}](4,0.8\textwidth)[50]{scénario}(350,4cm){temps~(s)}
					...
					\begin{myfigure}
						...
						\begin{myboxgraph}(4,0.8\textwidth)[25]{scénario}(125,4cm){nombre de sélection~(nb)}
							\myboxplot{exp2-numsel-task-group.csv}
						\end{myboxgraph}
						\mycaption[fig-exp2-NombreDeSelectionsPourChaqueScenarioEnFonctionDuNombreDeSujets]{Nombre de sélections pour chaque scénario en fonction du nombre de sujets}
					\end{myfigure}

					La \myref{fig-exp2-NombreDeSelectionsPourChaqueScenarioEnFonctionDuNombreDeSujets} présente le nombre de sélections \myvard{2} des différents scénarios \myvari{2} en fonction du nombre de sujets \myvari{1}.
					...
					\begin{myfigure}
						...
						\begin{mysubfigure}[\textwidth]
							...
							\begin{myboxgraph}(4,0.8\textwidth)[0.5]{scénario}(3,4cm){distance~(mm)}
					...
					\begin{myfigure}
						...
						\begin{myboxgraph}(4,0.8\textwidth)[0.5]{scénario}(2.5,4cm){vitesse~(mm/s)}
				...
				\begin{mysubsubsection}[sss-exp2-EvolutionDesPerformancesEnFonctionDeLaComplexiteDeLaTache-AnalyseEtDiscussion]{Analyse et discussion}
					...
					En observant les différences de performances entre les \myglos*{glo-Monome} et les \myglos*{glo-Binome} sur la \myref{fig-exp2-TempsDeRealisationDesScenariosEnFonctionDuNombreDeSujets}, on constate que la configuration collaborative n'a amélioré ses performances que dans le cas des tâches complexes.
					...
					Il y a donc peu d'intérêt à effectuer ces tâches peu complexes en configuration collaborative puisqu'aucune amélioration significative des performances n'est constatée.
				...
				\end{mysubsubsection}
			\end{mysubsection}
			\begin{mysubsection}[sse-exp2-AmeliorationDeLApprentissagePourLesBinomes]{Amélioration de l'apprentissage pour les binômes}
				...
				\begin{mysubsubsection}[sss-exp2-AmeliorationDeLApprentissagePourLesBinomes-DonneesEtStatistiques]{Données et statistiques}
					\begin{myfigure}
						...
						\begin{myboxgraph}[llx={-3em},yAxisLabelPos={-3em,c}](3,0.8\textwidth)[50]{essai}(200,4cm){temps~(s)}
					...
					\begin{myfigure}
						...
						\begin{myboxgraph}[llx={-3em},yAxisLabelPos={-3em,c}](3,0.8\textwidth)[50]{essai}(250,4cm){temps~(s)}
					...
					\begin{myfigure}
						...
						\begin{myboxgraph}(3,0.8\textwidth)[25]{essai}(100,4cm){nombre de sélections~(nb)}
					...
					\begin{myfigure}
						...
						\begin{myboxgraph}(3,0.8\textwidth)[0.5]{essai}(3,4cm){distance~(mm)}
					...
					\begin{myfigure}
						...
						\begin{myboxgraph}(3,0.8\textwidth)[0.5]{essai}(2.5,4cm){vitesse~(mm/s)}
				...
				\begin{mysubsubsection}[sss-exp2-AmeliorationDeLApprentissagePourLesBinomes-AnalyseEtDiscussion]{Analyse et discussion}
					...
					En effet, les \myglos*{glo-Binome} atteignent des performances optimales dès le second essai tandis que les \myglos*{glo-Monome} ont besoin de plus d'apprentissage pour converger vers de bonnes performances.
	...
	\begin{mychapter}[cha-LaDynamiqueDeGroupe]{La dynamique de groupe}
		\begin{mysection}[sec-exp3-Introduction]{Introduction}
			...
			L'augmentation du nombre de manipulateur nous permet également de confronter les utilisateurs à des tâches plus complexes que celles proposées dans les études précédentes.

			Selon la littérature en psychologie sociale, le travail en groupe provoque des modifications sur l'organisation et la structure \myref*{sec-sota-ConfigurationCollaborativePourLaResolutionDesTachesComplexes} qu'on nomme \og dynamique de groupe \fg.
		...
		\begin{mysection}[sec-exp3-CollaborationDeGroupe]{Collaboration de groupe}
			\begin{mysubsection}[sse-exp3-TravauxExistants]{Travaux existants}
				Nous avons déjà vu, dans la \myref{sec-sota-ConfigurationCollaborativePourLaResolutionDesTachesComplexes}, les dynamiques de groupe qui se mettent en place lors d'un travail en collaboration.
				...
				La \myglos{glo-ParesseSociale} est la tendance des collaborateurs à ne pas s'impliquer activement dans le travail de groupe (isolation, peur de l'évaluation, \myetc).
				...
				\mycite[author]{Osborn-1963} propose de mettre en place une séance de \mybrainstorming afin d'améliorer les performances de ces groupes restreints.
				L'idée est de créer une période de temps où tous les collaborateurs peuvent élaborer une stratégie sur la tâche à réaliser.
				...
				Cependant, \mycite[author]{Diehl-1987} tempèrent les avantages du \mybrainstorming en groupe.
				En effet, ils montrent que cette réflexion pré-opératoire peut également être effectuée de manière individuelle et que les individus seuls profitent plus de cette réflexion.
		...
		\begin{mysection}[sec-exp3-PresentationDeLExperimentation]{Présentation de l'expérimentation}
			...
			\begin{mysubsection}[sse-exp3-SpecificitesDuProtocoleExperimental]{Spécificités du protocole expérimental}
				...
				\begin{mysubsubsection}[sss-exp3-VisualisationEtRepresentation]{Visualisation et représentation}
					...
					\begin{myfigure}
						\psset{xunit=0.026034156\textheight,yunit=0.02\textheight}
						\begin{myps}(-10,-10)(10,10)
							\rput(0,0){\myimage[height=0.4\textheight]{exp3-scenario1}}
							\psset{nodesepA=3pt,linewidth=1pt,linearc=0.1,arrowinset=.2,arrowsize=1pt 3}
							\myexptwolabel(-7,-9.5)[exp3-1-fixed-label]{mygray}{Structure fixe}
							\pnode(-7,-6.2){exp3-1-fixed}
							\ncdiagg[angleA=90,linecolor=mygray]{c->}{exp3-1-fixed-label}{exp3-1-fixed}
							\myexptwolabel(6.5,9.5)[exp3-1-deformed-label]{myred}{Structure à déformer}
							\pnode(5.4,7.5){exp3-1-deformed}
							\ncdiagg[angleA=-90,linecolor=myred]{c->}{exp3-1-deformed-label}{exp3-1-deformed}
							\myexptwolabel(-5,6)[exp3-1-stable-label]{myblue}{Structure stable}
							\pnode(-3.4,3.2){exp3-1-stable}
							\ncdiagg[angleA=-90,linecolor=myblue]{c->}{exp3-1-stable-label}{exp3-1-stable}
						\end{myps}
					...
					\end{myfigure}
					\begin{myfigure}
						\psset{xunit=0.025884544\textheight,yunit=0.02\textheight}
						\begin{myps}(-11,-10)(11,10)
							\rput(0,0){\myimage[height=0.4\textheight]{exp3-scenario2}}
							\psset{nodesepA=3pt,linewidth=1pt,linearc=0.1,arrowinset=.2,arrowsize=1pt 3}
							\myexptwolabel(7,8)[exp3-2-fixed-label]{mygray}{Structure fixe}
							\pnode(2.6,5.4){exp3-2-fixed}
							\ncdiagg[angleA=-90,linecolor=mygray]{c->}{exp3-2-fixed-label}{exp3-2-fixed}
							\myexptwolabel(7.5,-8.5)[exp3-2-deformed-label]{myred}{Structure à déformer}
							\pnode(4.3,-6){exp3-2-deformed}
							\ncdiagg[angleA=90,linecolor=myred]{c->}{exp3-2-deformed-label}{exp3-2-deformed}
							\myexptwolabel(-8.5,7)[exp3-2-stable-label]{myblue}{Structure stable}
							\pnode(-8.5,-1.2){exp3-2-stable}
							\ncdiagg[angleA=-90,linecolor=myblue]{c->}{exp3-2-stable-label}{exp3-2-stable}
						\end{myps}
		...
		\begin{mysection}[sec-exp3-Resultats]{Résultats}
			\begin{mysubsection}[sse-exp3-AmeliorationDesPerformances]{Amélioration des performances}
				...
				\begin{mysubsubsection}[sss-exp3-AmeliorationDesPerformances-DonneesEtTestsStatistiques]{Données et tests statistiques}
					\begin{myfigure}
						...
						\begin{myboxgraph}[llx={-3em},yAxisLabelPos={-3em,c}](2,0.8\textwidth)[100]{scénario}(600,4cm){temps~(s)}
					...
					\begin{myfigure}
						...
						\mylegend{%
							\myleg{\myglosnl{glo-Binome}}{myblue}%
							\myleg{\myglosnl{glo-Quadrinome}}{myblue70}%
						}
						\begin{myboxgraph}[llx={-3em},yAxisLabelPos={-3em,c}](2,0.8\textwidth)[100]{scénario}(775,4cm){temps~(s)}
					...
					\begin{myfigure}
						...
						\begin{myboxgraph}[llx={-3.25em},yAxisLabelPos={-3.25em,c}](2,0.8\textwidth)[0.05]{scénario}(0.40,4cm){sélections~(nb/s)}
							\myboxplot{exp3-freqsel-molecule-group.csv}
						\end{myboxgraph}
						\mycaption[fig-exp3-FréquenceDesSelectionsPourLesScenariosEnFonctionDuNombreDeParticipants]{Fréquence des sélections pour les scénarios en fonction du nombre de participants}
					\end{myfigure}

					La \myref{fig-exp3-FréquenceDesSelectionsPourLesScenariosEnFonctionDuNombreDeParticipants} présente la fréquence de sélection \myvard{2} de chaque scénario \myvari{2} en fonction du nombre de sujets \myvari{1}.
					...
					\begin{myfigure}
						...
						\begin{myboxgraph}[llx={-3em},yAxisLabelPos={-3em,c}](2,0.8\textwidth)[0.25]{scénario}(1.25,4cm){vitesse~(mm/s)}
					...
					\begin{myfigure}
						...
						\begin{myboxgraph}(2,0.8\textwidth)[5]{scénario}(35,4cm){échanges verbaux~(nb)}
					...
					L'analyse montre un effet significatif du nombre de sujets \myvari{1} sur le nombre d'échanges verbaux \myvard{5} du scénario~\myscenario{1} (\myanova{exp3-talk-molecule-group-anova-prion.tex}); le nombre d'échanges est inférieur de \myratio{exp3-talk-molecule-group-ratio-prion.tex} pour les \myglos*{glo-Quadrinome}.
					De la même façon, l'analyse montre un effet significatif du nombre de sujets \myvari{1} sur le nombre d'échanges verbaux \myvard{5} du scénario~\myscenario{2} (\myanova{exp3-talk-molecule-group-anova-ubiquitin.tex}); le nombre d'échanges est inférieur de \myratio{exp3-talk-molecule-group-ratio-ubiquitin.tex} pour les \myglos*{glo-Quadrinome}.
				\end{mysubsubsection}
				\begin{mysubsubsection}[sss-exp3-AmeliorationDesPerformances-AnalyseEtDiscussion]{Analyse et discussion}
					...
					Les \myglos*{glo-Binome} et les \myglos*{glo-Quadrinome} ont également effectué des fréquences de sélections similaires ce qui appuie ce résultat \myref*{fig-exp3-FréquenceDesSelectionsPourLesScenariosEnFonctionDuNombreDeParticipants}.
			...
			\begin{mysubsection}[sse-exp3-UtiliteDuBrainstormingPourLaCollaboration]{Utilité du \mybrainstorming pour la collaboration}
				...
				\begin{mysubsubsection}[sss-exp3-UtiliteDuBrainstormingPourLaCollaboration-DonneesEtTestsStatistiques]{Données et tests statistiques}
					\begin{myfigure}
						\psset{xunit=0.274914089\textwidth,yunit=0.005cm}
						\begin{myboxgraph}[llx={-3em},yAxisLabelPos={-3em,c}](2,0.8\textwidth)[100]{\mybrainstorming}(600,4cm){temps~(s)}
					...
					\begin{myfigure}
						...
						\begin{myboxgraph}[llx={-3em},yAxisLabelPos={-3em,c}](2,0.8\textwidth)[100]{\mybrainstorming}(775,4cm){temps~(s)}
					...
					\begin{myfigure}
						...
						\begin{myboxgraph}[llx={-3.25em},yAxisLabelPos={-3.25em,c}](2,0.8\textwidth)[0.05]{\mybrainstorming}(0.35,4cm){sélections~(nb/s)}
							\myboxplot{exp3-freqsel-brainstorm-group.csv}
						\end{myboxgraph}
						\mycaption[fig-exp3-FréquenceDesSelectionsPourLesScenariosEnFonctionDesGroupesAvecOuSansBrainstorming]{Fréquence des sélections pour les scénarios en fonction des groupes avec ou sans \mybrainstorming}
					\end{myfigure}

					La \myref{fig-exp3-FréquenceDesSelectionsPourLesScenariosEnFonctionDesGroupesAvecOuSansBrainstorming} présente la fréquence de sélection \myvard{2} pour les groupes avec ou sans \mybrainstorming \myvari{3} en fonction du nombre de sujets \myvari{1}.
					...
					\begin{myfigure}
						...
						\begin{myboxgraph}[llx={-3em},yAxisLabelPos={-3em,c}](2,0.8\textwidth)[0.25]{\mybrainstorming}(1.25,4cm){vitesse~(mm/s)}
					...
					\begin{myfigure}
						...
						\begin{myboxgraph}(2,0.8\textwidth)[10]{\mybrainstorming}(55,4cm){communication~(nb)}
				...
				\begin{mysubsubsection}[sss-exp3-UtiliteDuBrainstormingPourLaCollaboration-AnalyseEtDiscussion]{Analyse et discussion}
					...
					Cependant, la \myref{fig-exp3-TempsDeRealisationDesScenariosEnFonctionDesGroupesAvecOuSansBrainstorming} et la \myref{fig-exp3-FréquenceDesSelectionsPourLesScenariosEnFonctionDesGroupesAvecOuSansBrainstorming} montrent que le \mybrainstorming est surtout profitable aux \myglos*{glo-Quadrinome}.
					...
					La \myref{fig-exp3-TempsDeRealisationDesScenariosEnFonctionDesGroupesAvecOuSansBrainstorming} et la \myref{fig-exp3-FréquenceDesSelectionsPourLesScenariosEnFonctionDesGroupesAvecOuSansBrainstorming} mettent en évidence l'amélioration des performances pour les \myglos*{glo-Quadrinome}.
				...
				\end{mysubsubsection}
			\end{mysubsection}
			\begin{mysubsection}[sse-exp3-DefinitionDUnMeneur]{Définition d'un meneur}
				...
				\begin{mysubsubsection}[sss-exp3-DefinitionDUnMeneur-DonneesEtStatistiques]{Données et statistiques}
					\begin{myfigure}
						...
						\begin{myboxgraph}[llx={-2em},yAxisLabelPos={-2em,c}](4,0.8\textwidth)[4]{sujets de \mygroup{1}}(10,4cm){ordres~(nb)}
					...
					\begin{myfigure}
						...
						\begin{myboxgraph}[llx={-3.25em},yAxisLabelPos={-3.25em,c}](4,0.8\textwidth)[0.25]{sujets de \mygroup{1}}(1.00,4cm){vitesse~(mm/s)}
					...
					On observe que la vitesse du sujet \mysubject{1} est plus élevée que la moyenne (\myanalysis{exp3-g1-speed-subject-analysis.tex} de plus que la moyenne).

					\begin{myfigure}
						\psset{xAxisLabel={temps~(s)},xAxisLabelPos={c,-5ex},llx={-2em},yAxisLabel={force~(N)},yAxisLabelPos={-2em,c},lly={-6ex}}
						\begin{mysubfigure}[0.95\textwidth]
							\begin{psgraph}[labels=all,ticks=all,Dx=25,Dy=1,yticksize={-3pt 125},ticklinestyle=dashed](125,5){0.8\textwidth}{4cm}
								\psscalebox{2.5 1}{\psfileplot[linecolor=myred,linewidth=0.1pt]{files/exp3-g1-force-prion-S1.csv}}
							\end{psgraph}
							\mysubcaption[fig-exp3-ProfilDeForceDuGroupeG1SurLaMoleculePrion-ProfilDeForceDeS1]{Profil de force de \mysubject{1}}
						\end{mysubfigure}
						\begin{mysubfigure}[0.95\textwidth]
							\begin{psgraph}[labels=all,ticks=all,Dx=25,Dy=1,yticksize={-3pt 125},ticklinestyle=dashed](125,5){0.8\textwidth}{4cm}
								\psscalebox{2.5 1}{\psfileplot[linecolor=myred,linewidth=0.1pt]{files/exp3-g1-force-prion-S2.csv}}
				...
				\begin{mysubsubsection}[sss-exp3-DefinitionDUnMeneur-AnalyseEtDiscussion]{Analyse et discussion}
					...
					Le \myglos{glo-Meneur} ne déploie pas autant de force car son objectif est d'explorer l'environnement, pas de déformer.
	...
	\begin{mychapter}[cha-TravailCollaboratifAssisteParHaptique]{Travail collaboratif assisté par haptique}
		\begin{mysection}[sec-exp4-Introduction]{Introduction}
			Sur la base des résultats obtenus dans les trois études précédentes, nous avons développé des outils haptiques afin d'améliorer la communication et la coordination des actions entre les utilisateurs durant la réalisation d'un \myglos{glo-DockingMoleculaire} collaboratif.
			Nous avons également identifié un certain nombre de facteurs permettant d'améliorer les performances d'un groupe (identification des rôles, \mybrainstorming, présence d'un \myglos{glo-Meneur}, \myetc).
		...
		\begin{mysection}[sec-exp4-AssistanceHaptiquePourLaCommunication]{Assistance haptique pour la communication}
			...
			\begin{mysubsection}[sse-exp4-TravauxExistants]{Travaux existants}
				Le concept de communication haptique apparaît dans les travaux de \mycite[author]{Sallnas-2000} avec une étude sur la manipulation synchrone d'objets \myThreeD dans environnement virtuel.
				...
				Sur la base de ces résultats, \mycite[author]{Oakley-2001} proposent de créer des outils haptiques pour la création de diagrammes \myacro{acr-UML} en environnement \myTwoD.
				...
				Puis, \mycite[author]{Enriquez-2006} créent une liste de phonèmes haptiques permettant la communication.
				...
				Récemment, \mycite[author]{Ullah-2011} s'est intéressé à l'influence de la communication haptique sur le sentiment de présence et sur la conscience périphérique \myref*{sec-sota-ConfigurationCollaborativePourLaResolutionDesTachesComplexes}.
			...
			\begin{mysubsection}[sse-exp4-OutilsHaptiquesPourLaCollaboration]{Outils haptiques pour la collaboration}
				...
				\begin{mysubsubsection}[sss-OutilPourLeCoordinateur]{Outils pour le coordinateur}
					...
					Nous avions souligné ce point lors de la première expérimentation et \mycite[author]{Moll-2009} mettent en avant la pertinence de la modalité haptique pour effectuer une désignation.
		...
		\begin{mysection}[sec-exp4-PresentationDeLExperimentation]{Présentation de l'expérimentation}
			\begin{mysubsection}[sse-exp4-DescriptionDeLaTache]{Description de la tâche}
				La tâche étudiée est constituée d'une tâche de déformation, telle que celle abordée dans les expérimentations précédentes \myref*{sse-exp2-DescriptionDeLaTache}, et d'une tâche d'assemblage; les deux tâches abordées permettent de créer un scénario de \myglos{glo-DockingMoleculaire} complet.
				...
				\begin{description}
					...
					\item[Scénario~\myscenario{2}]
						...
						La molécule \myNusE est ancrée dans l'environnement virtuel à l'aide d'atomes fixes (sa chaîne carbonée).
				\end{description}
			...
			\begin{mysubsection}[sse-exp4-SpecificitesDuProtocoleExperimental]{Spécificités du protocole expérimental}
				...
				\begin{mysubsubsection}[sss-exp4-VisualisationEtRepresentation]{Visualisation et représentation}
					...
					\begin{myfigure}
						\psset{xunit=0.026337761\textheight,yunit=0.02\textheight}
						\begin{myps}(-10,-10)(10,10)
							\rput(0,0){\myimage[height=0.4\textheight]{exp4-scenario1}}
							\psset{nodesepA=3pt,linewidth=1pt,linearc=0.1,arrowinset=.2,arrowsize=1pt 3}
							\myexptwolabel(7,8)[exp3-2-fixed-label]{mygray}{Structure fixe}
							\pnode(2.6,5.4){exp3-2-fixed}
							\ncdiagg[angleA=-90,linecolor=mygray]{c->}{exp3-2-fixed-label}{exp3-2-fixed}
					...
					\end{myfigure}
					\begin{myfigure}
						\psset{xunit=0.021854975\textheight,yunit=0.02\textheight}
						\begin{myps}(-10,-10)(10,10)
							\rput(0,0){\myimage[width=0.4\textheight,angle=-90]{exp4-scenario2}}
							\psset{nodesepA=3pt,linewidth=1pt,linearc=0.1,arrowinset=.2,arrowsize=1pt 3}
							\myexptwolabel(7,5)[exp3-2-nuse-stable-label]{myblue}{\myNusE stable}
							\pnode(7,1.5){exp3-2-nuse-stable}
							\ncdiagg[angleA=-90,linecolor=myblue]{c->}{exp3-2-nuse-stable-label}{exp3-2-nuse-stable}
							\myexptwolabel(3,9.5)[exp3-2-nusg-deformed-label]{myred}{\myNusG à déformer}
							\pnode(-0.6,6.6){exp3-2-nusg-deformed}
							\ncdiagg[angleA=-90,linecolor=myred]{c->}{exp3-2-nusg-deformed-label}{exp3-2-nusg-deformed}
							\myexptwolabel(-7,-8)[exp3-2-nusg-stable-label]{myblue}{\myNusG stable}
							\pnode(-6,-5.6){exp3-2-nusg-stable}
							\ncdiagg[angleA=90,linecolor=myblue]{c->}{exp3-2-nusg-stable-label}{exp3-2-nusg-stable}
						\end{myps}
					...
					\begin{myparagraph}[par-exp4-OutilDeDeformation]{Outil de déformation}
						\begin{description}
							...
							\item[Fonctionnement]
								...
								Soit il choisit de déformer de manière autonome; dans ce cas, il ne peut manipuler qu'un atome à la fois.
			...
			\begin{mysubsection}[sse-exp4-AmeliorationDesPerformances]{Amélioration des performances}
				...
				\begin{mysubsubsection}[sss-exp4-AmeliorationDesPerformances-DonneesEtTestsStatistiques]{Données et tests statistiques}
					\begin{myfigure}
						...
						\begin{myboxgraph}[llx={-2em},yAxisLabelPos={-2em,c}](2,0.8\textwidth)[1]{haptique}(6,4cm){score \myacronl{acr-RMSD}}
					...
					\begin{myfigure}
						...
						\begin{myboxgraph}[llx={-3em},yAxisLabelPos={-3em,c}](2,0.8\textwidth)[100]{haptique}(500,4cm){temps~(s)}
					...
					\begin{myfigure}
						...
						\mylegend{%
							...
							\myleg{avec assistance}{myblue70}%
						}
						\begin{myboxgraph}[llx={-3em},yAxisLabelPos={-3em,c}](2,0.8\textwidth)[100]{scénario}(550,4cm){temps~(s)}
					...
					\begin{myfigure}
						...
						\begin{myboxgraph}[llx={-3.5em},yAxisLabelPos={-3.5em,c}](2,0.8\textwidth)[0.025]{haptique}(0.150,4cm){fréquence~(nb/s)}
					...
					\begin{myfigure}
						...
						\begin{myboxgraph}(2,0.8\textwidth)[5]{haptique}(25,4cm){temps~(s)}
					...
					\begin{myfigure}
						...
						\begin{myboxgraph}(2,0.8\textwidth)[10]{haptique}(40,4cm){temps~(s)}
				...
				\begin{mysubsubsection}[sss-exp4-AmeliorationDesPerformances-AnalyseEtDiscussion]{Analyse et discussion}
					...
					Le complexe de molécules \myNusENusG est la tâche la plus complexe à réaliser notamment à cause du nombre important de \myglos*{glo-Residu} à déformer.
			...
			\begin{mysubsection}[sse-exp4-AmeliorationDeLaCommunication]{Amélioration de la communication}
				...
				\begin{mysubsubsection}[sss-exp4-AmeliorationDeLaCommunication-DonneesEtTestsStatistiques]{Données et tests statistiques}
					\begin{myfigure}
						...
						\begin{myboxgraph}[llx={-2em},yAxisLabelPos={-2em,c}](2,0.8\textwidth)[2]{haptique}(10,4cm){temps~(s)}
					...
					\begin{myfigure}
						...
						\begin{myboxgraph}(2,0.8\textwidth)[5]{haptique}(15,4cm){sélections~(nb)}
					...
					\begin{myfigure}
						...
						\begin{myboxgraph}[llx={-3em},yAxisLabelPos={-3em,c}](2,0.8\textwidth)[0.2]{haptique}(1.0,4cm){vitesse~(mm/s)}
					...
					L'analyse montre un effet significatif de l'assistance haptique \myvari{1} sur cette vitesse \myvard{8} (\myanova{exp4-speed-haptic-anova.tex}); la vitesse moyenne est supérieure de \myratio{exp4-speed-haptic-ratio.tex} avec l'assistance haptique.

					\begin{myfigure}
						\psset{xunit=0.274914089\textwidth,yunit=0.016cm}
						\begin{myboxgraph}[llx={-3em},yAxisLabelPos={-3em,c}](2,0.8\textwidth)[50]{haptique}(250,4cm){temps~(s)}
					...
					\begin{myfigure}
						\psset{xunit=0.274914089\textwidth,yunit=0.016cm}
						\begin{myboxgraph}[llx={-3em},yAxisLabelPos={-3em,c}](2,0.8\textwidth)[50]{haptique}(300,4cm){temps~(s)}
		...
		\begin{mysection}[sec-exp4-Conclusion]{Conclusion}
			\begin{mysubsection}[sse-exp4-ResumeDesResultats]{Résumé des résultats}
				...
				De plus, la répartition de la communication sur différents canaux sensoriels permet de soulager de la charge cognitive de travail pour chaque utilisateur.
			...
			\begin{mysubsection}[sse-exp4-SyntheseEtPerspectives]{Synthèse et perspectives}
				...
				On peut se reporter aux travaux de \mycite[author]{Oakley-2001} qui proposent plusieurs métaphores sur le sujet qui devrait permettre d'améliorer la conscience de groupe comme l'ajout de la perception haptique entre les utilisateurs au sein de l'environnement virtuel ou encore la possibilité d'emmener le curseur d'un partenaire pour le guider vers une cible.
	...
	\begin{mychapter+}[cha-ConclusionEtPerspectives]{Conclusion et perspectives}
		Durant ce travail de thèse, nous avons étudié différentes configurations collaboratives dans le contexte particulier de la collaboration étroitement couplée pour la résolution de tâches complexes, en l'occurence, le \myglos{glo-DockingMoleculaire}.
		...
		Tout d'abord, nous avons pu constater un gain en performances lié à la distribution des charges de travail, notamment dans la seconde étude \myref*{cha-DeformationCollaborativeDeMolecule} dans laquelle nous comparons deux distributions différentes des ressources; ces conclusions vont dans le même sens que les études de \mycite[author]{Bandura-1986} ou de \mycite[author]{Foushee-1987} sur la collaboration.
		Cependant, la collaboration étroitement couplée provoque des \myglos*{glo-ConflitDeCoordination} entre les utilisateurs (accès concurrent à une zone, besoin de coordination, \myetc) comme expliqué par \mycite[author]{Latane-1979}.
		La troisième étude nous a permis de constater que ces \myglos*{glo-ConflitDeCoordination} sont nombreux dans une collaboration étroitement couplée avec pour effet de réduire considérablement les gains en performances.

		Nous avons également pu observer les effets de la \myglos{glo-FacilitationSociale} au cours des différentes configurations collaboratives évaluées.
		Pourtant, \mycite[author]{Zajonc-1965} avait évoqué une décroissance des performances sur des tâches complexes.
		Les travaux de \mycite[author]{Zajonc-1965} évoquaient des collaborations faiblement couplées contrairement à notre contexte de collaboration.
		...
		Dans le cadre du \myglos{glo-DockingMoleculaire}, les objectifs ne sont pas forcément atteignables et il est possible que cela entraîne un niveau de motivation du groupe différent.

		Au cours de la troisième étude \myref*{cha-LaDynamiqueDeGroupe}, nous avons pu arriver à des conclusions similaires à celles obtenues par \mycite[author]{Bales-1950} concernant l'apparition de membres dominants au sein d'un groupe.
		...
		L'ensemble de ces conclusions nous a mené à l'établissement d'une nouvelle configuration de travail (\myglos{glo-Meneur} et \myglos*{glo-Suiveur}) et à fournir des outils haptiques adaptés à chacun des rôles pour améliorer la coordination et la communication.
		Cette nouvelle configuration de travail a montré son efficacité dans la dernière expérimentation \myref*{cha-TravailCollaboratifAssisteParHaptique} dans laquelle des évolutions significatives en terme de communication ont été observées.
		D'ailleurs, cette expérimentation nous a permis de confirmer les hypothèses non-évaluées de \mycite[author]{Moll-2009} concernant l'utilité de la modalité haptique pour assister le processus de désignation.
		...
		Puis, sur la base de mes travaux de thèse, Adrien \myname{Girard} se propose d'étudier le potentiel de la modalité haptique pour la communication et la conscience périphérique sur des tâches élémentaires de déformation collaborative.
		...
		En effet, nous avons pu voir que le \myglos{glo-DockingMoleculaire} fait appel à des spécialités diverses.
		...
		La collaboration distante n'a également pas été abordée dans ce travail de thèse.
		...
		La communauté a visiblement un réel besoin de ce type de plateforme au regard de l'étude bibliographique \myref{cha-sota-EtudeBibliographique} où la plupart des plateformes présentées permettent des collaborations distantes.
		...
		Cependant, nous avons eu des difficultés pour mesurer, quantifier ou même qualifier ces \myglos*{glo-ConflitDeCoordination} et de la même façon, les conflits de communication.
		Il est nécessaire de définir des mesures objectives permettant de répondre à cette problématique.

		De nombreux champs restent à explorer en ce qui concerne les configurations collaboratives étroitement couplées.
	...
	\begin{mychapter}[cha-pro-DispositifExperimental]{Dispositif expérimental}
		\begin{mysection}[sec-pro-MaterielExperimental]{Matériel expérimental}
			...
			L'affichage de la scène virtuelle est assuré par un vidéoprojecteur connecté à l'ordinateur~\mycomputer{A}.
			...
			Afin que la communication entre les sujets soit optimale, aucune contrainte de communication ne leur est donnée et ils sont libres d'utiliser tous les moyens de communication possibles (verbaux, gestuels, virtuels, \myetc).
		...
		\begin{mysection}[sec-pro-PresentationsDesMolecules]{Présentation des molécules}
			...
			À partir de ces molécules, différents scénarios ont été conçus et les difficultés sont décrites au-fur-et-à-mesure de la présentation des différentes expérimentations.
		...
		\begin{mysection}[sec-pro-OutilsDeManipulation]{Outils de manipulation}
			...
			Au cours des trois premières expérimentations, seules quelques modifications du rendu visuel associés à ces outils sont effectuées.
	...
	\begin{mychapter}[cha-met-MethodeExperimentale]{Méthode expérimentale}
		\begin{mysection}[sec-met-exp1-PremiereExperimentation]{Première expérimentation}
			...
			\begin{mysubsection}[sse-met-exp1-Variables]{Variables}
				\begin{mysubsubsection}[sss-met-exp1-VariablesIndependantes]{Variables indépendantes}
					...
					\begin{myparagraph}[par-met-exp1-ResiduRecherche]{\myvari{2} \myGlosnl{glo-Residu} recherché}
						...
						Différents niveaux de complexité caractérisent chaque \myglos{glo-Residu} \myref*{tab-exp1-CriteresDeComplexiteDesResidus}.
					\end{myparagraph}
				\end{mysubsubsection}
			...
			\begin{mysubsection}[sse-met-exp1-Procedure]{Procédure}
				...
				Un \myglos{glo-Residu} est proposé et doit être identifié et extrait.
		...
		\begin{mysection}[sec-met-exp2-SecondeExperimentation]{Seconde expérimentation}
			...
			\begin{mysubsection}[sse-met-exp2-Procedure]{Procédure}
				...
				Lorsque la phase d'entraînement est terminée, les sujets sont confrontés aux scénarios \myscenario{1a} et \myscenario{1b}.
		...
		\begin{mysection}[sec-met-exp4-QuatriemeExperimentation]{Quatrième expérimentation}
			...
			\begin{mysubsection}[sse-met-exp4-Procedure]{Procédure}
				...
				\begin{myparagraph}[par-met-exp4-Phase9-LeQuestionnaire]{Phase~\mynum{9} : questionnaire d'utilisabilité}
					...
					Durant cette phase, il est demandé aux sujets de ne pas communiquer entre eux.
					Des informations permettant de caractériser le sujet (âge, sexe, main dominante, \myetc) sont également demandées à la fin du questionnaire.
	...
	\begin{mychapter}[cha-Questionnaires]{Questionnaires}
		...
		\begin{mysection}[sec-q-SecondeExperimentation]{Seconde expérimentation}
			...
			\begin{mysubsection}[sse-q-SecondeExperimentation-QuestionnairePourLesMonomes]{Questionnaire pour les monômes}
				...
				\end{enumerate}
			\end{mysubsection}
			\begin{mysubsection}[sse-q-SecondeExperimentation-QuestionnairePourLesBinomes]{Questionnaire pour les binômes}
				Chaque sujet dans un \myglos{glo-Binome} est interrogé séparement pour éviter que les réponses de l'un n'influence pas les réponses de l'autre.
		...
		\begin{mysection}[sec-q-QuatriemeExperimentation]{Quatrième expérimentation}
			Le questionnaire proposé durant la quatrième expérimentation contient une traduction en français du questionnaire \myacro{acr-SUS} proposé par \mycite[author]{Brooke-1996}.
			...
			\begin{mysubsection}[sse-q-QuatriemeExperimentation-LeQuestionnaireSUS]{Le questionnaire \textsc{sus}}
	...
	\newpage
	\loadgeometry{LIMSI}
	\RappelReference{2012 - 11}
	{Mars 2012}
	{Collaboration haptique étroitement couplée pour la déformation moléculaire interactive}
	{J. \textsc{Simard}}

	\Title{Closely coupled haptic collaboration for interactive molecular deformation}

	\Resume{%
		Le \emph{docking} moléculaire est une tâche complexe, difficile à appréhender pour une personne seule.
		...
		Trois expérimentations ont permis de valider l'intérêt d'une approche collaborative pour des tâches complexes à fort couplage.
		Cependant, elle a mis en évidence des conflits de coordination et de communication.
	...
	\MotsClefs{\emph{docking} moléculaire, communication haptique, collaboration étroite, interaction haptique}

	\Abstract{%
		Molecular docking is a complex problem for one person.
		We propose to study the cognitive distribution of the workload in a collaborative configuration.
		A distributed platform for the molecular deformation has been developed to study the closely coupled collaboration.
		Three experimental studies confirm the pertinence of the collaborative configuration for closely coupled collaboration.
		However, we observe coordination and communication conflicts.
		Based on these results, we developed tools to assist the collaboration through haptic communication.
		A last experimentation with bio-informaticians showed the gain of efficiency with the help of these haptic communication tools.
	}

	\KeyWords{molecular docking, haptic communication, closely coupled collaboration, haptic interaction}
\end{document}
