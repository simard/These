...
\newcommand{\myAutoDock}{\textsc{AutoDock}\xspace}
% BBB
\newcommand{\mybrainstorming}{\myemph{brainstorming}\xspace}
\newcommand{\myBoxSearch}{\textsc{BoxSearch}\xspace}
% CCC
