...
\newcommand{\myawareness}{\textit{awareness}\xspace}
% BBB
\newcommand{\mybrainstorming}{\textit{brainstorming}\xspace}
...
\newcommand{\myChemicalForceFeedback}{\textit{Chemical Force Feedback}\xspace}
...
\newcommand{\myFoldIt}{\begin{otherlanguage}{english}Fold It!\end{otherlanguage}}
...
\newcommand{\mygrounding}{\textit{grounding}\xspace}
\newcommand{\mygroup}[1]{$\mathcal{G}_{#1}$\xspace}
% HHH
\newcommand{\myHaption}{Haption\xspace}
\newcommand{\myHawthorne}{\textit{Hawthorne Works}\xspace}
...
\newcommand{\mySIDA}{\textsc{sida}\xspace}
...
% WWW
\newcommand{\myWiki}{\textit{Wiki}\xspace}
\WithSuffix\newcommand\myWiki*{\textit{Wikis}\xspace}
\newcommand{\myWikipedia}{Wikipedia\xspace}
\newcommand{\myWindows}{Windows\xspace}
\newcommand{\myWorkbench}{\textit{Workbench}\xspace}
