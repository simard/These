							...
							\uput{0pt}[90](0.3,0){%
								\psframebox*[fillcolor=black!5,framearc=0.25,boxsep=true,framesep=5pt]{%
									\begin{psmatrix}[colsep=0pt,rowsep=2ex]
										...
										\begin{mygraph}[labels=none,ticks=none,xAxisLabel={\footnotesize d (distance)},xAxisLabelPos={c,-1.5ex},llx={-1.5ex},yAxisLabel={\footnotesize F (force)},yAxisLabelPos={-1.5ex,c},lly={-1.5ex}]{->}(4.5,2.5){3cm}{1cm}%
