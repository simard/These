...
\begin{document}
	...
	\begin{frame}{Organisation logicielle de la plateforme \myShaddock}
		\begin{myfigure}
	...
	\begin{frame}{Organisation matérielle de la plateforme \myShaddock}
	...
	\begin{frame}[label=current]{Outils supplémentaires proposés}
		\begin{myblock}{Objectif}
