...
\usepackage[%
	...
	\captionsetup{figurename={},justification=centering,font={bf,color=black!75}}
...
\begin{document}
		...
		\begin{columns}
			...
			\begin{column}{0.475\textwidth}
				\begin{myfigure}
					...
					\mycaption[fig-sota-VisualisationMultimodaleFerey2009]{Visualisation multimodale \mycite{Ferey-2009}}
				\end{myfigure}
			\end{column}
		\end{columns}
		\vspace{-3ex}
	...
	\begin{myframe}{Objectifs de la thèse}
		\begin{myminusblock}{Problématiques}
			\begin{itemize}
				\item Quels sont les avantages de la collaboration étroitement couplée ?
					\note[item]{Quelles sont les influences d'une collaboration nécessitant une forte coordination entre les collaborateurs ?}
				\item Quelles problématiques la collaboration pose-t-elle ?
				\item Comment améliorer la collaboration dans un environnement complexe ?
			\end{itemize}
		\end{myminusblock}
		\begin{myplusblock}{Démarche}
			\begin{enumerate}
				\item Étudier et caractériser les approches collaboratives étroitement couplée
				\item Identifier les limites et les contraintes
				\item Proposer des solutions haptiques pour améliorer la collaboration
		...
		\begin{columns}
			\begin{column}{0.35\textwidth}
				\begin{myplusblock}{Fonctionnalités}
					\begin{itemize}
						\item<1-> Colocalisé synchrone
						\item<1-> Communication orale et gestuelle
						\item<2-> Vue partagée
						\item<3-> Différents outils
							\begin{itemize}
								\item déplacement
								\item orientation
								\item déformation
							\end{itemize}
						\item<5-> Multiples interfaces
					\end{itemize}
				\end{myplusblock}
			\end{column}
			\begin{column}{0.6\textwidth}
	...
	\begin{myframe}{Organisation logicielle}
		\begin{myfigure}
			...
			\begin{myps}(-7.5,-7)(7.5,6)
				...
				\psframe*[linecolor=mygreen!5,shadow=false](-7.4,-7)(-2.6,6)
				\psframe*[linecolor=myblue!5,shadow=false](-2.4,-7)(2.4,6)
				\psframe*[linecolor=myred!5,shadow=false](2.6,-7)(7.4,6)
				...
				\pnode(5,-6.75){PHANToM2}
				\nccurve[linestyle=dashed,arrowinset=0,ArrowFill=false,angleA=-90,angleB=90]{-}{VRPN2}{PHANToM2}%
			\end{myps}
