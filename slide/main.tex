...
\usepackage{pgfpages}
\usepackage{csquotes}
\usepackage[sorting=ydnt,hyperref=true,backend=biber,style=authoryear,citestyle=authoryear-comp,bibstyle=authoryear,abbreviate=true,date=short,urldate=short,block=space,maxcitenames=2,maxbibnames=99]{biblatex}
...
\DeclareNameFormat{sortname}{% 
	...
	{\let\mkbibnamefirst=\textbf\color{myblue}%
		\let\mkbibnamelast=\textbf\color{myblue}%
		\let\mkbibnameprefix=\textbf\color{myblue}%
		\let\mkbibnameaffix=\textbf\color{myblue}}%
	{}%
...
\begin{document}
		...
		\begin{columns}
			...
			\begin{column}{0.475\textwidth}
				\begin{myfigure}
					...
					\mycaption[fig-sota-InterfaceHaptiqueA5DDLPourLeDockingLaiYuen2006]{Interface haptique à \mynum[\textsc{ddl}]{5} pour le \mydocking \mycite{Lai-Yuen-2006}}
				\end{myfigure}
			\end{column}
		\end{columns}
		\begin{columns}
			...
			\begin{column}{0.475\textwidth}
				\begin{myfigure}
					...
					\mycaption[fig-sota-ModeleHaptiquePourLeManipulationMoleculaire]{Modèle haptique pour la manipulation moléculaire \mycite{Hou-2010}}
				\end{myfigure}
			\end{column}
		\end{columns}
		\onslide<2>{%
		...
		\begin{columns}
			...
			\begin{column}{0.475\textwidth}
				\begin{myfigure}
					...
					\mycaption[fig-sota-ManipulationAsymetriqueGuideeParDesExpertsPark2006]{Manipulation asymétrique guidée par des experts \mycite{Park-2006}}
				\end{myfigure}
			\end{column}
		\end{columns}
		\begin{columns}
	...
	\begin{myframe}{Organisation matérielle}
		...
		\only<4>{
			\begin{itemize}
				\item Outil pour la \alert{déformation} ou le \alert{déplacement} de molécule (\myOmni)
			\end{itemize}
		}
		\only<5>{
			\begin{itemize}
				\item Outil pour l'\alert{orientation} de la molécule (SpaceTraveler de 3\textsc{d}connexion\myregistered{})
			\end{itemize}
		}
		\only<6>{
			\begin{itemize}
			...
			\only<1-7>{%
				\begin{column}{0.5\textwidth}%
					\begin{myblock}{Description}%
						Basé sur les PC Virtuelles \mycite{Fuchs-2006}%
						\begin{description}%
...
%		\end{myfigure}
	...
	\begin{myframe}{Stratégies de travail}
		\begin{myfigure}
			...
			\begin{myboxgraph}[lly=-5ex,xAxisLabelPos={c,-5ex}](12,0.75\textwidth)[4]{binôme}(24,2cm){distance~(mm)}
				...
				\listplot[linecolor=myred,linewidth=2pt,showpoints=true,shadow=false]{\affinitygroupsdata}
		...
		\begin{columns}[t]
			\begin{column}{0.3\textwidth}
				\begin{myblock}{Scénarios}
					\begin{itemize}
						\item \mynum{2}~niveaux de complexité
	...
	\begin{myframe}{Synthèse}
		\begin{columns}[t]
			...
			\begin{column}{0.475\textwidth}
				...
				\begin{myplusblock}{Résultats}
					\begin{itemize}
						\item Différentes complexité pour la manipulation collaborative
		...
		\begin{columns}[T]
			\begin{column}{0.65\textwidth}
				\begin{myfigure}
					...
					\begin{myboxgraph}(2,0.8\textwidth)[0.1]{\mybrainstorming}(0.45,1.9cm){sélections~(nb/s)}
	...
	\end{myframe}
	\subsubsection{Objectifs}
	\begin{myframe}[label=current]{Objectifs}
		\begin{myblock}{Objectif principal}
	...
	\begin{myframe}{Efficacité de la collaboration}
		\begin{myfigure}
			...
			\begin{myboxgraph}[llx=-3em,yAxisLabelPos={-3em,c}](2,0.9\textwidth)[200]{scénario}(700,2cm){temps~(s)}
		...
		\begin{myfigure}
			...
			\begin{myboxgraph}[llx=-3em,yAxisLabelPos={-3em,c}](2,0.9\textwidth)[0.05]{scénario}(0.125,2cm){fréquence~(nb/s)}
	...
	\begin{myframe}{Amélioration de la communication}
		\begin{myfigure}
			\begin{myboxgraph}[llx=-2em,yAxisLabelPos={-2em,c}](2,0.6\textwidth)[2]{haptique}(10,2cm){temps~(s)}
				\myboxplot{exp4-shake-time-haptic.csv}
			\end{myboxgraph}
			\mycaption[fig-exp4-TempsMoyenDAcceptationDUneDesignation]{Temps moyen d'acceptation d'une désignation}
		\end{myfigure}
		\begin{myfigure}
			\begin{myboxgraph}(2,0.6\textwidth)[5]{haptique}(17.5,2cm){sélections~(nb)}
	...
	\begin{myframe}{Journaux internationaux}
		\printbibliography[type=article,category=myrefs]
	\end{myframe}
	\begin{myframe}{Conférences internationales}
