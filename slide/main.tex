...
\begin{document}
	...
	\begin{myframe}{Objectifs}
		...
		\begin{myblock}{Variables}
			\begin{description}
				...
				\item[Complexité du \emph{residue}] Forme, nature, position, similarités\dots{}
			\end{description}
		\end{myblock}
	\end{myframe}
	...
	\begin{myframe}{Stratégies de travail}
		...
		\end{myfigure}
	\end{myframe}
	\subsubsection[Synthèse]{Synthèse de l'étude~\mynum{1}}
	\begin{myframe}{Synthèse de l'étude~\mynum{1}}
		\begin{columns}[t]
			\begin{column}{0.475\textwidth}
				\centering
	...
	\begin{myframe}{Objectifs}
		...
		\begin{myblock}{Variables}
			\begin{description}
				...
				\item[Complexité de la molécule] \mynum{2}~molécules de taille différente
	...
	\begin{myframe}{Influence de la complexité de la tâche}
		...
		\end{mytable}
	\end{myframe}
	\subsubsection[Synthèse]{Synthèse de l'étude~\mynum{2}}
	\begin{myframe}{Synthèse de l'étude~\mynum{2}}
		\begin{columns}[t]
			\begin{column}{0.475\textwidth}
				\centering
			...
			\begin{column}{0.475\textwidth}
				...
				\begin{myminusblock}{Limites}
					\begin{itemize}
						\item La coordination est plus efficace en individuel
					\end{itemize}
				\end{myminusblock}
			\end{column}
		\end{columns}
	...
	\begin{myframe}{Objectifs}
		...
		\begin{myplusblock}{Hypothèses}
			\begin{enumerate}
				...
				\item Influence d'une étape de \textit{brainstorming} sur les performances
			\end{enumerate}
		\end{myplusblock}
		\begin{myblock}{Variables}
			\begin{description}
				\item[Nombre de participants] \mynum{8}~couples et \mynum{4}~groupes
				\item[Tâche différente] \mynum{2}~molécules (tâche faiblement et fortement couplées)
				\item[Stratégie] Étape de \textit{brainstorming}
			\end{description}
		\end{myblock}
	\end{myframe}
	\subsubsection{Protocole expérimental}
	...
	\begin{myframe}{Amélioration des performances}
		\begin{myfigure}
			...
			\begin{myboxgraph}(2,0.6\textwidth)[0.5]{scénario}(1.75,2cm){vitesse~(mm/s)}
		...
		\begin{myfigure}
			...
			\begin{myboxgraph}(2,0.6\textwidth)[10]{scénario}(40,2cm){échanges~(nb)}
				\myboxplot{exp3-talk-molecule-group.csv}
			\end{myboxgraph}
			\mycaption[fig-exp3-NombreDEchangeVerbaux]{Nombre d'échanges verbaux}
		\end{myfigure}
	\end{myframe}
	\begin{myframe}{Influence du \textit{brainstorming}}
		\begin{myfigure}
			\mylegend{%
				\myleg{binôme}{myblue}%
				\myleg{quadrinôme}{myblue!70}%
			}
			\begin{myboxgraph}[llx=-3em,yAxisLabelPos={-3em,c}](2,0.6\textwidth)[300]{\textit{brainstorming}}(1100,2cm){temps~(s)}
		...
		\begin{myfigure}
			...
			\begin{myboxgraph}(2,0.6\textwidth)[0.1]{\textit{brainstorming}}(0.45,2cm){sélections~(nb/s)}
				\myboxplot{exp3-freqsel-brainstorm-group.csv}
			\end{myboxgraph}
			\mycaption[fig-exp3-FrequenceDesSelections]{Fréquence des sélections}
		\end{myfigure}
	\end{myframe}
	\subsubsection[Synthèse]{Synthèse de l'étude~\mynum{3}}
	\begin{myframe}{Synthèse de l'étude~\mynum{3}}
		\begin{columns}[t]
			\begin{column}{0.475\textwidth}
				\centering
			...
			\begin{column}{0.475\textwidth}
				\centering
				\myunode[90][shadowcolor=myblue](0,0)[brainstorming-problem]{\textit{Brainstorming}}[4cm]
				\begin{myplusblock}{Résultats}
					\begin{itemize}
						\item Amélioration importante des performances
						\item Conflits de communication pendant le \textit{brainstorming}
	...
	\begin{myframe}{Objectifs}
		...
		\begin{myblock}{Hypothèses}
			\begin{enumerate}
				\item Influence des propositions sur les performances
				\item Influence des propositions sur la communication
				\item Évaluations des propositions par des experts
			\end{enumerate}
		\end{myblock}
		\begin{myblock}{Variables}
			\begin{description}
				\item[Nombre de participants] \mynum{8}~trinômes
				\item[Tâche] \mynum{2}~molécules (tâche faiblement et fortement couplée)
				\item[Assistance haptique] Avec ou sans assistance
			\end{description}
		\end{myblock}
	\end{myframe}
	\subsubsection{Résultats}
