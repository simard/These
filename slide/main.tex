...
\usepackage{pgfpages}
\usepackage{csquotes}
\usepackage[sorting=ydnt,hyperref=true,backend=biber,style=authoryear,citestyle=authoryear-comp,bibstyle=authoryear,abbreviate=true,date=short,urldate=short,block=space,maxcitenames=1,maxbibnames=99]{biblatex}
