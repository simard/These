...
let s:sections={"document":"Document","mypart":"Partie","mychapter":"Chapitre","mysection":"Section","mysubsection":"Sous-section","mysubsubsection":"Sous-sous-section","myparagraph":"Paragraphe","mysubparagraph":"Sous-paragraphe","itemize":"Liste à items","enumerate":"Énumération","description":"Liste de descriptions","minipage":"Mini-page","myTodo":"À faire","myquote":"Citation","myabstract":"Résumé","mykeywords":"Mots-clefs","frame":"Slide","block":"Bloc","comment":"Commentaires"}
let s:sections_flag="\%(\*\|-\|+\)"
