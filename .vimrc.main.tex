...
noremap <F6> :wa<Enter>:!/usr/bin/time -p make review<Enter>
...
let s:sections={"document":"Document","mypart":"Partie","mychapter":"Chapitre","mysection":"Section","mysubsection":"Sous-section","mysubsubsection":"Sous-sous-section","myparagraph":"Paragraphe","mysubparagraph":"Sous-paragraphe","itemize":"Liste à items","enumerate":"Énumération","description":"Liste de descriptions","minipage":"Mini-page","myTodo":"À faire","myquote":"Citation"}
let s:sections_flag="\%(\*\|-\|+\)"
