...
\jury{%
	\jurymember{Professeur}{Indira}{Thouvenin}{rapporteur}{Université de technologie de \myname{Compiègne}}
	\jurymember{Maître de Conférence}{Jean-Marie}{Burkhardt}{rapporteur}{Institut Français des Sciences et Technologies des Transports, de l'Aménagement et des Réseaux (\myIFSTTAR)}
	\jurymember{Professeur}{Abdulmotaleb}[el]{Saddik}{examinateur}{Université d'\myname{Ottawa}}
	\jurymember{Chargé de recherche}{Marc}{Baaden}{examinateur}{Laboratoire de Biochimie Théorique}
	\jurymember{Professeur}{Philippe}{Tarroux}{directeur}{École Normale Supérieure}
	\jurymember{Maître de Conférence}{Mehdi}{Ammi}{encadrant}{Université de \myname{Paris}-Sud}
}
...
\begin{document}
	...
	\begin{mychapter}[cha-Shaddock-ManipulationCollaborativeDeMolecules]{\myShaddock\ -- Plate-forme de manipulation collaborative de molécules}
		\begin{mysection}[sec-Shaddock-Introduction]{Introduction}
			...
			Cependant, afin d'obtenir une simulation moléculaire interactive temps-réel, un module spécifique doit être ajouté; il sera présenté dans la \myref{sss-Shaddock-PlateFormeDeSimulationMoleculaireInteractiveEtTempsReel}.
		...
		\begin{mysection}[sec-Shaddock-ArchitectureMaterielleEtLogicielle]{Architecture matérielle et logicielle}
			\begin{mysubsection}[sse-Shaddock-TravailCollaboratifSynchroneEtColocalise]{Travail collaboratif synchrone et colocalisé}
				...
				Tout d'abord, la \myref{sss-sota-LaConscienceDeGroupe} évoque les problématiques liées à la conscience périphériques des partenaires dans la réalisation d'une tâche collaborative.
			...
			\begin{mysubsection}[sse-Shaddock-ArchitectureLogicielleAdoptee]{Architecture logicielle adoptée}
				Deux types d'architectures ont été explorés pour les \myacro*{acr-EVC} : client/serveur ou pair-à-pair\footnote{\myemph{Peer-to-peer} en anglais, parfois abrégé en \textsc{p2p}.}.
				...
				\begin{mysubsubsection}[sss-Shaddock-ServeurDePeripheriques]{Serveur de périphériques}
					...
					La connexion avec le moteur de simulation est gérée par un autre module qui sera détaillé plus tard dans la \myref{sss-Shaddock-PlateFormeDeSimulationMoleculaireInteractiveEtTempsReel}.
		...
		\begin{mysection}[sec-Shaddock-PlateFormeDeSimulationEtDeVisualisation]{Plate-forme de simulation et de visualisation}
			...
			Un module présenté dans la \myref{sss-Shaddock-PlateFormeDeSimulationMoleculaireInteractiveEtTempsReel} permet de faire communiquer le module de visualisation avec le module de simulation afin d'obtenir une simulation en temps-réel.
			...
			\begin{mysubsection}[sse-Shaddock-ModuleDeSimulationMoleculaire]{Module de simulation moléculaire}
				...
				\begin{mysubsubsection}[sss-Shaddock-PlateFormeDeSimulationMoleculaireInteractiveEtTempsReel]{Plate-forme de simulation moléculaire interactive et temps-réel}
			...
			\begin{mysubsection}[sse-exp4-AmeliorationDesPerformances]{Amélioration des performances}
				\begin{mysubsubsection}[sss-exp4-AmeliorationDesPerformances-DonneesEtTestsStatistiques]{Données et tests statistiques}
					...
					\begin{myfigure}
						...
						\begin{myps}(-0.425,-150)(2,525)
							\myaxes(0,2){haptique}(0,500)[100]{temps~(s)}
							\myboxplot{exp4-rmsd-time-haptic-ubiquitin.csv}
						\end{myps}
						\mycaption[fig-exp4-TempsPourAtteindreLeScoreRMSDMinimumAvecEtSansHaptiqueSurLaMoleculeUbiquitin]{Temps pour atteindre le score \myacronl{acr-RMSD} minimum avec et sans haptique sur la molécule \myUbiquitin}
					\end{myfigure}

					La \myref{fig-exp4-TempsPourAtteindreLeScoreRMSDMinimumAvecEtSansHaptiqueSurLaMoleculeUbiquitin} présente le temps du score \myglos{acr-RMSD} minimum atteint \myvard{2} avec et sans haptique \myvari{1} sur la molécule \myUbiquitin.
					L'analyse montre qu'il n'y a pas d'effet significatif de la présence d'une assistance haptique \myvari{1} sur le temps du score \myacro{acr-RMSD} minimum atteint \myvard{2} (\myanova{exp4-rmsd-time-haptic-ubiquitin-anova.tex}).

					\begin{myfigure}
						\psset{xunit=0.274914089\textwidth,yunit=0.0125cm}
						\begin{myps}(-0.425,-100)(2,325)
							\myaxes(0,2){haptique}(0,300)[50]{temps~(s)}
							\myboxplot{exp4-rmsd-time-haptic-nuse.csv}
						\end{myps}
						\mycaption[fig-exp4-TempsPourAtteindreLeScoreRMSDMinimumAvecEtSansHaptiqueSurLaMoleculeNusE]{Temps pour atteindre le score \myacronl{acr-RMSD} minimum avec et sans haptique sur la molécule \myNusE}
					\end{myfigure}

					La \myref{fig-exp4-TempsPourAtteindreLeScoreRMSDMinimumAvecEtSansHaptiqueSurLaMoleculeNusE} présente le temps du score \myglos{acr-RMSD} minimum atteint \myvard{2} avec et sans haptique \myvari{1} sur la molécule \myNusE.
					L'analyse montre un effet significatif de la présence d'une assistance haptique \myvari{1} sur le temps du score \myacro{acr-RMSD} minimum atteint \myvard{2} (\myanova{exp4-rmsd-time-haptic-nuse-anova.tex}).
				\end{mysubsubsection}
