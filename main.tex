		...
		\begin{mychapter}[cha-LaRechercheCollaborative]{La recherche collaborative}
			...
			\begin{mysection}[sec-exp1-Resultats]{Résultats}
				...
				\begin{mysubsection}[sse-exp1-ResultatsQualitatifs]{Résultats qualitatifs}
					\begin{mysubsubsection}[sss-exp1-EvaluationDeLaCollaboration]{Évaluation de la collaboration}
						...
						Cependant, les sujets ne considèrent pas que la réalisation de la tâche a provoqué la création d'une configuration avec un meneur et un suiveur (\mysummary{exp1-evaluation-leader.tex}).
						...
						Il est important de conserver cette impression que le partenaire est plus performant.
						En effet, cette configuration mène à une confiance mutuelle sur la qualité du travail effectué par le partenaire, point nécessaire à toute collaboration.
						Tout sujet n'ayant aucun estime pour le partenaire passerait son temps à vérifier le travail effectué et entraînerait une perte significative des performances générales du groupe.
						...
						En ce qui concerne la communication gestuelle, ils la considèrent comme inexistante (\mysummary{exp1-evaluation-gestural.tex}).
						...
						Deuxièmement, les sujets ont rapidement opté pour le canal virtuel qui est plus précis dans les tâches de désignation qui constituent la plupart des besoins de communication.
						...
						En effet, aucun outil visuel ou haptique n'a été fourni pour effectuer des tâches de désignation et le seul canal virtuel serait incapable de remplir seul cette mission.
					\end{mysubsubsection}
					\begin{mysubsubsection}[sss-exp1-EvaluationDuSysteme]{Évaluation du système}
						...
						Il est en va de même en ce qui concerne l'intuitivité des interactions haptiques du système (\mysummary{exp1-platform-interaction-intuitive.tex}).
			...
			\begin{mysection}[sec-exp1-Synthese]{Synthèse}
				\begin{mysubsection}[sse-exp1-ResumeDesResultats]{Résumé des résultats}
					...
					L'objectif était de montrer l'intérêt du travail collaboratif pour améliorer les performances et d'identifier les différentes stratégies de travail.
					...
					Le nombre d'atomes (et donc le nombre de \myglos*{glo-Residu}) joue un rôle important dans cette complexité : l'environnement virtuel en devient surchargé et difficile à appréhender.
					Un autre facteur de complexité est l'amplitude des contraintes physiques pour parvenir à l'objectif.
					...
					En effet, en champ proche, le nombre de conflits augmente significativement; en champ distant, tout l'intérêt du travail collaboratif est perdu.
					Le travail en champ voisin constitue un juste milieu qui souffre cependant, encore, de quelques problèmes de conflits.

					Enfin, la collaboration est bénéfique aux partenaires.
					Il paraît nécessaire d'avoir de bonnes relations avec ces partenaires afin d'apporter à la fois, une communication saine et un respect mutuel du travail effectué.
					Cependant, les résultats montre de façon évidente que tout déséquilibre dans le groupe mène à des performances dégradées.
				\end{mysubsection}
				\begin{mysubsection}[sse-exp1-Perspectives]{Perspectives}
					...
					Ceci se traduit soit par la proposition de tâche à fortes zones de contraintes \mychapterref*{cha-LaManipulationCollaborative} ou la manipulation de molécules de taille importante \mychapterref*{cha-LesDynamiquesDeGroupe}.

					Les différentes stratégies observées ont permis de mettre en évidence l'intérêt du travail en champ voisin.
					Les propositions d'outils visuo-haptiques tiennent compte de ce paramètre : ils encouragent le travail rapproché en fournissant des assistance au travail en champ voisin tout en maintenant une distance minimum afin de limiter les conflits liés au travail en champ proche.

					L'évaluation qualitative par questionnaire apport également de nombreuses réponses intéressantes.
					Tout d'abord, les sujets ont mis un point important en avant : le canal de communication virtuel est important.
					...
					Des améliorations sont cependant nécessaires en ce qui concerne le visuel et les interactions.
					De nombreux sujets ont par exemple demandé une mise en surbrillance du \myglos{glo-Residu} survolé sans restreindre cette mise en surbrillance à l'action de sélection.
					Une assistance haptique pour la sélection est également une des améliorations possibles.
					Ces améliorations ne sont pas implémentées dans les deux études suivantes pour ne pas alourdir les outils et ainsi biaiser l'étude.
					Cependant, ils sont implémentés pour la dernière expérimentation \mychapterref*{cha-TravailCollaboratifAssisteParHaptique}.
				\end{mysubsection}
			\end{mysection}
		\end{mychapter}
