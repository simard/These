	...
	\begin{mychapter}[cha-sota-EtudeBibliographique]{Étude bibliographique}
		...
		\begin{mysection}[sec-sota-LeTravailCollaboratif]{Le travail collaboratif}
			...
			\begin{mysubsection}[sse-sota-LaDistributionCognitiveDesChargesDeTravail]{La distribution cognitive des charges de travail}
				...
				\mycite[author]{George-1990} souligne également les effets de l'état émotionnel de chacun sur l'état émotionnel du groupe\footnote{\mycite[author]{Yammarino-1992} a remis en cause les conclusions obtenues mais le travail de \mycite[author]{George-1990} a de nouveau été confirmé par \mycite[author]{George-1993}.}
				...
				Afin de justifier le rejet de l'approche internaliste et individualiste, \mycite[author]{Clark-1998} explique que lorsque notre cognition s'appuie sur une aide externe, elle devient interactive et relationnelle, c'est-à-dire non détachable d'un composant externe présent dans l'environnement.
				...
				\mycite[author]{Hollan-2000} propose de définir la distribution cognitive de la façon suivante
				...
				\end{myquote}
				Plus récemment, \mycite[author]{Zhang-2006} synthétise la distribution cognitive en décrivant les groupes d'individus comme des systèmes ayant des interactions externes (avec des matériels) \mycite{Zhang-1994} et des interactions internes (avec des partenaires).
				...
				L'affordance est l'ensemble des possibilités d'actions sur et avec un objet \mycite{Gibson-1979} mais cette définition s'est par la suite réduite aux seules possibilités dont l'acteur est conscient.
				...
				Le terme est utilisé en suite par les fondateurs de la psychologie cognitive sociale \mycite{Patel-2000}.

				Cependant, \mycite[author]{Foushee-1987} montre qu'une configuration de travail collaboratif peut amener un gain en efficacité mais peut également amener une perte d'efficacité.
				Par exemple, \mycite[author]{Patel-1999} montre une perte d'efficacité sur une application permettant la collaboration distante.
