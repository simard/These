			...
			\begin{mysection}[sec-exp1-Resultats]{Résultats}
				...
				\begin{mysubsection}[sse-exp1-AmeliorationDesPerformancesEnBinome]{Amélioration des performances en \myglosnl{glo-Binome}}
					...
					\begin{myfigure}
						...
						\end{myps}
						\mycaption[fig-exp1-TempsDeCompletionParResidu]{Temps de complétion comparés (\myglosnl{glo-Monome} ou \myglosnl{glo-Binome}) par \myglosnl{glo-Residu}}
					\end{myfigure}

					La \myfigureref{fig-exp1-TempsDeCompletionParResidu} présente les temps de complétion \myvard{1} de chaque \myglos{glo-Residu} \myvari{2} en fonction du nombre de participants \myvari{1}.
