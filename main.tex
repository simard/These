	...
	\begin{mychapter}[cha-LaDynamiqueDeGroupe]{La dynamique de groupe}
		...
		\begin{mysection}[sec-exp3-CollaborationDeGroupe]{Collaboration de groupe}
			...
			\begin{mysubsection}[sse-exp3-Objectifs]{Objectifs}
				...
				De plus, si l'hypothèse précédente se vérifie, le \mybrainstorming devrait permettre d'identifier plus rapidement le ou les meneurs du groupe.
			\end{mysubsection}
		\end{mysection}
		...
		\begin{mysection}[sec-exp3-Resultats]{Résultats}
			...
			\begin{mysubsection}[sse-exp3-AvantageDuBrainstormingPourLesQuadrinomes]{Avantage du \mybrainstorming pour les \myglosnl*{glo-Quadrinome}}
				...
				\begin{mysubsubsection}[sss-exp3-AvantageDuBrainstormingPourLesQuadrinomes-AnalyseEtDiscussion]{Analyse et discussion}
					...
					La présence d'un \mybrainstorming n'améliore pas la résolution des \myglos*{glo-ConflitDeCoordination}.
					...
					En effet, les groupes n'ayant pas effectué de \mybrainstorming (\mycondition{1} et \mycondition{3}) tentent tout de même d'élaborer une stratégie pendant la manipulation.
					...
					Cette section nous a permis de tester et de confirmer l'intérêt d'un \mybrainstorming pour structurer les groupes : cette période est bénéfique pour les \myglos*{glo-Quadrinome}.
					Elle permet d'éviter les problèmes de \myglos{glo-ParesseSociale} évoqués par \mycite[author]{Latane-1979}.
					Le \mybrainstorming permet de faire émerger rapidement les rôles de \myglos{glo-Meneur} et \myglos{glo-Suiveur}.
