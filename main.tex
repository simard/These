	...
	\begin{mychapter}[cha-DeformationCollaborativeDeMolecule]{Déformation collaborative de molécule}
		...
		\begin{mysection}[sec-exp2-Resultats]{Résultats}
			...
			\begin{mysubsection}[sse-exp2-ResultatsQualitatifs]{Résultats qualitatifs}
				...
				Quoiqu'il en soit, ils ont été seulement \mysummary{exp2-evaluation-preference-monome-bimanual.tex} à préférer la configuration \myglos*{glo-Bimanuel} en \myglos{glo-Monome} alors qu'ils ont été \mysummary{exp2-evaluation-preference-binome-monomanual.tex} à opter pour la configuration \myglos*{glo-Monomanuel} en \myglos{glo-Binome}.
		...
		\begin{mysection}[sec-exp4-Resultats]{Résultats}
			...
			\begin{mysubsection}[sse-exp4-AmeliorationDesPerformances]{Amélioration des performances}
				\begin{mysubsubsection}[sss-exp4-AmeliorationDesPerformances-DonneesEtTestsStatistiques]{Données et tests statistiques}
					...
					L'analyse montre un effet significatif de la présence d'une assistance haptique \myvari{1} sur le temps du score \myacro{acr-RMSD} minimum atteint \myvard{2} pour le complexe de molécules \myNusENusG (\myanova{exp4-rmsd-time-molecule-haptic-nuse-anova.tex}).
					...
					L'analyse montre un effet significatif de la présence d'une assistance haptique \myvari{1} sur le nombre de sélections \myvard{3} (\myanova{exp4-freq-button1-haptic-anova.tex}).
					...
					L'analyse montre un effet significatif de la présence d'une assistance haptique \myvari{1} sur le temps moyen d'une sélection (\myanova{exp4-meantime-button1-haptic-anova.tex}).
					...
					L'analyse montre un effet significatif de la présence d'une assistance haptique \myvari{1} sur ce temps moyen (\myanova{exp4-attract-time-haptic-anova.tex}).
				\end{mysubsubsection}
			...
			\begin{mysubsection}[sse-exp4-AmeliorationDeLaCommunication]{Amélioration de la communication}
				\begin{mysubsubsection}[sss-exp4-AmeliorationDeLaCommunication-DonneesEtTestsStatistiques]{Données et tests statistiques}
					...
					L'analyse montre un effet significatif de la présence d'une assistance haptique \myvari{1} sur ce temps moyen (\myanova{exp4-shake-time-haptic-anova.tex}).
					...
					L'analyse montre un effet significatif de la présence d'une assistance haptique \myvari{1} sur ce nombre de sélections (\myanova{exp4-accept-haptic-anova.tex}).
					...
					L'analyse montre un effet significatif de la présence d'une assistance haptique \myvari{1} sur ce nombre de sélections (\myanova{exp4-speed-haptic-anova.tex}).
					...
					\begin{myfigure}
						...
						\begin{myps}(-0.425,-75)(2,310)
							...
							\myboxplot{exp4-annotation-time-haptic-last.csv}
						\end{myps}
					...
					L'analyse montre un effet significatif de l'ordre de passage de l'assistance haptique sur le temps de parole \myvard{4} (\myanova{exp4-annotation-time-haptic-last-anova.tex}).
				\end{mysubsubsection}
				\begin{mysubsubsection}[sss-exp4-AmeliorationDeLaCommunication-AnalyseEtDiscussion]{Analyse et discussion}
					La \myref{fig-exp4-TempsMoyenDAcceptationDUneDesignationAvecEtSansHaptique} est un résultat permettant de mettre en avant les améliorations en terme de communication entre les membres du groupe.
					En effet, ce résultat montre la diminution du temps de réaction des opérateurs lorsque le coordinateur propose une désignation.
					Les outils d'assistance à la communication ont permis aux opérateurs de comprendre l'information concernant la désignation d'une cible plus rapidement.

					L'information visuelle donnée lors d'une désignation effectuée par le coordinateur est suffisante pour connaître la position de la cible.
					Cependant, cette seule information ne suffit pas à prévenir les opérateurs qu'une désignation vient d'être réalisée.
					En effet, si la cible désignée est dissimulée derrière d'autres \myglos*{glo-Residu}, l'opérateur pourra ne pas voir cette désignation tant que le coordinateur ne lui aura pas signaler oralement.
					Par contre, l'ajout de la modalité haptique pour signaler la présence d'une nouvelle désignation permet aux opérateurs d'être prévenu rapidement et de réagir plus rapidement : soit ils se mettront en recherche active d'une cible signalée visuellement, soit ils interrogeront directement le coordinateur.
					Ces outils de communication permettent de ne prévenir que les personnes concernées tout en conservant la teneur de l'information de manière visuelle.
					Par exemple, un affichage clignotant de la cible aurait peut-être permis d'obtenir des résultats similaires en terme de temps de réponse mais aurait été beaucoup plus envahissant visuellement, notamment pour le coordinateur qui n'a pas besoin de cette information.

					Cette communication améliorée permet un meilleur rendement de la stratégie proposée par le coordinateur.
					En effet, la \myref{fig-exp4-NombreDeDesignationsAccepteesAuCoursDuProcessusDeDesignationAvecEtSansHaptique} montre que les opérateurs acceptent plus de désignations lorsqu'ils ont ces outils d'assistance à la communication à leur disposition.
					Ces outils leurs permettent d'être plus attentifs et ainsi de répondre plus rapidement et plus souvent aux requêtes du coordinateur.

					Cette rapidité permet d'ailleurs au coordinateur d'être plus actif \myref*{fig-exp4-VitesseMoyenneDuCoordinateurAvecEtSansHaptique}.
					Les opérateurs répondant plus rapidement à ses requêtes, le coordinateur se libère plus rapidement d'un processus de désignation et peut s'occuper de la suite des événements.
					Il devient lui aussi plus efficace dans la répartition des désignations car il passe moins de temps à attendre que les opérateurs répondent présent.

					On constate dans cette section que les outils d'assistance à la communication remplissent leur rôles en améliorant l'efficacité et la qualité de la communication.
