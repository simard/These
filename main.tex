...
\begin{document}
		...
		\begin{mychapter}[cha-LeSujet]{Le sujet}
			...
			\begin{mysection}[sec-Contexte]{Contexte}
				\begin{mysubsection}[sse-LAmarrageMoleculaire]{L'\myglosnl{glo-AmarrageMoleculaire}}
					...
					Pour chacun de ces différents niveaux, le processus de manipulation est similaire et peut être séparé en sous-tâches \myref*{fig-ProcessusDeDeformationMoleculaireEnQuatreEtapes} :
					\begin{description}
				...
				\begin{mysubsection}[sse-simulation-LesOutilsExistants]{Les outils existants}
					...
					\begin{mysubsubsection}[sss-simulation-VMD]{\myacronl+{acr-VMD}}
						...
						\begin{myparagraph}[par-simulation-LesOutilsDeManipulation]{Les outils de manipulation}
							...
							Les outils disponibles par défaut dans \myacro{acr-VMD} ont été utilisés dans la première expérimentation \myref*{cha-LaRechercheCollaborativeDeResidusEnSimulationMoleculaire} et sont :
							\begin{description}
	...
	\begin{mypart}[prt-EtudeDuTravailCollaboratif]{Étude du travail collaboratif}
		\begin{mychapter}[cha-LaRechercheCollaborativeDeResidusEnSimulationMoleculaire]{La recherche collaborative de résidus en simulation moléculaire}
			\begin{mysection}[sec-exp1-Introduction]{Introduction}
				...
				L'environnement virtuel complexe choisi est la manipulation moléculaire qui se découpe en quatre tâches élémentaires \myref*{fig-ProcessusDeDeformationMoleculaireEnQuatreEtapes}.
				...
				La \myref{sec-exp1-Methode} expose la tâche réalisée ainsi que les différentes variables de l'expérimentations.
				...
				\begin{mysubsection}[sse-exp1-Tache]{Tâche}
					...
					\begin{description}
						\item[\myTRPZIPPER]
							...
							Cette molécule contient 218~atomes dont 12~\myglos*{glo-Residu}.
						...
						\item[\myTRPCAGE]
							...
							Cette molécule contient 304~atomes dont 20~\myglos*{glo-Residu}.
							C'est une des deux molécules proposées pour la tâche de recherche et d'extraction de 5~\myglos*{glo-Residu} \myref*{tab-exp1-ListeDesResidusRecherches-ResidusSurLaMoleculeTRPCAGE}.
						\item[\myPrion]
							...
							Cette molécule contient 1779~atomes dont 112~\myglos*{glo-Residu}.
							C'est une des deux molécules proposées pour la tâche de recherche et d'extraction de 5~\myglos*{glo-Residu} \myref*{tab-exp1-ListeDesResidusRecherches-ResidusSurLaMoleculePrion}.
					\end{description}
			...
			\begin{mysection}[sec-exp1-Resultats]{Résultats}
				...
				\begin{mysubsection}[sse-exp1-AmeliorationDesPerformancesEnBinome]{Amélioration des performances en \myglosnl{glo-Binome}}
					...
					La \myref{fig-exp1-TempsDeRealisationParResidu} présente le temps de réalisation \myvard{1} de chaque \myglos{glo-Residu} \myvari{2}.
				...
				\begin{mysubsection}[sse-exp1-StrategiesDeTravail]{Stratégies de travail}
					...
					\begin{mysubsubsection}[sss-exp1-ChampVoisin]{Champ voisin}
						...
						D'après la \myref{fig-exp1-TempsDeRealisationEntreLesSujetsPourChaqueBinome}, ces \myglos*{glo-Binome} obtiennent de très bonnes performances sur les temps de réalisation de la tâche.
		...
		\begin{mychapter}[cha-LaManipulationCollaborative]{La manipulation collaborative}
			\begin{mysection}[sec-exp2-Presentation]{Présentation}
				\begin{mysubsection}[sse-exp2-Objectifs]{Objectifs}
					...
					La précédente expérimentation \myref*{cha-LaRechercheCollaborativeDeResidusEnSimulationMoleculaire} a souligné l'avantage de la collaboration sur des tâches nécessitant un couplage fort.
