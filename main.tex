...
\begin{document}
	...
	\begin{mychapter}[cha-DeformationCollaborativeDeMolecule]{Déformation collaborative de molécule}
		\begin{mysection}[sec-exp2-Introduction]{Introduction}
			...
			Tout d'abord, nous présenterons les objectifs et les hypothèses de cette seconde expérimentation dans la \myref{sec-exp2-Contexte}.
			Ensuite, la tâche et le dispositif expérimental, modifié pour cette nouvelle étude, est présenté dans la \myref{sec-exp2-ExperimentationDeDeformationDeMolecule}.
		...
		\end{mysection}
		\begin{mysection}[sec-exp2-Contexte]{Contexte}
		...
		\end{mysection}
		\begin{mysection}[sec-exp2-ExperimentationDeDeformationDeMolecule]{Expérimentation de déformation de molécule}
			\begin{mysubsection}[sse-exp2-Tache]{Tâche}
				...
				\end{mysubsubsection}
			\end{mysubsection}
			\begin{mysubsection}[sse-exp2-SpecificitesDeLaPremiereExperimentation]{Spécificités de la seconde expérimentation}
				L'expérimentation, basée sur la dispositif expérimental présenté dans le \myref{cha-pro-DispositifExperimental}, a subi quelques modifications qui seront détaillées dans les sections suivantes.
				Un résumé de la methode expérimentale se trouve dans le \myref{tab-exp2-SyntheseDeLaProcedureExperimentale} qu'on pourra retrouver de manière détaillée dans la \myref{sec-pro-exp2-PremiereExperimentation}.
	...
	\begin{mychapter}[cha-LesDynamiquesDeGroupe]{Les dynamiques de groupe}
		...
		\begin{mysection}[sec-exp3-DispositifExperimentalEtMateriel]{Dispositif expérimental et matériel}
			...
			\begin{mysubsection}[sse-exp3-DispositifTechnique]{Dispositif technique}
				Cette nouvelle étude propose une disposition identique à la seconde expérimentation \myref*{sse-exp2-SpecificitesDeLaPremiereExperimentation} avec les matériels suivants :
				\begin{itemize}
			...
			\begin{mysubsection}[sse-exp3-Visualisation]{Visualisation}
				...
				La \myref{fig-pro-exp2-IllustrationDesRendusPourLAffichageDeLaMolecule} dans la \myref{sss-exp2-Visualisation} illustre l'ensemble des rendus graphiques précédemment décrits.
			\end{mysubsection}
		\end{mysection}
	...
	\begin{mychapter}[cha-pro-DispositifExperimental]{Dispositif expérimental}
		...
		\begin{mysection}[sec-pro-OutilsDeManipulation]{Outils de manipulation}
			...
			Ce sera par l'intermédiaire d'un outil \mytool{grab} dans la première expérimentation \myref*{sss-exp1-Materiel}, par une souris~\myThreeD dans la seconde \myref*{sss-exp2-Materiel} puis par une simple souris \myUSB dans la dernière expérimentation \myref*{sse-pro-exp4-Materiel}.
		\end{mysection}
