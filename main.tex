		...
		\begin{mychapter}[app-ShaddockSystemeCollaboratifPourLaManipulationDeMolecules]{\myShaddock\ -- Système collaboratif pour la manipulation de molécules}
			\begin{mysection}[sec-PlateFormesCollaborativesExistantes]{Plates-formes collaboratives existantes}
				...
				\begin{myfigure}
					...
					\def\mynode(#1,#2)[#3]#4{%
						\rput(#1,#2){\rnode{#3}{\psframebox[shadow=true,shadowcolor=myblue,blur=true,framearc=0.25]{#4}}}%
					}
					\def\mymultiline#1{%
						\begin{tabular}{c}%
							#1
					...
					\def\myVRPNclient{\mymultiline{%
							Client \\
							\myacronl-{acr-VRPN} \\
						}
					}
					\def\myVRPNserveur#1{\mymultiline{%
							Serveur \\
					...
					\def\myvmdnode(#1,#2){%
						\rput(#1,#2){%
							\rnode{VMD}{%
								\psframebox[framesep=0pt,shadow=true,shadowcolor=myblue,blur=true,framearc=0.25]{%
									\begin{tabular}{c|c}%
