			...
			\begin{mysection}[sec-exp1-Resultats]{Résultats}
				...
				\begin{mysubsection}[sse-exp1-StrategiesDeTravail]{Stratégies de travail}
					...
					\begin{mysubsubsection}[sss-exp1-InteractionEnChampVoisin]{Interaction en champ voisin}
						...
						De plus, la \myref{fig-exp1-TempsDeCommunicationVerbaleEntreLesSujetsPourChaqueBinome} montre une communication verbale faible.
					...
					\begin{mysubsubsection}[sss-exp1-InteractionEnChampDistant]{Interaction en champ distant}
						...
						Cette \figurename montre également que ce \myglos{glo-Binome} communique plus dans les phases de sélection que dans les phases de recherche.
				...
				\begin{mysubsection}[sse-exp1-ResultatsQualitatifs]{Résultats qualitatifs}
					...
					\begin{mysubsubsection}[sss-exp1-EvaluationDeLaCollaboration]{Évaluation de la collaboration}
						...
						L'hypothèse \myhypothesis{3} est confirmée par les sujets qui préfèrent la configuration collaborative à la configuration seule.
