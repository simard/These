...
\begin{document}
	...
	\begin{mychapter}[cha-RechercheCollaborativeDeResidusEnSimulationMoleculaire]{Recherche collaborative de résidus en simulation moléculaire}
		\begin{mysection}[sec-exp1-Introduction]{Introduction}
			...
			Nous commencerons par présenter les objectifs et les hypothèses de cette première expérimentation dans la \myref{sec-exp1-Contexte}.
			Les détails de l'expérimentation seront abordés dans la \myref{sec-exp1-ExperimentationDeRechercheDeResiduEnSimulationMoleculaire}.
		...
		\end{mysection}
		\begin{mysection}[sec-exp1-Contexte]{Contexte}
		...
		\end{mysection}
		\begin{mysection}[sec-exp1-ExperimentationDeRechercheDeResiduEnSimulationMoleculaire]{Expérimentation de recherche de résidu en simulation moléculaire}
			\begin{mysubsection}[sse-exp1-Tache]{Tâche}
				...
				Les molécules \myTRPCAGE et \myPrion sont utilisées pour la tâche de recherche et d'extraction de \myglos*{glo-Residu} : chaque molécules possède \mynum{5}~\myglos*{glo-Residu} à extraire.
			...
			\begin{mysubsection}[sse-exp1-SpecificitesDuProtocoleExperimental]{Spécificités du protocole expérimental}
				...
				Les détails à propos de la méthode expérimentale, présents dans la \myref{sec-met-exp1-PremiereExperimentation}, sont résumés dans le \myref{tab-exp1-SyntheseDeLaMethodeExperimentale}.
	...
	\begin{mychapter}[cha-DeformationCollaborativeDeMolecule]{Déformation collaborative de molécule}
		...
		\begin{mysection}[sec-exp2-DispositifExperimentalEtMateriel]{Dispositif expérimental et matériel}
			...
			\begin{mysubsection}[sse-exp2-DispositionDesElements]{Disposition des éléments}
				Cette nouvelle étude propose une disposition relativement similaire à la première expérimentation \myref*{sec-exp1-ExperimentationDeRechercheDeResiduEnSimulationMoleculaire}.
	...
	\begin{mychapter}[cha-pro-DispositifExperimental]{Dispositif expérimental}
		...
		\begin{mysection}[sec-pro-OutilsDeManipulation]{Outils de manipulation}
			...
			Ce sera par l'intermédiaire d'un outil \mytool{grab} dans la première expérimentation \myref*{sss-exp1-Materiel}, par une souris~\myThreeD dans la seconde \myref*{sse-pro-exp2-Materiel} puis par une simple souris \myUSB dans la dernière expérimentation \myref*{sse-pro-exp4-Materiel}.
		\end{mysection}
