...
\begin{document}
				...
				\begin{mysubsection}[sse-LAmarrageMoleculaire]{L'\myglosnl{glo-AmarrageMoleculaire}}
					...
					\begin{myfigure}
						...
						\begin{myps}(-2.5,-0.5)(2.5,5)
							...
							\mycirclenum(0,3){2}
							\mynode(0,2)[Deformation]{Déformation}
							\mycirclenum(0,2){3}
							\mynode(0,1)[Evaluation]{Évaluation}
							\mycirclenum(0,1){4}
							\mynode[fillstyle=solid,fillcolor=myblue!25](0,0)[Objective]{Objectif atteint}
							\ncline{->}{Search}{Selection}
							\ncline{->}{Selection}{Deformation}
							\ncline{->}{Deformation}{Evaluation}
				...
				\begin{myfigure}
					...
					\def\myvmdnode(#1,#2){%
						\rput(#1,#2){%
							\rnode{VMD}{%
								\psframebox[style=nodestyle,framesep=0pt]{%
									\begin{tabular}{c|c}%
										\multicolumn{2}{c}{\psframebox*[linecolor=white]{\Large\myacronl-{acr-VMD}}} \\[2ex]
											\hline
											\psframebox*[linecolor=white]{\myacronl-{acr-IMD}} & \myVRPNclient \\
										\end{tabular}%
									}%
								}%
							}%
						...
						\begin{myps}(-10,-5)(10,5)
							\rput(-8,4){\textit{Simulation}}
							\psline[linewidth=0.1pt,linestyle=dashed,linecolor=black!33](-4,5)(-4,-5)
							\rput(0,4){\textit{Visualisation}}
							\psline[linewidth=0.1pt,linestyle=dashed,linecolor=black!33](4,5)(4,-5)
							\rput(8,4){\textit{Interaction}}
							\psset{arrowsize=1.5pt 3,arrowlength=2}
							\myvmdnode(0,0)
							\mynode(-8,0)[NAMD]{\Large\myacronl-{acr-NAMD}}
							\mynode(8,2)[VRPN1]{\myVRPNserveur{1}}
							\mynode(8,0)[VRPN2]{\myVRPNserveur{2}}
							\mynode(8,-3)[VRPNn]{\myVRPNserveur{n}}
							\rput(8,-1.5){\LARGE$\vdots$}
							\nccurve[offsetA=10pt,angleA=180,angleB=0]{<->}{VMD}{NAMD}
							\psset{labelsep=3pt,nrot=:D}
							\nbput{\scriptsize Données de}
							\naput{\scriptsize simulation}
							\pnode(-4,0){VMD-NAMD-link}
							\psset{angleA=0,angleB=180,offsetA=-10pt,ncurvA=1}
							\nccurve{<->}{VMD}{VRPN1}
							\nccurve{<->}{VMD}{VRPN2}
							\nccurve{<->}{VMD}{VRPNn}
						\end{myps}
	...
	\begin{mypart}[prt-EtudeDuTravailCollaboratif]{Étude du travail collaboratif}
		\begin{mychapter}[cha-LaRechercheCollaborativeDeResidusEnSimulationMoleculaire]{La recherche collaborative de \myglosnl*{glo-Residu} en simulation moléculaire}
