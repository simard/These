			...
			\begin{mysection}[sec-exp2-Presentation]{Présentation}
				...
				\begin{mysubsection}[sse-exp2-Hypotheses]{Hypothèses}
					...
					\begin{myparagraph}{\myhypothesis{3} L'apprentissage est plus performant pour les \myglos*{glo-Binome}}
						...
						Tout d'abord grâce à un échange des connaissances mais aussi grâce à la multiplicité des avis et idées pour répondre à un problème ou comprendre un événement.
					\end{myparagraph}
				\end{mysubsection}
			\end{mysection}
		\end{mychapter}
