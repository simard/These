	...
	\begin{mypart}[prt-Introduction]{Introduction}
		...
		\begin{mychapter}[app-ShaddockSystemeCollaboratifPourLaManipulationDeMolecules]{\myShaddock\ -- Système collaboratif pour la manipulation de molécules}
			...
			\begin{mysection}[sec-NouveauxOutilsPourLInteraction]{Nouveaux outils pour l'interaction}
				...
				\end{mysubsection}
				\begin{mysubsection}[sse-OutilDeDesignation]{Outil de désignation}
				\end{mysubsection}
				\begin{mysubsection}[sse-AppelHaptique]{Appel haptique}
				\end{mysubsection}
			\end{mysection}
		\end{mychapter}
	\end{mypart}
		...
		\begin{mychapter}[cha-LaRechercheCollaborative]{La recherche collaborative}
			...
			\begin{mysection}[sec-exp1-Methode]{Méthode}
				...
				\begin{mysubsection}[sse-exp1-Procedure]{Procédure}
					...
					\begin{enumerate}
						\item Le sujet $\mathcal{A}$, puis le sujet $\mathcal{B}$, puis le \myglos{glo-Binome} $\mathcal{AB}$;
						\item Le sujet $\mathcal{A}$, puis le \myglos{glo-Binome} $\mathcal{AB}$, puis le sujet $\mathcal{B}$;
						\item Le \myglos{glo-Binome} $\mathcal{AB}$, puis le sujet $\mathcal{A}$, puis le sujet $\mathcal{B}$.
					\end{enumerate}
						...
						\begin{mytabular}{>{\bfseries}p{\exponefirstcolumn}p{\exponesecondcolumn}}
							...
							\multicolumn{2}{c}{%
								\begin{tabular}{^C-C-C}
									...
									\mymiddlerule
									Sujet~$\mathcal{A}$                  & Sujet~$\mathcal{A}$                  & \myGlosnl{glo-Binome}~$\mathcal{AB}$ \\
									\mynum{10}~\myglosnl*{glo-Residu}    & \mynum{10}~\myglosnl*{glo-Residu}    & \mynum{10}~\myglosnl*{glo-Residu}    \\
									\mymiddlerule
									Sujet~$\mathcal{B}$                  & \myGlosnl{glo-Binome}~$\mathcal{AB}$ & Sujet~$\mathcal{A}$                  \\
									\mynum{10}~\myglosnl*{glo-Residu}    & \mynum{10}~\myglosnl*{glo-Residu}    & \mynum{10}~\myglosnl*{glo-Residu}    \\
									\mymiddlerule
									\myGlosnl{glo-Binome}~$\mathcal{AB}$ & Sujet~$\mathcal{B}$                  & Sujet~$\mathcal{B}$                  \\
									\mynum{10}~\myglosnl*{glo-Residu}    & \mynum{10}~\myglosnl*{glo-Residu}    & \mynum{10}~\myglosnl*{glo-Residu}    \\
								\end{tabular}
							} \\
							\mybottomrule
