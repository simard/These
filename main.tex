	...
	\begin{mychapter}[cha-LaDynamiqueDeGroupe]{La dynamique de groupe}
		...
		\begin{mysection}[sec-exp3-PresentationDeLExperimentation]{Présentation de l'expérimentation}
				...
				\begin{mysubsubsection}[sss-exp3-DescriptionDesScenarios]{Description des scénarios}
					...
					\begin{description}
						\item[Scénario~\myscenario{1}]
							...
							La déformation de cette molécule nécessite de replacer correctement par rapport à un modèle, une chaîne de \mynum{16}~\myglos*{glo-Residu}.
						...
						\item[Scénario~\myscenario{2}]
							...
							La déformation de cette molécule nécessite de replacer correctement par rapport à un modèle, une chaîne de \mynum{19}~\myglos*{glo-Residu}.
			...
			\begin{mysubsection}[sse-exp3-SpecificitesDuProtocoleExperimental]{Spécificités du protocole expérimental}
				...
				Le protocole expérimental est détaillé dans la \myref{sec-met-exp3-TroisiemeExperimentation} et résumé dans la \myref{tab-exp3-SyntheseDeLaProcedureExperimentale}.
