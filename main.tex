	...
	\begin{mychapter}[cha-sota-EtudeBibliographique]{Étude bibliographique}
		...
		\begin{mysection}[sec-sota-ContexteDeTravail-LaModelisationMoleculaire]{Contexte de travail : la modélisation moléculaire}
			...
			\begin{mysubsection}[sse-sota-DockingMoleculaireEnEnvironnementVirtuel]{\myGlosnl{glo-DockingMoleculaire} en environnement virtuel}
				...
				Puis, il adapte son travail pour créer un moteur de simulation moléculaire ce qui lui permet d'obtenir des simulations temps-réel, utilisable pour la manipulation haptique \mycite{Bolopion-2009}.
		...
		\begin{mysection}[sec-sota-ApprocheCollaborativePourLesProblemesComplexes]{Approche collaborative pour les problèmes complexes}
			...
			\begin{mysubsection}[sse-sota-LaFacilitationSociale]{La facilitation sociale}
				...
				Dans ce même contexte, \mycite[author]{Roethlisberger-1939}\footnote{\mycite[author]{Roethlisberger-1939} base ses conclusions sur les travaux non-publiés de Elton \myname{Mayo} au sein de l'entreprise \myHawthorne.} constate que le travail en groupe génère une stimulation qui augmente les performances du groupe : les performances du groupe sont meilleures que la somme des performances individuelles de chacun des membres.
		...
		\begin{mysection}[sec-sota-Conclusion]{Conclusion}
			...
			\begin{description}
				\item[Recherche] Cette tâche concerne la recherche et l'identification d'une cible (atome, \myglos{glo-Residu}, structure secondaire, \myetc) en fonction de critères multiples (articulations, bilan énergétique, régions hydrophobique, \myetc).
	...
	\begin{mychapter}[cha-DeformationCollaborativeDeMolecule]{Déformation collaborative de molécule}
		...
		\begin{mysection}[sec-exp2-Synthese]{Synthèse}
			...
			\begin{mysubsection}[sse-exp2-Conclusion]{Conclusion}
				...
				L'ajout de sujets supplémentaires va probablement générer des dynamiques de groupe qui n'avait pas de raison d'exister au sein d'un \myglos{glo-Binome}.
		...
		\begin{mysection}[sec-exp4-Resultats]{Résultats}
			...
			\begin{mysubsection}[sse-exp4-AmeliorationDesPerformances]{Amélioration des performances}
				...
				\begin{mysubsubsection}[sss-exp4-AmeliorationDesPerformances-AnalyseEtDiscussion]{Analyse et discussion}
					...
					Nous avons vu que les outils d'assistance haptique pour la désignation aident le coordinateur à imposer une stratégie commune ce qui a pour effet d'améliorer les performances du groupe sur les tâches les plus complexes.
