...
\university{École Doctorale d'Informatique de \myname{Paris}-Sud}
...
\begin{document}
	...
	\begin{mychapter+}{Résumé}
		...
		\myemph{<Ma thèse>}\par
		\myemph{<Développement de la plateforme>}\par
	...
	\begin{mychapter}[cha-sota-EtudeBibliographique]{Étude bibliographique}
		...
		\begin{mysection}[sec-sota-ContexteDeTravail-LaModelisationMoleculaire]{Contexte de travail : la modélisation moléculaire}
			...
			\begin{mysubsection}[sse-sota-RechercheDeSolutionsDeDockingMoleculaire]{Recherche de solutions de \myglosnl{glo-DockingMoleculaire}}
				...
				Parmi les algorithmes les plus utilisés, on peut citer les algorithmes génétiques, les \myacro*{acr-ICM}, la méthode de \myname{Monte-Carlo} ou encore la reconstruction incrémentale autour d'une base protéinique.
				...
				La \myref{tab-sota-ListeNonExhaustiveDeSolutionsLogiciellesDeDockingMoleculaire} propose une liste non-exhaustive de solutions logicielles de \myglos{glo-DockingMoleculaire}.
				...
				\begin{itemize}
					...
					\item Utiliser différentes conformations d'une molécule sur des solutions de \myglos{glo-DockingMoleculaire} rigide \mycite{Meagher-2004};
					\item Découper l'espace de recherche de manière grossière pour améliorer les performances d'évaluation \mycite{Osterberg-2002}.
				\end{itemize}

				La flexibilité introduit une complexité importante dans l'évaluation et la recherche de solution en \myglos{glo-DockingMoleculaire}.
				...
				À l'aide de \myFoldIt, un logiciel de \myglos{glo-DockingMoleculaire} vulgarisé et distribué sous forme de jeu vidéo, la solution d'un problème de \myglos{glo-DockingMoleculaire} qui pourrait faire avancer la recherche sur le \mySIDA a été découverte \mycite{Khatib-2011}.
			...
			\begin{mysubsection}[sse-sota-DockingMoleculaireEnEnvironnementVirtuel]{\myGlosnl{glo-DockingMoleculaire} en environnement virtuel}
				Malgré une communauté scientifique très active pour améliorer les solutions de \myglos{glo-DockingMoleculaire} existantes et se rapprocher toujours plus près de conditions biologiques réalistes, la complexité du problème rend la découverte de solutions difficile.
				...
				L'intervention d'un expert durant le processus de recherche est effectuée par l'immersion à l'aide d'environnements de \myglos{glo-RealiteVirtuelle}.
				\mycite[author]{Batter-1972} proposent les premières solutions d'immersion grâce à ce projet.
				
				L'immersion dans un environnement virtuel avec des molécules pose tout de suite le problème de la représentation des molécules.
				\mycite[author]{Bergman-1993} proposent la plateforme \myVIEW avec différents rendus graphiques pour représenter les molécules \myref*{fig-sota-RepresentationAvanceesDeMoleculesProposeeParBergman1993}.
				...
				Enfin, afin d'améliorer l'exploration, \mycite[author]{Krenek-1999} puis \mycite[author]{Davies-2005} proposent une visualisation multimodale en ajoutant un modèle de force haptique calqué sur les champs de forces électriques d'une molécule \myref*{fig-sota-VisualisationMultimodaleProposeeParDavies2005}.
				...
				Le projet \myGROPEHaptic qui se place dans la continuité du projet \myGROPE propose une manipulation moléculaire interactive \mycite{Ouh-Young-1988,Brooks-1990}.
				Puis, la modélisation moléculaire assistée par ordinateur est proposée sur la plateforme \myHIMM (\myemph{Highly Immersive Molecular Modeling}) \mycite{Drees-1996,Drees-1998}.
				Afin de manipuler plus intuitivement les molécules, \mycite[author]{Weghorst-2003} propose l'utilisation d'une interface tangible censée représenter la molécule manipulée.
				...
				\end{equation}
				Enfin, la manipulation interactive avec des structures moléculaires flexibles devient possible avec la plateforme proposée par \mycite[author]{Delalande-2009} à laquelle on peut ajouter la possibilité d'interagir avec une interface haptique \mycite{Delalande-2010}.
				...
				Par exemple, \mycite[author]{Sankaranarayanan-2003} proposent une plateforme interactive avec des interfaces haptiques pour enseigner différents aspects qui constituent la structure moléculaire.
				Puis \mycite[author]{Wollacott-2007} s'intéressent à la compréhension des interactions chimiques en combinant une interface haptique et l'interface tangible proposée par \mycite[author]{Weghorst-2003}.
				...
				Par exemple, \mycite[author]{Lai-Yuen-2005} proposent une interface haptique avec cinq \myacro*{acr-DDL} afin d'effectuer du \myglos{glo-DockingMoleculaire} rigide \mycite{Lai-Yuen-2006} \myref*{fig-sota-DockingMoleculaireRigideALAideDUneInterfaceACinqDDLsLaiYuen2006}.
				Puis, à l'aide d'interfaces haptiques plus largement répandue comme le \myVirtuose (six \myacro*{acr-DDL}), la manipulation moléculaire \mycite{Daunay-2007} puis le \myglos{glo-DockingMoleculaire} \mycite{Daunay-2009} accompagné d'une évaluation temps-réel de l'énergie du système devient possible.
			...
			\begin{mysubsection}[sse-sota-PlateformesCollaborativesPourLaBiologieMoleculaire]{Plateformes collaboratives pour la biologie moléculaire}
				Des applications collaboratives ont commencé à être développées pour répondre au besoin de travailler à plusieurs.
				L'une des premières application a été proposée par \mycite[author]{Casher-1995} sous le nom de \myEyeChem.
				Cette application constituée d'une nœud serveur et de nœuds clients sur un réseau interne, permet aux utilisateurs d'éditer et de manipuler une molécule de manière synchrone.
				...
				Un projet similaire appelé \myChimera, développé par \mycite[author]{Pettersen-2004}, est encore utilisé de nos jours contrairement à \myMICE qui n'est actuellement plus maintenu.
				...
				En effet, les gestes sont effectuées avec des \textit{haptic eggs}, deux petites interfaces tangibles placées dans chaque main de l'utilisateur, chaque \textit{haptic egg} étant l'abstraction d'une molécule.
				...
				Plus récemment, le projet \myeMinerals \mycite{Dove-2005}, illustré sur la \myref{fig-sota-PlateformeDeCollaborationInterUniversiteProposeeParDove2005}, fournit une solution plus aboutie pour la collaboration entre biologistes (messagerie instantanée, vidéo-conférence, serveur centralisé, \myetc) mais il s'agit surtout de collaboration distante et asynchrone.
				...
				Parmi les applications collaboratives de biologie moléculaire, \mycite[author]{Chastine-2005} sont les premiers à s'intéresser aux problèmes de communication entre les sujets \myref*{sss-sota-LInterReferencement}.
				À travers l'application \myAMMPVis, il propose des outils pour désigner ou indiquer des zones de l'environnement virtuel.
				Un point important est la représentation de chaque sujet par une représentation des mains au sein de l'environnement virtuel afin d'améliorer la communication \myref*{fig-sota-ManipulationCollaborativeDeMoleculeAvecRepresentationDesMainsDesParticipantsChastine2005}.
				Cette plateforme a ensuite été réutilisée sous la forme de \myAMMPEXTN afin d'introduire des procédures de contrôle d'accès aux différentes strates d'informations (paramètres de visualisation, modélisation, modification des données) afin d'éviter les conflits entre les utilisateurs \mycite{Ma-2007,Ma-2007a}.
				...
				Pour améliorer l'expérience d'immersion, \mycite[author]{Kriz-2003} proposent aux utilisateurs une visualisation dans un \myCAVE à l'aide de l'application \myDIVERSE.

				Plusieurs applications ont été développées afin de créer un espace de collaboration pour la modélisation moléculaire et, dans le cas de \mycite[author]{Park-2006}, du \myglos{glo-DockingMoleculaire}.
				Cependant, la présentation de ces travaux abordent les contraintes techniques nécessaires à la mise en place de tels systèmes sans évoquer les contraintes humaines de la collaboration.
		...
		\begin{mysection}[sec-sota-LeTravailCollaboratif]{Le travail collaboratif}
			...
			\begin{mysubsection}[sse-sota-LaDistributionCognitiveDesChargesDeTravail]{La distribution cognitive des charges de travail}
				\mycite[author]{Bandura-1986} puis \mycite[author]{Foushee-1987} sont parmi les premiers a avoir l'intuition que le travail collaboratif apporte plus qu'une simple multiplication des ressources.
		...
		\begin{mysection}[sec-sota-CollaborationEnEnvironnementVirtuel]{Collaboration en environnement virtuel}
			...
			\begin{mysubsection}[sse-sota-LaCommunicationImpliciteEtExplicite]{La communication implicite et explicite}
				...
				\begin{mysubsubsection}[sss-sota-LeGrounding]{Le \myemph{grounding}}
					...
					\mycite[author]{Clark-1991} expliquent ce besoin de \myemph{grounding} par la phrase suivante.
					\begin{myquote}[english]
					...
					Le \myemph{grounding} est nécessaire à la transmission d'information.
					...
					\mycite[author]{Dillenbourg-1996} étudient ce partage d'informations sur une tâche d'enquête fictive sur un meurtre.
					...
					\mycite[author]{Hertzum-2008} lie les processus de recherche d'informations et de \myemph{grounding}.
					...
					Cependant, \mycite[author]{Hertzum-2010} met en pratique cette constatation en observant le travail d'un hôpital où plusieurs médecins sont à la recherches de symptômes pour définir un diagnostique et fournir un traitement.
				...
				\begin{mysubsubsection}[sss-sota-LInterReferencement]{L'inter-référencement}
					La notion d'inter-référencement est très récente et c'est \mycite[author]{Chastine-2007} qui l'a mise en évidence à travers sa plateforme \myAMMPVis \mycite{Chastine-2005,Chastine-2006}.
					L'inter-référencement est défini par \mycite[author]{Chastine-2007} comme
					\begin{myquote}[english]
					...
					Afin de résoudre cette problématique, \mycite[author]{Chastine-2007a} se proposent, dans un contexte de collaboration distante, d'utiliser des techniques de réalité augmentée pour désigner les éléments inter-référencés \myref*{fig-sota-InterReferencementVisuelProposeParChastineALAideDeTechniquesDeRealiteAugmentee}.
					Dans une étude l'année suivante, \mycite[author]{Chastine-2008} montrent que les techniques qu'ils proposent pour améliorer l'inter-référencement permettent de limiter les ambigüités et d'améliorer les performances globales du groupe.
				...
				\begin{mysubsubsection}[sss-sota-LaConscienceDeGroupe]{La conscience de groupe}
					La présence de groupe, également appelée \myemph{awareness}, a été définie par \mycite[author]{Dourish-1992}.
					\begin{myquote}[english]
					...
					\begin{myquote}[frenchb]
						[La conscience de groupe est la] compréhension des activités des autres, qui permet de donner un contexte à sa propre activité.
					\end{myquote}

					La conscience des autres partenaires peut concerner aussi bien l'action réalisée, la position actuelle ou encore des informations durables sur un collaborateur (âge, sexe, spécialité, culture, \myetc) \mycite{Cockburn-1999}.
					...
					\mycite[author]{Cahour-2005} identifient trois avantages d'avoir une bonne conscience de groupe en étudiant la coopération entre serveurs et cuisiniers d'un café-restaurant :
					\begin{itemize}
					...
					\mycite[author]{Gutwin-1996} propose les quatre catégories de conscience suivantes\footnote{Les catégories en anglais sont les suivantes : \myemph{informal awareness}, \myemph{social awareness}, \myemph{group-structural awareness} et \myemph{workspace awareness}.} :
					\begin{description}
					...
					D'après \mycite[author]{Sallnas-2004}, la conscience est une donnée objective (l'individu sait que son collègue est présent, qu'il s'appelle Luke et que c'est son père) alors que la présence est plutôt une donnée subjective.
				...
				\end{mysubsubsection}
			\end{mysubsection}
			\begin{mysubsection}[sse-sota-PlateformeDeCollaborationVirtuelle]{Plateforme de collaboration virtuelle}
			\end{mysubsection}
		\end{mysection}
	...
	\begin{mychapter}[cha-Shaddock-ManipulationCollaborativeDeMolecules]{\myShaddock\ -- Plateforme de manipulation collaborative de molécules}
		...
		\begin{mysection}[sec-Shaddock-ArchitectureMaterielleEtLogicielle]{Architecture matérielle et logicielle}
			...
			\begin{mysubsection}[sse-Shaddock-ArchitectureLogicielleAdoptee]{Architecture logicielle adoptée}
				Deux types d'architectures ont été explorés pour les \myacro*{acr-EVC} : client/serveur ou pair-à-pair\footnote{\myemph{Peer-to-peer} en anglais, parfois abrégé en \myPtwoP.}.
		...
		\begin{mysection}[sec-Shaddock-PlateformeDeSimulationEtDeVisualisation]{Plateforme de simulation et de visualisation}
			...
			Cependant, les moteurs de simulation ne sont pas conçus pour effectuer des simulations en temps-réel, et encore moins des simulations \myemph{interactives} en temps-réel.
			...
			\begin{mysubsection}[sse-Shaddock-ModuleDeSimulationMoleculaire]{Module de simulation moléculaire}
				...
				\begin{mysubsubsection}[sss-Shaddock-LaGenerationAutomatiqueDeFichierDeSimulation]{La génération automatique de fichier de simulation}
					...
					\myacro{acr-VMD} fournit l'outil permettant de générer le fichier nécessaire à la simulation (fichier \myPSF) par l'intermédiaire d'une extension : \myemph{Automatic \textsc{psf} builder}.
				\end{mysubsubsection}
			\end{mysubsection}
		\end{mysection}
...
vmd> set mysel [atomselect "top" "name C or name O or name N or name CA"]
				...
				\mycite[author]{Pavlovic-1996} ont développé une plateforme permettant d'interagir avec les molécules en utilisant la voix et les gestes.
				...
				\mycite[author]{Levine-1997} proposent une plateforme d'interaction avec un environnement moléculaire virtuel afin d'explorer un complexe ligand-protéine pour réaliser un \myglos{glo-DockingMoleculaire}.
				Cependant, le \myglos{glo-DockingMoleculaire} s'effectue ici sur des corps rigides ce qui simplifie grandement la complexité de l'exploration.
			...
			\begin{mysubsection}[sse-exp1-Objectifs]{Objectifs}
				...
				Enfin, nous souhaitons valider la plateforme de manipulation proposée.
				...
				L'objectif est de vérifier l'utilisabilité de la plateforme afin d'identifier les points faibles et les contraintes.
			\end{mysubsection}
		\end{mysection}
		\begin{mysection}[sec-exp1-PresentationDeLExperimentation]{Présentation de l'expérimentation}
			...
			\begin{mysubsection}[sse-exp1-DescriptionDeLaTache]{Description de la tâche}
				...
				La molécule \myTRPZIPPER sera utilisée pour la procédure d'apprentissage de la plateforme.
				...
				\begin{mytable}
					...
					\begin{mytabular}{>{\bfseries}p{\exponefirstcolumn}p{\exponesecondcolumn}}
						...
						\mytitlecolumn{4}{Hypothèses}              & \myhypothesis{1} Amélioration des performances en \myglosnl{glo-Binome}      \\
						                                           ...
						                                           & \myhypothesis{4} La plateforme est appréciée des utilisateurs               \\
						\mymiddlerule
	...
	\begin{mychapter}[cha-DeformationCollaborativeDeMolecule]{Déformation collaborative de molécule}
		\begin{mysection}[sec-exp2-Introduction]{Introduction}
			...
			En effet, certains éléments de la première expérimentation semble indiquer qu'une configuration collaborative stimule l'apprentissage concernant l'utilisation des outils, de la plateforme ou encore de la tâche à réaliser.
		\end{mysection}
		\begin{mysection}[sec-exp2-DeformationCollaborativeEnEnvironnementVirtuel]{Déformation collaborative en environnement virtuel}
			\begin{mysubsection}[sse-exp2-TravauxExistants]{Travaux existants}
				...
				\mycite[author]{Sumengen-2007} proposent une plateforme permettant la déformation de maillages destinés à des simulations d'objets déformables (tissus, organes, \myetc) dans un \myacro{acr-EVC}.
				...
				Ces deux plateformes proposent chacun une plateforme de déformation collaborative mais se focalisent principalement sur les contraintes techniques d'une telle plateforme.
			...
			\begin{mysubsection}[sse-exp2-Objectifs]{Objectifs}
				...
				Nous supposons que la facilitation et l'échange qui a lieu lors d'un travail collaboratif va permettre aux \myglos*{glo-Binome} d'appréhender plus rapidement la plateforme, les outils ou encore la tâche.
			\end{mysubsection}
		\end{mysection}
		\begin{mysection}[sec-exp2-PresentationDeLExperimentation]{Présentation de l'expérimentation}
			...
			\begin{mysubsection}[sse-exp2-SpecificitesDuProtocoleExperimental]{Spécificités du protocole expérimental}
				...
				\begin{mysubsubsection}[sss-exp2-Materiel]{Matériel}
					Pour cette seconde expérimentation, une unique modification a été effectuée par rapport à la plateforme de base \myref*{sec-pro-MaterielExperimental}.
		...
		\begin{mysection}[sec-exp2-Resultats]{Résultats}
			...
			\begin{mysubsection}[sse-exp2-AmeliorationDesPerformancesEnBinome]{Amélioration des performances en \myglosnl{glo-Binome}}
				\begin{mysubsubsection}[sss-exp2-AmeliorationDesPerformancesEnBinome-DonneesEtStatistiques]{Données et statistiques}
					...
					L'analyse montre un déséquilibre de vitesse moyenne entre la main dominante et dominée des \myglos*{glo-Monome} avec un effet significatif (\myanova{exp2-speed-group-dominant-anova-monome.tex}) avec une différence de \myratio{exp2-speed-group-dominant-ratio-monome.tex}.
			...
			\begin{mysubsection}[sse-exp2-AmeliorationDeLApprentissagePourLesBinomes]{Amélioration de l'apprentissage pour les \myglosnl*{glo-Binome}}
				\begin{mysubsubsection}[sss-exp2-AmeliorationDeLApprentissagePourLesBinomes-DonneesEtStatistiques]{Données et statistiques}
					...
					Un test post-hoc de \mycite[author]{Mann-1947} avec une correction de \mycite[author]{Holm-1979} montre une évolution significative seulement à partir de dernier essai pour les \myglos*{glo-Monome} avec une diminution de \myratio{exp2-time-try-group-ratio-monome.tex} alors que l'évolution est significative dès le deuxième essai pour les \myglos*{glo-Binome} avec une diminution de \myratio{exp2-time-try-group-ratio-binome.tex}.
				...
				\begin{mysubsubsection}[sss-exp2-AmeliorationDeLApprentissagePourLesBinomes-AnalyseEtDiscussion]{Analyse et discussion}
					...
					Dans cette section, nous avons mis en évidence les améliorations en terme d'apprentissage pour les configurations collaboratives sans distinction sur les aspects de l'apprentissage (plateforme, outils, tâche, \myetc).
			...
			\begin{mysubsection}[sse-exp2-ResultatsQualitatifs]{Résultats qualitatifs}
				...
				Tout d'abord, la grande majorité des sujets travaillant en \myglos{glo-Binome} se sont trouvés utiles dans cette tâche de collaboration (\mysummary{exp2-evaluation-help.tex})\footnote{L'échelle de notation est comprise entre \mynum{1} et \mynum{5} mais les moyennes ont été normalisées entre \mynum{0} et \mynum{4}.}.
				...
				En effet, l'importance de la communication verbale a été mise en avant (\mysummary{exp2-evaluation-verbal}).
				Par opposition, les sujets ont considéré qu'ils n'utilisaient quasiment pas la modalité virtuelle (\mysummary{exp2-evaluation-virtual.tex}) et encore moins la modalité gestuelle (\mysummary{exp2-evaluation-gestural.tex}) pour communiquer.
				...
				La configuration \myglos*{glo-Monomanuel} en \myglos{glo-Monome} (qui n'a pas été testée) a été relativement peu choisie (\mysummary{exp2-evaluation-monome-monomanual.tex}).
		...
		\begin{mysection}[sec-exp2-Synthese]{Synthèse}
			\begin{mysubsection}[sse-exp2-ResumeDesResultats]{Résumé des résultats}
				...
				La complexité de la tâche ainsi que de la plateforme (rendu visuel, outils, \myetc) nécessite un apprentissage important.
		...
		\begin{mysection}[sec-exp3-PresentationDeLExperimentation]{Présentation de l'expérimentation}
			...
			\begin{mysubsection}[sse-exp3-SpecificitesDuProtocoleExperimental]{Spécificités du protocole expérimental}
				...
				\begin{mysubsubsection}[sss-exp3-Materiel]{Matériel}
					...
					Il est nécessaire d'ajouter deux outils de déformation supplémentaires à la plateforme \myref*{sec-pro-MaterielExperimental}.
		...
		\begin{mysection}[sec-exp3-Resultats]{Résultats}
			\begin{mysubsection}[sse-exp3-AmeliorationDesPerformances]{Amélioration des performances}
				\begin{mysubsubsection}[sss-exp3-AmeliorationDesPerformances-DonneesEtTestsStatistiques]{Données et tests statistiques}
					...
					L'analyse montre un effet significatif du nombre de sujets \myvari{1} sur la vitesse moyenne \myvard{3} de la molécule \myPrion (\myanova{exp3-speed-molecule-group-anova-prion.tex}) supérieur de \myratio{exp3-speed-molecule-group-ratio-prion.tex}.
					De la même façon, l'analyse montre un effet significatif du nombre de sujets \myvari{1} sur la vitesse moyenne \myvard{3} de la molécule \myUbiquitin (\myanova{exp3-speed-molecule-group-anova-ubiquitin.tex}) supérieur de \myratio{exp3-speed-molecule-group-ratio-ubiquitin.tex}.
					...
					L'analyse montre un effet significatif du nombre de sujets \myvari{1} sur le nombre d'échanges verbaux \myvard{5} de la molécule \myPrion (\myanova{exp3-talk-molecule-group-anova-prion.tex}) inférieur de \myratio{exp3-talk-molecule-group-ratio-prion.tex}.
					De la même façon, l'analyse montre un effet significatif du nombre de sujets \myvari{1} sur le nombre d'échanges verbaux \myvard{5} de la molécule \myUbiquitin (\myanova{exp3-talk-molecule-group-anova-ubiquitin.tex}) inférieur de \myratio{exp3-talk-molecule-group-ratio-ubiquitin.tex}.
				\end{mysubsubsection}
				\begin{mysubsubsection}[sss-exp3-AmeliorationDesPerformances-AnalyseEtDiscussion]{Analyse et discussion}
					...
					L'étude précédente présentée dans le \myref{cha-RechercheCollaborativeDeResiduSurUneMolecule} a montré que les performances sont meilleures lorsque les ressources disponibles (outils de manipulation) sont partagées entre plusieurs utilisateurs.
					Cependant, cette étude compare deux configurations collaboratives.
					On constate d'après la \myref{fig-exp3-TempsDeRealisationDesScenariosEnFonctionDuNombreDeParticipants} que les \myglos*{glo-Quadrinome} obtiennent des performances identiques aux \myglos*{glo-Binome}, indépendamment du scénario.
			...
			\begin{mysubsection}[sse-exp3-DefinitionDUnMeneur]{Définition d'un \myglosnl{glo-Meneur}}
				...
				\begin{mysubsubsection}[sss-exp3-DefinitionDUnMeneur-AnalyseEtDiscussion]{Analyse et discussion}
					...
					L'identification des rôles est nécessaire pour obtenir de bonne performances et éviter le phénomène de \myglos{glo-ParesseSociale} \myref*{sse-exp3-UtiliteDuBrainstormingPourLaCollaboration}.
	...
	\begin{mychapter}[cha-TravailCollaboratifAssisteParHaptique]{Travail collaboratif assisté par haptique}
		\begin{mysection}[sec-exp4-Introduction]{Introduction}
			Cette dernière expérimentation a pour objectif d'introduire et de valider des outils de communication haptique dans le cadre d'une tâche de \myglos{glo-DockingMoleculaire}.
		...
		\begin{mysection}[sec-exp4-AssistanceHaptiquePourLaCommunication]{Assistance haptique pour la communication}
			\begin{mysubsection}[sse-exp4-TravauxExistants]{Travaux existants}
				Le concept de communication haptique a été initié par les travaux de \mycite[author]{Sallnas-2000} avec une expérimentation sur la manipulation synchrone de cube au sein d'un environnement virtuel.
				...
				Sur le même principe de manipulation synchrone, \mycite[author]{Basdogan-2000} proposent de déplacer un anneau autour d'un fil avec pour objectif de ne pas toucher le fil.
				...
				Sur la base de ces résultats, \mycite[author]{Oakley-2001} propose un environnement en \myTwoD pour la création de diagrammes \myacro{acr-UML}.
				...
				D'ailleurs, \mycite[author]{Moll-2009} mettent en évidence l'utilité des retours haptiques pour la désignation de cible en environnement virtuel.

				Le terme \myemph{communication haptique} a pris tout son sens avec les premières tentatives de \myemph{langages haptiques}.
				Tout d'abord, \mycite[author]{Chang-2002} proposent d'augmenter l'information d'une communication par \myemph{talkies-walkies} avec différents types de vibrations.
				...
				Récemment, \mycite[author]{Ullah-2011} s'est intéressé aux influences de la communication haptique sur le sentiment de présence et sur la conscience périphérique \myref*{sse-sota-LaCommunicationImpliciteEtExplicite}.
				Tout d'abord avec des travaux sur la manipulation collaborative d'un bras articulé en environnement virtuel, il montre une amélioration de la conscience périphérique \mycite{Naud-2009}.
				Puis, c'est avec une tâche de déplacement d'objet virtuel coordonné (une cheville à déplacer dans un trou) que \mycite[author]{Ullah-2010} montre une amélioration significative du sentiment de présence et de la conscience périphérique.
			\end{mysubsection}
			\begin{mysubsection}[sse-exp4-Objectifs]{Objectifs}
				...
				\mycite[author]{Moll-2009} a montré la pertinence de la modalité haptique pour la communication et en particulier pour le processus de désignation.
		...
		\begin{mysection}[sec-exp4-PresentationDeLExperimentation]{Présentation de l'expérimentation}
			\begin{mysubsection}[sse-exp4-DescriptionDeLaTache]{Description de la tâche}
				...
				L'affichage des molécules est identique à celui de la troisième expérimentation présenté dans la \myref{sss-exp3-Visualisation} : la molécule déformable est représentée en \myCPK et \myNewRibbon alors que la molécule cible est en \myNewRibbon transparent.
				...
				\begin{description}
					\item[Entraînement~\myscenario{1}]
						...
						La tâche est volontairement peu complexe et est surtout destinée à permettre aux sujets d'intégrer les étapes du processus de désignation \myref*{sss-Shaddock-OutilDeDesignation}.
					...
					\item[Scénario~\myscenario{2}]
						...
						La molécule \myNusG est laissé complétement libre de mouvement (pas d'atome fixes) et doit être amarrée à la molécule \myNusE : c'est une tâche de \myglos{glo-DockingMoleculaire} simplifiée.
				...
				Une première mesure est le score \myacro{acr-RMSD}, déjà décrit dans la \myref{sse-exp2-DescriptionDeLaTache}.
			...
			\begin{mysubsection}[sse-exp4-SpecificitesDuProtocoleExperimental]{Spécificités du protocole expérimental}
				...
				\begin{mysubsubsection}[sss-exp4-Materiel]{Matériel}
					Dans cette quatrième et dernière expérimentation, nous introduisons de nouveaux outils destinés à améliorer les interactions entre les membres d'un \myglos{glo-Trinome}.
					Les deux opérateurs auront à leur disposition deux outils de déformation adaptés pour le processus de désignation \myref*{sss-exp4-OutilsDInteraction} matérialisés par des \myOmni.
					...
					Chaque interface haptique est liée à un serveur \myacro{acr-VRPN}.
				...
				\begin{mysubsubsection}[sss-exp4-OutilsDInteraction]{Outils d'interaction}
					...
					Les outils modifiés sont l'outil d'orientation, l'outil de désignation, l'outil de déformation par atome et l'outil de déformation par molécule que nous nommerons outil de manipulation.
					Ces outils sont décrits dans la \myref{sse-Shaddock-OutilsDeManipulationAvances}.
					\begin{description}
						\item[Outil de désignation]
							...
							L'arrêt de la vibration informe le coordinateur que la désignation vient d'être acceptée par un opérateur.
							Tant que la cible désignée par le coordinateur n'aura pas été acceptée, le coordinateur ne pourra pas désigner une autre cible.
						\item[Outil de déformation]
							Un outil de déformation par atome est fourni aux deux opérateurs.
							Le coordinateur indiquer qu'une nouvelle désignation a été effectuée en émettant une vibration chez les opérateurs.
							Il est à noter que si les opérateurs sont en train de déformer la molécule, ils ne ressentent pas la vibration mais dès qu'ils relâchent leur sélection, la vibration leur indique qu'une requête est en cours.
							Les opérateurs ont la possibilité d'accepter ou non la désignation.
							Lorsque un opérateur accepte la désignation, les vibrations du coordinateur et des opérateurs s'arrêtent.
							L'opérateur qui a accepté est alors attiré vers la cible à déformer.
							De plus, sa prochaine déformation lui permettra la déformation d'un \myglos{glo-Residu} ce qui est un gain de potentiel de déformation substantiel.
						...
						\item[Outil d'orientation]
							...
							Cet outil, générateur de \myglos*{glo-ConflitDeCoordination}, a été de nouveau mis à disposition après avoir été enlevé de la troisième expérimentation.
		...
		\begin{mysection}[sec-exp4-Resultats]{Résultats}
			...
			Les données, qui sont appareillées et en faible nombre, ont été confrontées au test des rangs signés de \mycite[author]{Wilcoxon-1945}.
			\begin{mysubsection}[sse-exp4-AmeliorationDesPerformances]{Amélioration des performances}
				...
				\begin{mysubsubsection}[sss-exp4-AmeliorationDesPerformances-AnalyseEtDiscussion]{Analyse et discussion}
					En observant le meilleur score \myacro{acr-RMSD} obtenu par les participants avec et sans haptique, on constate qu'il n'y a pas d'amélioration significative des performances \myref*{fig-exp4-ScoreRMSDMinimumAtteintAvecEtSansHaptique}.
					L'assistance haptique proposée ne semble pas permettre d'améliorer la collaboration entre les sujets et ne confirme pas l'hypothèse~\myhypothesis{1}.
					D'ailleurs, la \myref{fig-exp4-TempsPourAtteindreLeScoreRMSDMinimumAvecEtSansHaptique} montre que le temps mis pour atteindre ce score ne s'est également pas amélioré.

					Cependant, une analyse segmentée en fonction des scénarios montre que les outils d'assistance haptique permettent une amélioration sur le complexe de molécules \myNusENusG (scénario~\myscenario{2}) mais pas sur la molécule \myUbiquitin (scénario~\myscenario{1}).
					...
					La \myref{fig-exp4-NombreDeSelectionsParSecondeEffectueesParUnOperateurPourLaDeformationAvecEtSansHaptique} et la \myref{fig-exp4-TempsMoyenDUneSelectionParSecondeEffectueeParUnOperateurPourLaDeformationAvecEtSansHaptique} montrent que ces actions solitaires diminuent avec la présence des outils d'assistance haptique.
					...
					D'ailleurs, la \myref{fig-exp4-TempsMoyenPourAtteindreUneCibleDesigneeLorsDUneDesignationAvecEtSansHaptique} montre que les opérateurs sont plus rapides à atteindre la cible désignée avec l'assistance haptique ce qui leur permet de passer plus de temps à déformer mais moins de temps à chercher des tâches à réaliser.

					Nous avons vu que les outils d'assistance haptique pour la désignation aident le coordinateur à imposer une stratégie commune ce qui a pour effet d'améliorer les performances du groupes sur les tâches les plus complexes.
					L'hypothèse~\myhypothesis{1} est confirmée pour la tâche la plus complexe.
					Il semble que quelque soit la stratégie, le travail collaboratif sera plus efficace si tous les membres du groupe sont en accord avec la stratégie à suivre.
				\end{mysubsubsection}
			\end{mysubsection}
			\begin{mysubsection}[sse-exp4-AmeliorationDeLaCommunication]{Amélioration de la communication}
				...
				\begin{mysubsubsection}[sss-exp4-AmeliorationDeLaCommunication-AnalyseEtDiscussion]{Analyse et discussion}
					...
					En effet, une meilleure perception des désignations permet aux opérateurs d'être plus réactifs à la stratégie du coordinateur \myref*{fig-exp4-NombreDeDesignationsAccepteesAuCoursDuProcessusDeDesignationAvecEtSansHaptique}.
					...
					On constate cette amélioration de rendement par une vitesse moyenne du coordinateur augmentée comme le montre la \myref{fig-exp4-VitesseMoyenneDuCoordinateurAvecEtSansHaptique}.

					Pourtant, la \myref{fig-exp4-TempsDeParoleDesSujetsAvecEtSansHaptique} ne montre pas d'évolution du temps de parole lié à la présence ou à l'absence d'une assistance haptique.
			...
			\begin{mysubsection}[sse-exp4-EvaluationQualitative]{Évaluation qualitative}
				\begin{mysubsubsection}[sss-exp4-QuestionnaireDUtilisabilite]{Questionnaire d'utilisabilité}
					Cette dernière expérimentation a été l'occasion d'évaluer l'utilisabilité de la plateforme \myShaddock à l'aide du score \myacro{acr-SUS} décrit dans la \myref{sse-Questionnaires-QuatriemeExperimentation-LeQuestionnaireSUS}.
					L'évaluation par l'ensemble des utilisateurs fournit une note relativement peu élevée (\mysummary{exp4-evaluation-sus.tex})\footnote{Pour rappel, les tests d'utilisabilité \myacronl-{acr-SUS} fournissent des notes comprises entre \mynum{0} et \mynum{100}.}.
					Cependant, si on restreint ce score aux sujets biologistes, le score augmente (\mysummary{exp4-evaluation-sus-biologists.tex}).
					La plateforme n'est pas encore suffisante dans l'état actuel selon les utilisateurs.
					En se basant sur les travaux de \mycite[author]{Bangor-2009}, on peut évaluer notre plateforme comme \og \myemph{OK} \fg ce qui signifie qu'elle se trouve en-dessous de la moyenne globale d'utilisabilité du score d'évaluation \myacro{acr-SUS} mais qu'elle reste une application utilisable.
					L'hypothèse~\myhypothesis{3} est donc partiellement validé avec ces résultats sont mitigés.
					...
					En particulier, ils auraient souhaité pouvoir stabiliser un \myglos{glo-Residu} dans sa position finale ou encore pouvoir déformer des structures moléculaires de taille plus importante que les \myglos*{glo-Residu} tels que les \myhelice* et les \myfeuillet*.
					Cependant, ce dernier point a été abordé dans la \myref{sss-Shaddock-DeformationParGroupeDAtomes}.
				\end{mysubsubsection}
				\begin{mysubsubsection}[sss-exp4-QuestionnaireSurLaConsciencePeripherique]{Questionnaire sur la conscience périphérique}
					Les utilisateurs pensent être relativement conscients des actions de leurs partenaires puisqu'ils estiment comprendre les requêtes et consignes de leurs collègues rapidement (\mysummary{exp4-evaluation-resume-2.tex}) et qu'ils considèrent être conscients à chaque instant de la position des autres collaborateurs (\mysummary{exp4-evaluation-resume-1.tex})\footnote{L'échelle de notation est comprise entre \mynum{1} et \mynum{5} mais les moyennes ont été normalisées entre \mynum{0} et \mynum{4}.}.
					D'ailleurs, ils pensent que leurs partenaires font de même puisqu'ils n'éprouvent pas le besoin de se signaler (\mysummary{exp4-evaluation-resume-3.tex}).
					...
					Cependant, il y a tout de même un cas pour lequel les utilisateurs éprouvent le besoin de se signaler : l'acceptation d'une requête ou d'une consigne (\mysummary{exp4-evaluation-resume-4.tex}).
					...
					Par exemple, le coordinateur indique oralement une cible qu'il a désigné mais qu'un opérateur n'aurait pas vu, ou encore un opérateur peut signaler au coordinateur un \myglos{glo-Residu} ayant besoin d'être rapidement déplacé.
					...
					En effet, un test de \mycite[author]{Wilcoxon-1945} montre qu'il n'y a aucun effet significatif des outils de communication haptique sur :
					\begin{itemize}
						\item la compréhension rapide des actions effectuées par les collègues (\myanova{exp4-evaluation-resume-2-anova.tex});
						\item le besoin de se signaler (\myanova{exp4-evaluation-resume-3-anova.tex});
						\item le signalement lors de l'acceptation d'une consigne (\myanova{exp4-evaluation-resume-4-anova.tex}).
					\end{itemize}

					Cependant, on note que les sujets estiment que les consignes peuvent plus souvent se passer d'une communication verbale lorsque les outils de communication haptique sont présents (\mysummary{exp4-evaluation-resume-5.tex}).
					Un test de \mycite[author]{Wilcoxon-1945} montre un résultat assez proche du seuil de significativité (\myanova{exp4-evaluation-resume-5-anova.tex}).
					...
					Les utilisateurs font ressortir à travers le questionnaire, de façon modérée, une meilleure communication avec assistance haptique (\mysummary{exp4-evaluation-resume-5-true.tex}) que sans assistance haptique (\mysummary{exp4-evaluation-resume-5-false.tex}).
					...
					De plus, le rôle de l'assistance haptique s'est montré particulièrement utile dans la conscience de la position des autres utilisateurs (\myanova{exp4-evaluation-resume-1-anova.tex}).
					En effet, les sujets ont estimé connaître les zones de travail des partenaires de manière modérée sans assistance haptique (\mysummary{exp4-evaluation-resume-1-false.tex}) alors que la présence de retours haptiques semble améliorer cette perception (\mysummary{exp4-evaluation-resume-1-true.tex}).
		...
		\begin{mysection}[sec-exp4-Synthese]{Synthèse}
			\begin{mysubsection}[sse-exp4-ResumeDesResultats]{Résumé des résultats}
				...
				Un tel outil a été discuté dans la \myref{sss-Shaddock-DeformationParGroupeDAtomes} mais les contraintes de manipulation d'un tel ensemble d'atomes entraînerait des modifications importantes sur les métaphores de manipulation.
			...
			\begin{mysubsection}[sse-exp4-Conclusion]{Conclusion}
				...
				On peut se reporter aux travaux de \mycite[author]{Oakley-2001} qui propose des idées intéressantes sur le sujet.
				...
				La possibilité d'\myemph{attraper} un curseur puis de le \myemph{tirer} vers une cible peut également se montrer pertinente.
	...
	\begin{mychapter}[cha-pro-DispositifExperimental]{Dispositif expérimental}
		...
		\begin{mysection}[sec-pro-PresentationsDesMolecules]{Présentation des molécules}
			...
			\begin{mysubsection}[sse-pro-RepresentationDesMolecules]{Représentation des molécules}
				...
				Heureusement, \myacro{acr-VMD} possède un moteur de rendu graphique avancé \myref*{sss-Shaddock-RendusGraphiquesSelectionnesPourNotrePlateforme}, aussi bien en terme de choix de rendu qu'en terme d'accélération graphique.
	...
	\begin{mychapter}[cha-met-MethodeExperimentale]{Méthode expérimentale}
		\begin{mysection}[sec-met-exp1-PremiereExperimentation]{Première expérimentation}
			\begin{mysubsection}[sse-met-exp1-Hypotheses]{Hypothèses}
				...
				Deuxièmement, une évaluation de la plateforme est nécessaire.
				Des hypothèses sont formulées pour noter l'utilisabilité de la plateforme ainsi que la sensation de collaboration des utilisateurs.
				...
				\end{myparagraph}
				\begin{myparagraph}[par-met-exp1-LaPlateformeEstApprecieeDesUtilisateurs]{\myhypothesis{4} La plateforme est appréciée des utilisateurs}
					Notre dernière hypothèse concerne la validation de notre plateforme en terme d'utilisabilité (intuitivité, ergonomie, \myetc).
		...
		\begin{mysection}[sec-met-exp4-QuatriemeExperimentation]{Quatrième expérimentation}
			...
			\begin{mysubsection}[sec-met-exp4-Variables]{Variables}
				...
				\begin{mysubsubsection}[sec-met-exp4-VariablesDependantes]{Variables dépendantes}
					...
					\begin{myparagraph}[par-met-exp4-NombreDeSelections]{\myvard{3} Nombre de sélections}
						\myvard{3} représente le nombre de sélections réalisées durant chaque tâche à réaliser.
					...
					\begin{myparagraph}[par-met-exp4-TempsMoyenPourAtteindreUneCibleAcceptee]{\myvard{6} Temps moyen pour atteindre une cible acceptée}
						Lorsqu'un cible est acceptée par un opérateur, cette mesure représente le temps que met l'opérateur pour atteindre et sélectionner le \myglos{glo-Residu} désigné.
					\end{myparagraph}
					...
					\begin{myparagraph}[par-met-exp4-QuestionnaireDUtilisabiliteEtSurLaPresence]{\myvard{10} Questionnaire d'utilisabilité et sur la conscience}
						...
						Il nous permet d'obtenir un score d'utilisabilité de la plateforme compris entre \mynum{0} et \mynum{100}.
						De plus, un questionnaire sur la conscience périphérique est proposé après chaque alternance de la variable indépendante \myvard{1}.
					\end{myparagraph}
				\end{mysubsubsection}
			\end{mysubsection}
			\begin{mysubsection}[sse-met-exp4-Procedure]{Procédure}
				...
				\begin{myparagraph}[par-met-exp4-Phase1-RepartitionDesRoles]{Phase~\mynum{1} : répartition des rôles}
					...
					Nous nous plaçons dans le cadre d'une \myglos{glo-StructureInformelle} dans laquelle un des sujets sera le coordinateur et les deux autres seront les opérateurs.
				...
				\begin{myparagraph}[par-met-exp4-Phase7-DeuxiemeEtapeDEvaluation]{Phase~\mynum{7} : deuxième étape d'évaluation}
					...
					Seules les phases de déformations de \mynum[mn]{8}, \myUbiquitin puis \myNusENusG, sont proposées.
				\end{myparagraph}
				\begin{myparagraph}[par-met-exp4-Phase8-LeQuestionnaire]{Phase~\mynum{8} : deuxième partie du questionnaire}
					La seconde partie du questionnaire est similaire à la première partie \myref*{sec-Questionnaires-QuatriemeExperimentation}.
