...
vmd> set mysel [atomselect "top" "name C or name O or name N or name CA"]
				...
				\mycite[author]{Levine-1997} proposent une plateforme d'interaction avec un environnement moléculaire virtuel afin d'explorer un complexe ligand-protéine pour réaliser un amarrage de molécules.
