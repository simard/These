	...
	\begin{mychapter}[cha-sota-EtudeBibliographique]{Étude bibliographique}
		...
		\begin{mysection}[sec-sota-ContexteDeTravail-LaModelisationMoleculaire]{Contexte de travail : la modélisation moléculaire}
			...
			\begin{mysubsection}[sse-sota-LeDockingMoleculaireEnEnvironnementVirtuel]{Le \myglosnl{glo-DockingMoleculaire} en environnement virtuel}
				...
				En effet, un expert, bien que moins rapide pour traiter rapidement les données, est capable de filtrer plus intelligemment les solutions pour lesquelles il faut améliorer la précision et celles qu'on peut rejeter immédiatement.

				L'intervention d'un expert durant le processus de recherche est effectuée par l'immersion par les solutions de \myglos{glo-RealiteVirtuelle}.
				\myGROPEHaptic est le premier projet à s'intéresser à la manipulation moléculaire interactive \mycite{Ouh-Young-1988,Brooks-1990} et déjà à l'époque, c'est le \myglos{glo-DockingMoleculaire} qui intéresse.
				...
				\mycite[author]{Bergman-1993} explore les structures moléculaires avec la plate-forme \myVIEW en proposant différentes représentations pour les molécules.
				...
				\mycite[author]{Huitema-2000} fournit une possibilité de visualiser des trajectoires d'atomes à propos de la dynamique de protéines.
				Puis \mycite[author]{Klosowski-2002} franchit une étape supplémentaire en proposant une visualisation temps-réel à l'aide du moteur de simulation \myGromacs \mycite{Berendsen-1995,Hess-2008}.
				Enfin, afin d'améliorer l'exploration, \mycite[author]{Krenek-1999} puis \mycite[author]{Davies-2005} propose une visualisation multimodale en ajoutant un retour haptique afin de percevoir les champs de forces.
				...
				\mycite[author]{Lee-2004} calque les interactions haptiques sur l'approximation du champ de force de \mycite[author]{Lennard-Jones-1924a,Lennard-Jones-1924b}, largement adopté par la communauté.
				Enfin, la manipulation interactive avec la simulation d'une molécule flexible devient possible avec la plate-forme proposée par \mycite[author]{Delalande-2009} à laquelle il ajoute la possibilité d'interagir avec une interface haptique \mycite{Delalande-2010}.
				...
				Par exemple, \mycite[author]{Sankaranarayanan-2003} propose une plate-forme interactive avec des interfaces haptiques pour apprendre et comprendre les structures moléculaires.
				Puis \mycite[author]{Wollacott-2007} s'intéresse à la compréhension des interactions chimiques avec la combinaison d'une interface haptique et de l'interface tangible proposée par \mycite[author]{Weghorst-2003}.
				...
				\mycite[author]{Lai-Yuen-2005} propose une interface haptique avec cinq \myacro*{acr-DDL} afin d'effectuer du \myglos{glo-DockingMoleculaire} rigide \mycite{Lai-Yuen-2006}.
				...
				Le \myglos{glo-DockingMoleculaire} faisant intervenir des champs de force spécifiques, \mycite[author]{Hou-2010} propose des modèles de forces haptiques adaptés.
				...
				Puis \mycite[author]{Daunay-2009} offre la possibilité d'évaluer en temps-réel ces simulations.
				\mycite[author]{Stone-2010} fournit les interfaces nécessaires sur le logiciel \myacro{acr-VMD} pour accéder à des solutions de \myglos{glo-RealiteVirtuelle}.
