	...
	\begin{mychapter}[cha-LaDynamiqueDeGroupe]{La dynamique de groupe}
		...
		\begin{mysection}[sec-exp3-CollaborationDeGroupe]{Collaboration de groupe}
			\begin{mysubsection}[sse-exp3-TravauxExistants]{Travaux existants}
				...
				Ce phénomène, appelé \myglos{glo-ParesseSociale}, est exactement le contraire des résultats obtenus par \mycite[author]{Roethlisberger-1939} sur la \myglos{glo-MotivationSociale}.
				...
				Cependant, l'analyse de \mycite[author]{Latane-1979} conclue sur la nécessité de trouver une solution pour limiter ce problème et propose de renforcer la responsabilité individuelle plutôt que de la diffuser sur le groupe en tant qu'entité propre.
				Une définition précise des rôles de chacun durant la collaboration permettra de responsabiliser chaque sujet tout en conservant les effets bénéfiques de la \myglos{glo-MotivationSociale}.
				...
				C'est \mycite[author]{Bales-1950} qui proposent les premières analyses sur ces groupes de trois à une vingtaine de partenaires.
