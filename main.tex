	...
	\begin{mychapter}[cha-sota-EtudeBibliographique]{Étude bibliographique}
		...
		\begin{mysection}[sec-sota-ContexteDeTravail-LaModelisationMoleculaire]{Contexte de travail : la modélisation moléculaire}
			...
			\begin{mysubsection}[sse-sota-RechercheDeSolutionsDeDockingMoleculaire]{Recherche de solutions de \myglosnl{glo-DockingMoleculaire}}
				...
				La flexibilité d'une molécule peut être vue à différents niveaux de granularité, de l'atome (granularité la plus fine) aux \myhelice* et \myfeuillet* (granularité la plus importante.
				La \myref{fig-sota-IllustrationDUneMoleculeAvecCesHelicesAlphaEtCesFeuilletsBeta} représente la structure interne d'un complexe de molécules constituée d'\myhelice* et de \myfeuillet*.
				...
				C'est pourquoi les logiciels présentés dans la \myref{tab-sota-ListeNonExhaustiveDeSolutionsLogiciellesDeDockingMoleculaire} évaluent plutôt des système semi-flexibles par différentes solutions dont voici quelques exemples:
				\begin{itemize}
			...
			\begin{mysubsection}[sse-sota-LeDockingMoleculaireEnEnvironnementVirtuel]{Le \myglosnl{glo-DockingMoleculaire} en environnement virtuel}
				...
				L'idée est de faire intervenir l'humain qui est capable de filtrer plus intelligemment les solutions pour lesquelles il faut améliorer la précision et celles qu'on peut rejeter immédiatement.
			\end{mysubsection}
		\end{mysection}
