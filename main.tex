	...
	\begin{mypart}{Étude du travail collaboratif}
		\begin{mychapter}{La recherche collaborative}
			...
			\begin{mysection}{Dispositif expérimental}
				Le \myacro{acr-EVC} utilisé est illustré sur la \myfigureref{fig-exp1-SchemaDuDispositifExperimental}.
				...
				\begin{itemize}
					\item \mynum{1}~interface haptique de manipulation;
					\item \mynum{2}~interfaces haptiques de déformation.
				\end{itemize}
			...
			\begin{mysection}{Méthode}
				...
				\begin{mysubsection}{Tâche}
					...
					Une fois le \myglos{glo-Residu} trouvé, les sujets doivent le sélection puis l'extraire hors de la sphère virtuelle englobant la molécule.
				\end{mysubsection}
				\begin{mysubsection}{Procédure}
					Pour débuter cette expérimentation, les sujets sont confrontés à un cas d'exemple sur la molécule \myTRPZIPPER \mycite{Cochran-2001} ayant pour identifiant \myPDB \myPDBlink{http://www.rcsb.org/pdb/explore/explore.do?structureId=1LE1}{1LE1}.
