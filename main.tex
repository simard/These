			...
			\begin{mysection}[sec-SimulationMoleculaireEnTempsReel]{Simulation moléculaire en temps-réel}
				...
				\begin{mysubsection}[sse-simulation-LesOutilsExistants]{Les outils existants}
					\begin{mysubsubsection}[sss-simulation-VMD]{\myacronl+{acr-VMD}}
						...
						Cependant, \myPyMOL n'est pas adapté à l'affichage de simulation et à la manipulation interactive, point nécessaire dans le cadre de notre étude et de nos expérimentations.
					...
					\begin{mysubsubsection}[sss-simulation-IMD]{\myacronl+{acr-IMD}}
						...
						Cependant, cette nouvelle solution n'a pas encore été implémentée dans notre plate-forme mais c'est une amélioration technique qui sera effectuée dans des prochaines versions de la plate-forme.
					\end{mysubsubsection}
				\end{mysubsection}
			\end{mysection}
