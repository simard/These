		...
		\begin{mysection}[sec-sota-LeTravailCollaboratif]{Le travail collaboratif}
			...
			\begin{mysubsection}[sse-sota-LaDistributionCognitiveDesChargesDeTravail]{La distribution cognitive des charges de travail}
				...
				\begin{myquote}[english]
					Unlike traditional theories, however, [the theory of distributed cognition] extends the reach of what is considered cognitive beyond the individual to encompass interactions between people and with resources and materials in the environment.
				\end{myquote}
			...
			\end{mysubsection}
			\begin{mysubsection}[sse-sota-LaMotivationSociale]{La motivation sociale}
			\end{mysubsection}
		\end{mysection}
	...
	\begin{mychapter}[cha-LaDynamiqueDeGroupe]{La dynamique de groupe}
		...
		\begin{mysection}[sec-exp3-CollaborationDeGroupe]{Collaboration de groupe}
			\begin{mysubsection}[sse-exp3-TravauxExistants]{Travaux existants}
				...
				\mycite[author]{Roethlisberger-1939} expliquent cette amélioration par la stimulation sociale qu'exerce chaque individu sur ses partenaires : c'est la \myglos{glo-MotivationSociale}.
