		...
		\begin{mysection}[sec-exp4-Resultats]{Résultats}
			...
			\begin{mysubsection}[sse-exp4-AmeliorationDeLaCommunication]{Amélioration de la communication}
				...
				\begin{mysubsubsection}[sss-exp4-AmeliorationDeLaCommunication-AnalyseEtDiscussion]{Analyse et discussion}
					...
					En effet, on constate sur la \myref{fig-exp4-NombreDeDesignationsAccepteesAuCoursDuProcessusDeDesignationAvecEtSansHaptique} que les opérateurs acceptent plus de désignations lorsqu'ils ont ces outils d'assistance à la communication à leur disposition.
