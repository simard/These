		...
		\begin{mychapter}[cha-LaRechercheCollaborative]{La recherche collaborative}
			...
			\begin{mysection}[sec-exp1-Resultats]{Résultats}
				...
				\begin{mysubsection}[sse-exp1-StrategiesDeTravail]{Stratégies de travail}
					...
					\begin{myfigure}
						\psset{xunit=0.075\textwidth,yunit=0.2cm}
						\begin{myps}(-1.25,-5)(12,21)
							...
							\uput[180](12,3){\pscharpath{\LARGE\bf\sffamily Espace proche}}
							\uput[180](12,9){\pscharpath{\LARGE\bf\sffamily Espace voisin}}
							\uput[180](12,15){\pscharpath{\LARGE\bf\sffamily Espace distant}}
						\end{myps}
						\mycaption[fig-exp1-DistanceMoyenneEntreLesSujetsPourChaqueBinome]{Distance moyenne entre les sujets pour chaque \myglosnl{glo-Binome}}
					\end{myfigure}
					\begin{myfigure}
						\psset{xunit=0.075\textwidth,yunit=0.5cm}
						\begin{myps}(-1.25,-1.75)(12,5.25)
							\myaxes(0,12){groupes}(0,5)[1]{affinité}
