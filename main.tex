...
\begin{document}
	...
	\begin{mychapter}[cha-RechercheCollaborativeDeResidusDansUneMolecule]{Recherche collaborative de résidus dans une molécule}
		\begin{mysection}[sec-exp1-Introduction]{Introduction}
			...
			Cependant, la distribution des charges cognitives de travail est une troisième solution que nous choisissons d'explorer par l'intermédiaire du travail collaboratif.
