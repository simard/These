		...
		\begin{mychapter}[cha-LesDynamiquesDeGroupe]{Les dynamiques de groupe}
			...
			\begin{mysection}[sec-exp3-Resultats]{Résultats}
				\begin{mysubsection}[sse-exp3-EvolutionDesPerformances]{Évolution des performances}
					...
					L'analyse montre un effet significatif du nombre de sujets \myvari{1} sur les scénarios \myvari{2} (\myanova{exp3-time-task-anova-molecule.tex}).

					\begin{myfigure}
						\psset{xunit=0.444444444\textwidth,yunit=0.005cm}
						\begin{myps}(-0.25,-220)(2,720)
							\myaxes(0,2){scénario}(0,600)[100]{temps~(s)}
							\myboxplot{exp3-time-task-group.csv}
					...
					L'analyse montre qu'il n'y a pas d'effet significatif du nombre de sujets \myvari{1} sur la molécule \myPrion (\myanova{exp3-time-task-group-anova-prion-group.tex}).
					De la même façon, l'analyse montre qu'il n'y a pas d'effet significatif du nombre de sujets \myvari{1} sur la molécule \myUbiquitin (\myanova{exp3-time-task-group-anova-ubiquitin-group.tex}).

					\begin{myfigure}
						\psset{xunit=0.43956044\textwidth,yunit=10cm}
						\begin{myps}(-0.275,-0.11)(2,0.36)
							\myaxes(0,2){scénario}(0,0.30)[0.05]{sélections~(nb/s)}
							\myboxplot{exp3-freqsel-task-group.csv}
							\mylegend{\myleg{\myglosnl{glo-Binome}}{myblue}\myand\myleg{\myglosnl{glo-Quadrinome}}{myblue!70}}
						\end{myps}
					...
					L'analyse montre qu'il n'y a pas d'effet significatif du nombre de sujets \myvari{1} sur la molécule \myPrion (\myanova{exp3-freqsel-task-group-anova-prion-group.tex}).
					De la même façon, l'analyse montre qu'il n'y a pas d'effet significatif du nombre de sujets \myvari{1} sur la molécule \myUbiquitin (\myanova{exp3-freqsel-task-group-anova-ubiquitin-group.tex}).
				\end{mysubsection}
			\end{mysection}
