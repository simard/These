...
vmd> set mysel [atomselect "top" "name C or name O or name N or name CA"]
	...
	\begin{mychapter}[cha-TravailCollaboratifAssisteParHaptique]{Travail collaboratif assisté par haptique}
		...
		\begin{mysection}[sec-exp4-Resultats]{Résultats}
			...
			Les données ont été confrontées au test des rangs signés \mycite{Wilcoxon-1945}.
			\begin{mysubsection}[sse-exp4-AmeliorationDesPerformances]{Amélioration des performances}
				\begin{mysubsubsection}[sss-exp4-AmeliorationDesPerformances-DonneesEtTestsStatistiques]{Données et tests statistiques}
					...
					\begin{myfigure}
						\psset{xunit=0.274914089\textwidth,yunit=0.07cm}
						\begin{myps}(-0.425,-15)(2,72.5)
							\myaxes(0,2){haptique}(0,70)[10]{sélections~(nb)}
							\myboxplot{exp4-button1-haptic.csv}
						\end{myps}
						\mycaption[fig-exp4-NombreDeSelectionParLesOperateursAvecEtSansHaptique]{Nombre de sélections par les opérateurs avec et sans haptique}
					\end{myfigure}

					La \myref{fig-exp4-NombreDeSelectionParLesOperateursAvecEtSansHaptique} présente le nombre de sélections effectuées par les opérateurs pour une déformation \myvard{3} avec et sans haptique \myvari{1}.
				...
				\begin{mysubsubsection}[sss-exp4-AmeliorationDesPerformances-AnalyseEtDiscussion]{Analyse et discussion}
					...
					Pourtant, si on effectue une observation détaillée en fonction des tâches proposées, on constate que sur le complexe de molécules \myNusENusG, les outils d'assistance permettent d'améliorer significativement les performances.
					En ce qui concerne le scénario~\myscenario{1} (molécule \myUbiquitin), aucune évolution n'est observée.
					Le complexe de molécules \myNusENusG (scénario~\myscenario{2}) reste clairement la tâche la plus complexe à réaliser de part le nombre de \myglos*{glo-Residu} à déformer et part la taille globale des deux molécules en présence.
					D'ailleurs, les annotations vidéos ont permis de constater à plusieurs reprises une sorte d'abandon face à la complexité de la tâche.
					Cependant, il semble que la présence d'outils d'assistance à la communication a permis d'améliorer significativement les performances globales.
				\end{mysubsubsection}
			\end{mysubsection}
			\begin{mysubsection}[sse-exp4-AmeliorationDeLaCommunication]{Amélioration de la communication}
				\begin{mysubsubsection}[sss-exp4-AmeliorationDeLaCommunication-DonneesEtTestsStatistiques]{Données et tests statistiques}
					...
					\begin{myfigure}
						...
						\end{myps}
						\mycaption[fig-exp4-NombreDeSelectionAuCoursDuProcessusDeDesignationAvecEtSansHaptique]{Nombre de sélection au cours du processus de désignation avec et sans haptique}
					\end{myfigure}

					La \myref{fig-exp4-NombreDeSelectionAuCoursDuProcessusDeDesignationAvecEtSansHaptique} présente le nombre de sélections au cours du processus de désignation avec et sans haptique \myvari{1}.
