			...
			\begin{mysection}[sec-Shaddock-ArchitectureMaterielleEtLogicielle]{Architecture matérielle et logicielle}
				...
				\begin{mysubsection}[sse-Shaddock-UneArchitectureClientServeur]{Une architecture client/serveur}
					...
					\begin{mysubsubsection}[sss-interaction-VRPN]{\myacronl+{acr-VRPN}}
						Afin de gérer ces connexions client/serveur, nous allons utiliser le logiciel \myacro{acr-VRPN} développé par \mycite[author]{Taylor-II-2001}.
						...
						L'interface haptique est connectée physiquement à un ordinateur et un serveur \myacro{acr-VRPN} communique avec cette interface.
						C'est seulement par l'intermédiaire de ce serveur \myacro{acr-VRPN} et à travers le réseau \myemph{Ethernet} que le client (\myacro{acr-VMD} dans notre cas) va envoyer et recevoir les informations à l'interface haptique.
						...
						On pourra noter que la chaleur dégagée par l'ensemble de ces machines additionnée à celle du vidéoprojecteur provoque des conditions d'expérimentation rapidement désagréables.
