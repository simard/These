		...
		\begin{mychapter}[cha-DeformationCollaborativeDeMolecule]{Déformation collaborative de molécule}
			...
			\begin{mysection}[sec-exp2-Resultats]{Résultats}
				...
				\begin{mysubsection}[sse-exp2-AmeliorationDeLApprentissagePourLesBinomes]{Amélioration de l'apprentissage pour les \myglosnl*{glo-Binome}}
					...
					On montre un effet significatif de l'ordre de l'essai \myvari{3} sur le temps de réalisation \myvard{1} (\myanova{exp2-time-try-anova.tex}).
					...
					Cependant, on montre un effet significatif du nombre de sujets \myvari{1} sur le nombre de sélections \myvard{2} pour le le second essai (\myanova{exp2-numsel-try-group-anova-try2.tex}).
					...
					\begin{myfigure}
						...
						\begin{mysubfigure}[\textwidth]
							\begin{myps}(-0.5,-0.9)(3,3)
								...
								\myboxplot{exp2-passive-try-group.csv}
								\mylegend{\myleg{\myglosnl{glo-Monome}}{myblue}\myand\myleg{\myglosnl{glo-Binome}}{myblue!70}}
							\end{myps}
							\mysubcaption[fig-exp2-DistancePassiveEtActiveEntreLesEffecteursTerminauxSurChaqueEssaiEnFonctionDuNombreDeSujets-DistancePassive]{Distance passive}
						\end{mysubfigure}
						\begin{mysubfigure}[\textwidth]
							\begin{myps}(-0.5,-0.9)(3,3)
								\myaxes(0,3){essai}(0,2.5)[0.5]{distance~(mm)}
								...
								\mylegend{\myleg{\myglosnl{glo-Monome}}{myblue}\myand\myleg{\myglosnl{glo-Binome}}{myblue!70}}
							\end{myps}
							\mysubcaption[fig-exp2-DistancePassiveEtActiveEntreLesEffecteursTerminauxSurChaqueEssaiEnFonctionDuNombreDeSujets-DistanceActive]{Distance active}
						\end{mysubfigure}
						\mycaption[fig-exp2-DistancePassiveEtActiveEntreLesEffecteursTerminauxSurChaqueEssaiEnFonctionDuNombreDeSujets]{Distance passive et active entre les \myglosnl*{glo-EffecteurTerminal} sur chaque essai en fonction du nombre de sujets}
					\end{myfigure}

					La \myref{fig-exp2-DistancePassiveEtActiveEntreLesEffecteursTerminauxSurChaqueEssaiEnFonctionDuNombreDeSujets} présente les distances passives \myvard{3} et actives \myvard{4} des différents essais \myvari{3} en fonction du nombre de sujets \myvari{1} ayant réalisé l'expérience.
					L'analyse montre un effet significatif du nombre de sujets \myvari{1} sur la distance passive \myvard{3} pour le premier essai (\myanova{exp2-passive-try-group-anova-try1.tex}) mais pas pour le second essai (\myanova{exp2-passive-try-group-anova-try2.tex}) ni le troisième essai (\myanova{exp2-passive-try-group-anova-try3.tex}).
					En ce qui concerne la distance active, 
