...
vmd> set mysel [atomselect "top" "name C or name O or name N or name CA"]
	...
	\begin{mychapter+}{Conclusion et perspectives}
		...
		Nous avons également pu constater que les effets de la \myglos{glo-FacilitationSociale} semblent particulièrement présents dans ce type de configuration synchrone et colocalisée.
