	...
	\begin{mychapter}[cha-sota-EtudeBibliographique]{Étude bibliographique}
		...
		\begin{mysection}[sec-sota-LeTravailCollaboratif]{Le travail collaboratif}
			...
			\begin{mysubsection}[sse-sota-LaParesseSociale]{La paresse sociale}
				...
				On trouve également les récents travaux de \mycite[author]{Buisine-2011} qui montre que l'occupation spatiale de l'environnement est importante : un accès limité à l'espace de travail mène à de la \myglos{glo-ParesseSociale}.
