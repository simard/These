		...
		\begin{mychapter}[cha-LesDynamiquesDeGroupe]{Les dynamiques de groupe}
			...
			\begin{mysection}[sec-exp3-Resultats]{Résultats}
				\begin{mysubsection}[sse-exp3-EvolutionDesPerformances]{Évolution des performances}
					...
					L'analyse montre qu'il n'y a pas d'effet significatif du nombre de sujets \myvari{1} sur la molécule \myPrion (\myanova{exp3-time-molecule-group-anova-prion-group.tex}).
					De la même façon, l'analyse montre qu'il n'y a pas d'effet significatif du nombre de sujets \myvari{1} sur la molécule \myUbiquitin (\myanova{exp3-time-molecule-group-anova-ubiquitin-group.tex}).
					...
					L'analyse montre qu'il n'y a pas d'effet significatif du nombre de sujets \myvari{1} sur la molécule \myPrion (\myanova{exp3-freqsel-molecule-group-anova-prion-group.tex}).
					De la même façon, l'analyse montre qu'il n'y a pas d'effet significatif du nombre de sujets \myvari{1} sur la molécule \myUbiquitin (\myanova{exp3-freqsel-molecule-group-anova-ubiquitin-group.tex}).
					...
					L'analyse montre un effet significatif du nombre de sujets \myvari{1} sur la molécule \myPrion (\myanova{exp3-speed-molecule-group-anova-prion-group.tex}).
					De la même façon, l'analyse montre un effet significatif du nombre de sujets \myvari{1} sur la molécule \myUbiquitin (\myanova{exp3-speed-molecule-group-anova-ubiquitin-group.tex}).
					...
					L'analyse montre un effet significatif du nombre de sujets \myvari{1} sur la molécule \myPrion (\myanova{exp3-talk-molecule-group-anova-prion-group.tex}).
					De la même façon, l'analyse montre un effet significatif du nombre de sujets \myvari{1} sur la molécule \myUbiquitin (\myanova{exp3-talk-molecule-group-anova-ubiquitin-group.tex}).
