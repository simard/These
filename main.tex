		...
		\begin{mychapter}[cha-LesDynamiquesDeGroupe]{Les dynamiques de groupe}
			...
			\begin{mysection}[sec-exp3-Presentation]{Présentation}
				\begin{mysubsection}[sse-exp3-Objectifs]{Objectifs}
					...
					Elle conclue sur les nombreux avantages du travail de groupe en terme de productivité ainsi que de \myglos{glo-MotivationSociale}.
					...
					Cette structure est constituée d'un \myglos{glo-Meneur} puis de \myglos*{glo-Suiveur}.
					...
					C'est également durant cette période que les \myglos*{glo-Meneur} et les \myglos*{glo-Suiveur} se manifesteront.
				\end{mysubsection}
			...
			\begin{mysection}[sec-exp3-Resultats]{Résultats}
				\begin{mysubsection}[sse-exp3-EvolutionDesPerformances]{Évolution des performances}
					...
					Les \myglos*{glo-Quadrinome} ont potentiellement plus de \myglos*{glo-ConflitDeCoordination} que les \myglos*{glo-Binome}.
					...
					Cependant, la \myglos{glo-MotivationSociale} permet aux sujets en \myglos*{glo-Quadrinome} de manipuler plus rapidement ce qui compense cette bausse de performances.
					...
					Cependant, la communication au sein d'un \myglos*{glo-Quadrinome} est plus complexe étant donné les rôles de \myglos{glo-Meneur} et de \myglos{glo-Suiveur} qui se forme au sein d'une \myglos{glo-StructureInformelle}.
					...
					Afin d'améliorer les performances d'un \myglos{glo-Quadrinome}, il faudrait faciliter les résolutions de \myglos*{glo-ConflitDeCoordination}.
				\end{mysubsection}
				\begin{mysubsection}[sse-exp3-AvantageDuRemueMeningesPourLesQuadrinomes]{Avantage du remue-méninges pour les \myglosnl*{glo-Quadrinome}}
					...
					D'ailleurs, cette définition des rôles devrait permettre d'éviter la \myglos{glo-ParesseSociale} mis en évidence par \mycite[author]{Ringelmann-1913} puis expliqué et confirmé par \mycite[author]{Latane-1979}.

					Le phénomène de la \myglos{glo-ParesseSociale} indique que lors de la réalisation d'une tâche collaborative, les sujets vont avoir tendance à laisser la réalisation de la tâche aux autres sujets.
					...
					Nous avons vu dans la \myref{sse-exp3-EvolutionDesPerformances} que les \myglos*{glo-Quadrinome} éprouvaient des difficultés dans la résolution des \myglos*{glo-ConflitDeCoordination}.
					Le remue-méninges permet l'élaboration d'une stratégie et la définition des rôles de chacun des sujets.
					Cela permet de réduire de façon importante le nombre de \myglos*{glo-ConflitDeCoordination} durant la réalisation de la tâche et ainsi améliorer les performances.
					...
					Cependant, la période de remue-méninges permet également de faire émerger rapidement les rôles de \myglos{glo-Meneur} et \myglos{glo-Suiveur}.
					C'est le \myglos{glo-Meneur} qui va répartir les différents rôles dans la réalisation de la tâche.
					La section suivante décrira le rôle de \myglos{glo-Meneur}.
				\end{mysubsection}
				\begin{mysubsection}[sse-exp3-DefinitionDUnMeneur]{Définition d'un \myglosnl{glo-Meneur}}
					...
					Cependant, étant donné le peu de données d'un seul groupe, aucun support statistique ne sera présenté.
					...
					On observe que le sujet \mysubject{1} donne beaucoup plus d'ordres que la moyenne (augmentation de \myanalysis{exp3-g1-talk-subject-analysis.tex}).
					...
					On observe que le sujet \mysubject{1} donne beaucoup plus d'ordres que la moyenne (augmentation de \myanalysis{exp3-g1-speed-subject-analysis.tex}).
					...
					On constate un profil très chaotique pour le sujet \mysubject{1} avec un grand nombre de sélections.
					Par opposition, le profil du sujet \mysubject{2} est très peu chaotique avec un petit nombre de sélections.
					De plus, les efforts maximaux produits par le sujet \mysubject{2} sont plus importants que ceux du \mysubject{1}.
					...
					Le \myglos{glo-Meneur} est donc choisi et accepté par les autres sujets.
					Ceci permet une meilleure collaboration des sujets avec une vraie \myglos{glo-MotivationSociale}.
					...
					La déformation demandant de la précision dans le mouvement, la vitesse de l'\myglos{glo-EffecteurTerminal} est alors moins élevée.
					Cependant, étant donné que toute l'attention est portée sur la déformation, l'effort déployé par les \myglos*{glo-Suiveur} pour déformer est plus important.
					Le \myglos{glo-Meneur} cherchant des tâches à effectuer mais n'effectuant pas totalement les déformation, il ne déploit pas autant d'effort.
					...
					Cependant, le \myglos{glo-Meneur} doit pouvoir se faire accepter des autres membres du groupes et ainsi garder une bonne cohésion.
				\end{mysubsection}
			\end{mysection}
			\begin{mysection}[sec-exp3-Synthese]{Synthèse}
				\begin{mysubsection}[sse-exp3-ResumeDesResultats]{Résumé des résultats}
					Cette troisième expérimentation a mis en opposition des \myglos*{glo-Binome} avec des \myglos*{glo-Quadrinome}.
					...
					Les \myglos*{glo-ConflitDeCoordination} étant plus nombreux dans un \myglos{glo-Quadrinome}, les utilisateurs utilisent plus de temps pour la résolution de ces conflits.
					...
					Ce remue-méninges permet une organisation préalable du groupe afin de produire de meilleures performances en limitant les \myglos*{glo-ConflitDeCoordination}.
					Pourtant, ce sont surtout les performances des \myglos*{glo-Quadrinome} qui sont augmentées.
					En effet, les \myglos*{glo-Quadrinome} perdent plus de temps que les \myglos*{glo-Binome} dans la résolution des conflits.

					De plus, ce remue-méninges permet de faire émerger des rôles plus rapidement au sein de cette \myglos{glo-StructureInformelle}.
					...
					Les \myglos*{glo-Suiveur} effectuent plutôt des déformations longues et gérent des déformations locales.
				...
				\begin{mysubsection}[sse-exp3-Perspectives]{Perspectives}
					...
					Des outils haptiques adaptés aux besoins de chacun seront alors proposés afin d'améliorer les possibilités de chacun.
					En l'occurence, le \myglos{glo-Meneur} n'effectue pas réellement de déformation, il semble donc peu nécessaire de lui donner cette possibilité.
					...
					Il faut donc lui laisser la possibilité d'effectuer des déformations locales précises.
					Cependant, il faut également lui faciliter la communication avec le \myglos{glo-Meneur} et lui rendant rapidement accessible les consignes.
					Le \myglos{glo-Meneur} ayant une vision plus globale de la tâche à réaliser, il peut être justifié de donner des outils de déformation plus grossière ponctuellement.

					La majorité de ces outils seront implémentés dans la dernière version de la plate-forme afin d'effectuer une expérimentation sur des experts de la déformation moléculaire.
