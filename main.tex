	...
	\begin{mychapter}[cha-LesDynamiquesDeGroupe]{Les dynamiques de groupe}
		...
		\begin{mysection}[sec-exp3-PresentationDeLExperimentation]{Présentation de l'expérimentation}
			...
			\begin{mysubsection}[sse-exp3-SpecificitesDuProtocoleExperimental]{Spécificités du protocole expérimental}
				...
				Le protocole expérimental est détaillé dans la \myref{sec-met-exp3-PremiereExperimentation} et résumé dans la \myref{tab-exp3-SyntheseDeLaProcedureExperimentale}\footnote{Pour la suite des développements, le mot \mybrainstorming sera utilisé à la place de \myemph{remue-méninges} car il évoque plus de notions en rapport avec notre sujet.}.
