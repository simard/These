	...
	\begin{mypart}[prt-Introduction]{Introduction}
		...
		\begin{mychapter}[cha-ShaddockSystemeCollaboratifPourLaManipulationDeMolecules]{\myShaddock\ -- Système collaboratif de manipulation de molécules}
			\begin{mysection}[sec-PlateFormesCollaborativesExistantes]{Plates-formes collaboratives existantes}
				...
				Une vue schématique de la plate-forme \myShaddock est détaillée sur la \myref{fig-DiagrammeUMLDeDeploiementDeLaPlateFormeShaddock}.
				L'application \myacro{acr-VMD} est développée sur la \myref{fig-DiagrammeUMLDeComposantDuNoeudVMD}.
				...
				\begin{myfigure}
					\psset{xunit=0.068965517\textwidth,yunit=0.041304348\textheight}
					\psset{framearc=.1,shadow=true,blur=true}
					\begin{myps}(-8,-11)(6.5,12)
						\psset{xunit=0.041304348\textheight,yunit=0.068965517\textwidth}
						\rotateleft{%
							\rput(0,0){%
								\myumlnode*<PCUtilisateur>[Linux et CUDA]{Client : PC utilisateur}{%
									\myumlcomponent<VMD>[application]{VMD}%
								}%
							}
							\rput(-8,0){%
								\myumlnode*<ServeurNAMD>[Linux et CUDA]{Serveur : Serveur NAMD}{%
									\begin{psmatrix}[rowsep=1]%
										\myumlcomponent<NAMD>[executable]{\texttt{namd2}} \\%
								...
								\rput(8,4){%
									\myumlnode*<ServeurVRPN1>[Linux, Mac OS ou Windows]{Serveur~1 : Serveur VRPN}{%
										\myumlcomponent<VRPN1>[executable]{\texttt{vrpnserver}}%
									}%
								}
								\rput(8,1){%
									\myumlnode<PHANToM1>[PHANToM Omni]{Interface~1 : Interface haptique}%
								}
								\rput(8,-0.5){\Huge$\vdots$}
								\rput(8,-3){%
									\myumlnode*<ServeurVRPNn>[Linux, Mac OS ou Windows]{Serveur~$n$ : Serveur VRPN}{%
										\myumlcomponent<VRPNn>[executable]{\texttt{vrpnserver}}%
									}%
								}
								\rput(8,-6){%
									\myumlnode<PHANToMn>[PHANToM Omni]{Interface~$n$ : Interface haptique}%
								}
								\rput(0,-5){%
									\myumlnode<VideoProjecteur>{Affichage : Vidéoprojecteur}
								}
								\psset{shadow=false}
								...
								\ncput*[framesep=1pt,nrot=:D,npos=0.333333]{\textcolor{black!30}{\scriptsize VGA}}
								\myumlinterface[angleA=0,angleB=180,offsetB=-8pt,ArrowInsidePos=0.333333]{NAMD}{VMD}[nccurve]
								\naput[npos=0.333333]{\tiny\begin{psmatrix}[rowsep=0]Transmission\\ des données\\ de simulation\end{psmatrix}}
								\ncput*[framesep=1pt,nrot=:U,npos=0.6]{\textcolor{black!30}{\scriptsize TCP/IP}}
								\myumlinterface[angleA=180,angleB=0,ncurvA=1,offsetA=8pt,ArrowInsidePos=0.4]{VRPN1}{VMD}[nccurve]
								\nbput[npos=0.4]{\tiny\begin{psmatrix}[rowsep=0]Transmission\\ des données\\ d'interaction\end{psmatrix}}
								\ncput*[framesep=1pt,nrot=:D,npos=0.666667]{\textcolor{black!30}{\scriptsize TCP/IP}}
								\myumlinterface[angleA=180,angleB=0,ncurvA=1,offsetA=8pt,ArrowInsidePos=0.4]{VRPNn}{VMD}[nccurve]
								\naput[npos=0.4]{\tiny\begin{psmatrix}[rowsep=0]Transmission\\ des données\\ d'interaction\end{psmatrix}}
								\ncput*[framesep=1pt,nrot=:D,npos=0.666667]{\textcolor{black!30}{\scriptsize TCP/IP}}
							}
						\end{myps}
						\mycaption[fig-DiagrammeUMLDeDeploiementDeLaPlateFormeShaddock]{Diagramme \myacronl{acr-UML} de déploiement de la plate-forme \myShaddock}
					\end{myfigure}
					\begin{myfigure}
						\psset{unit=0.05\textwidth}
						\begin{myps}(-10,-5)(10,4)
							\rput(0,0){%
								\myumlcomponent*[framesep=10pt,framearc=0,shadow=false]<VMD>[application]{VMD}{%
									\psset{framesep=5pt,framearc=.1,shadow=true,blur=true}%
									\psframebox[linestyle=none,fillstyle=none,shadow=false]{%
										\begin{psmatrix}[rowsep=1]%
											\myumlcomponent<IMD>[extension]{IMD}%
											\hspace{5em}%
											\myumlcomponent<VRPNclient>[fonction]{Client VRPN} \\%
						...
						\end{myps}
						\mycaption[fig-DiagrammeUMLDeComposantDuNoeudVMD]{Diagramme \myacronl{acr-UML} de composant du nœud \myacronl{acr-VMD}}
					\end{myfigure}
