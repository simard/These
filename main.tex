				...
				\begin{mysubsection}[sse-exp3-DefinitionDUnLeader]{Définition d'un leader}
					...
					\begin{myfigure}
						...
						\begin{mysubfigure}[\textwidth]
							...
							\end{myps}
							\mysubcaption[fig-exp3-ProfilDeForceSurG1-ProfilDeForceDeS1]{Profil de force de \mysubject{1}}
						\end{mysubfigure}
						\begin{mysubfigure}[\textwidth]
							\begin{myps}(-12.5,-1.15)(130,5.25)
								\myaxes[labels=all,ticks=all,Dx=25](0,125){temps~{(s)}}(0,5)[1]{force~(N)}
							...
							\end{myps}
							\mysubcaption[fig-exp3-ProfilDeForceSurG1-ProfilDeForceDeS2]{Profil de force de \mysubject{2}}
						\end{mysubfigure}
					...
					On constate un profil très chaotique pour le sujet \mysubject{1}.
					Par opposition, le profil du sujet \mysubject{2} est très peu chaotique.
