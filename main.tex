			...
			\begin{mysection}[sec-exp1-Resultats]{Résultats}
				...
				\begin{mysubsection}[sse-exp1-StrategiesDeTravail]{Stratégies de travail}
					...
					\begin{mysubsubsection}[sss-exp1-ChampProche]{Champ proche}
						...
						\mynum{8}~\myglos*{glo-Binome} sur \mynum{12} sont concernés par cette catégorie.
						Cela signifie que ce sont des \myglos*{glo-Binome} qui travaillent en collaboration étroite.

						Sur la \myfigureref{fig-exp1-AffiniteEntreLesSujetsPourChaqueBinome}, tous les \myglos*{glo-Binome} manipulant en collaboration étroite ont de fortes affinités ($\mu = 4$).
						Le groupe comprend des collègues proches et des amis.
						...
						Cependant, les différences importantes dans les forces appliquées \myfigureref*{fig-exp1-ForceMoyenneEtDifferenceDeForceEntreLesSujetsPourChaqueBinome} ou l'analyse des communications verbales montre des conflits importants au sein des \myglos*{glo-Binome}.
