			...
			\begin{mysubsection}[sse-sota-LeDockingMoleculaireEnEnvironnementVirtuel]{Le \myglosnl{glo-DockingMoleculaire} en environnement virtuel}
				...
				\begin{myfigure}
					...
					\begin{myps}(-0.5,-1)(5,2.25)
						...
						\makeatother
						\psplot[linewidth=1.5pt,linecolor=myred,plotpoints=1000]{1.412304381}{5}{4 \myEzero \mysigma x div \mysigma x div mul \mysigma x div mul \mysigma x div mul \mysigma x div mul \mysigma x div mul \mysigma x div mul \mysigma x div mul \mysigma x div mul \mysigma x div mul \mysigma x div mul \mysigma x div mul \mysigma x div \mysigma x div mul \mysigma x div mul \mysigma x div mul \mysigma x div mul \mysigma x div mul sub mul mul}
