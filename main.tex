	...
	\begin{mychapter}[cha-sota-EtudeBibliographique]{Étude bibliographique}
		...
		\begin{mysection}[sec-sota-ContexteDeTravail-LaModelisationMoleculaire]{Contexte de travail : la modélisation moléculaire}
			...
			\begin{mysubsection}[sse-sota-LeDockingMoleculaireEnEnvironnementVirtuel]{Le \myglosnl{glo-DockingMoleculaire} en environnement virtuel}
				...
				Afin de manipuler plus intuitivement les molécules, \mycite[author]{Weghorst-2003} introduit une interface tangible.
		...
		\begin{mysection}[sec-sota-LeTravailCollaboratif]{Le travail collaboratif}
			...
			Nous allons découvrir dans cette section qu'un certain nombre de chercheurs en psychologie sociale se sont intéressés à la distribution cognitive des charges de travail pour répondre à ce problème.
			\begin{mysubsection}[sse-sota-LaDistributionCognitiveDesChargesDeTravail]{La distribution cognitive des charges de travail}
				...
				Le concept d'affordance a été identifié par \mycite{Gibson-1977}.
				...
				Nous allons voir dans les sections suivantes que différent phénomènes influent sur les performances d'un groupe.
			\end{mysubsection}
			\begin{mysubsection}[sse-sota-LaFacilitationSociale]{La facilitation sociale}
				...
				Il s'est intéressé aux résultats de coureurs cyclistes ayant coucouru dans trois différentes conditions :
				\begin{enumerate}
					\item Course seul;
				...
				\mycite[author]{Mayer-1903} confirme l'amélioration des performances en plaçant des spectateurs pour toute la durée de la réalisation de la tâche (rédaction de dictée ou résolution de problème arithmétiques).
				...
				Le terme \myglos{glo-FacilitationSociale} est utilisé pour la première fois par \mycite[author]{Allport-1924} \mycite{Strauss-2002}.
				...
				Dans ce même contexte, \mycite[author]{Roethlisberger-1939}, qui a étudié les travaux de Elton \myname{Mayo} au sein de l'entreprise \myHawthorne, constate également que les travail en groupe génére une stimulation qui augmente les performances du groupe : les performances du groupe sont meilleures que la somme des performances de chacun des membres individuellement.
				La \myglos{glo-FacilitationSociale} a même été observée sur les animaux comme les cafards \mycite{Zajonc-1969} ou les singes \mycite{Dindo-2009}.
				...
				En effet, la présence de partenaires dans la réalisation d'une tâche permet de stimuler.
			...
			\begin{mysubsection}[sse-sota-LaParesseSociale]{La paresse sociale}
				\mycite[author]{Ringelmann-1913} est le premier à constater le phénomène de \myglos{glo-ParesseSociale}\footnote{Ce phénomène de \myglos{glo-ParesseSociale} est d'ailleurs parfois nommé \og effet de \mycite[author]{Ringelmann-1913} \fg.} dans un rapport technique qui sera signalé quelques années plus tard par \mycite[author]{Moede-1927}.
				Il propose une expérience de traction de corde et observe la traction totale exercée par le groupe en faisant varier la taille des groupes.
				...
				C'est \mycite[author]{Kravitz-1986} qui reprendront les résultats de \mycite[author]{Ringelmann-1913} pour les discuter dans une publication scientifique.
				...
				Entre temps, \mycite[author]{Latane-1979} ont recréé l'expérience proposée par \mycite[author]{Ringelmann-1913} en modifiant le protocole expérimental afin de limiter les erreurs de coordination.
				...
				\mycite[author]{Ingham-1974} puis \mycite[author]{Karau-1993} montrent que l'ajout du premier et du deuxième collaborateur est particulièrement peu bénéfique pour les performances du groupe mais que l'ajout supplémentaire de collaborateur provoque une baisse plus modérée.
				...
				\begin{myfigure}
					...
					\begin{myps}(-0.75,-25)(7.25,110)
						\pspolygon*[linecolor=myblue!25](1,0)(1,100)(2,50)(6,25)(6,0)
						\pspolygon*[linecolor=mygreen!25](1,100)(2,50)(6,25)(6,62.5)(2,75)
						\pspolygon*[linecolor=myred!25](1,100)(2,75)(6,62.5)(6,100)
						\pspolygon[linewidth=0pt,linestyle=none,fillstyle=gradient,gradbegin=white,gradend=myblue!25,gradangle=-90,gradmidpoint=1](6,0)(6,25)(6.2,23.75)(6.2,0)
						\pspolygon[linewidth=0pt,linestyle=none,fillstyle=gradient,gradbegin=white,gradend=mygreen!25,gradangle=-90,gradmidpoint=1](6,25)(6,62.5)(6.2,61.875)(6.2,23.75)
						\pspolygon[linewidth=0pt,linestyle=none,fillstyle=gradient,gradbegin=white,gradend=myred!25,gradangle=-90,gradmidpoint=1](6,62.5)(6,100)(6.2,100)(6.2,61.875)
						\psline(1,100)(2,50)(6,25)
						\psdots(1,100)(2,50)(6,25)
						\psline(1,100)(2,75)(6,62.5)
						\psdots(1,100)(2,75)(6,62.5)
						\psline(1,100)(2,100)(6,100)
						\psdots(1,100)(2,100)(6,100)
						...
						\myframebox{25}{0}{Réponse obtenue}
						\myframebox{62.5}{0}{Problème de coordination}
						...
						\psbrace[ref=lC](6.2,61.875)(6.2,100){\footnotesize\parbox{1.25cm}{\myglosnl{glo-ParesseSociale}}}
					\end{myps}
				...
				L'identification est censé éviter l'anonymat relatif qui peut se mettre en place selon \mycite[author]{Kerr-1981}.
				\mycite[author]{Latane-1979} en avaient déjà eu l'intuition puisqu'ils proposent une telle solution dans leurs perspectives.
				\mycite[author]{Karau-1993} repris par \mycite[author]{Kraut-2003} mettent en avant cette idée d'identification basée sur des expérimentations.
			...
			\end{mysubsection}
		\end{mysection}
		\begin{mysection}[sec-sota-EtatDeLArt]{État de l'art}
		...
		\end{mysection}
		\begin{mysection}[sec-sota-Contexte]{Contexte}
			\begin{mysubsection}[sse-sota-LeDockingMoleculaire]{Le \myglosnl{glo-DockingMoleculaire}}
