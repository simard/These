	...
	\begin{mychapter}[cha-Shaddock-ManipulationCollaborativeDeMolecules]{\myShaddock\ -- Manipulation collaborative de molécules}
		...
		\begin{mysection}[sec-Shaddock-LesOutilsDInteraction]{Les outils d'interaction}
			\begin{mysubsection}[sse-Shaddock-LesOutilsExistants]{Les outils existants}
				...
				Les outils proposés par défaut dans \myacro{acr-VMD} ont été utilisés dans la première expérimentation \myref*{cha-RechercheCollaborativeDeResidusDansUneMolecule}.
		...
		\end{mysection}
	\end{mychapter}
	\begin{mychapter}[cha-RechercheCollaborativeDeResidusDansUneMolecule]{Recherche collaborative de résidus dans une molécule}
		\begin{mysection}[sec-exp1-Introduction]{Introduction}
			...
			Le prétexte à cette étude sera une expérimentation sur la recherche de \myglos*{glo-Residu} présentée dans la \myref{sec-exp1-ExperimentationDeRechercheDeResiduEnSimulationMoleculaire}.
...
vmd> set mysel [atomselect "top" "name C or name O or name N or name CA"]
	...
	\begin{mychapter}[cha-DeformationCollaborativeDeMolecule]{Déformation collaborative de molécule}
		...
		\begin{mysection}[sec-exp2-Contexte]{Contexte}
			...
			La précédente expérimentation \myref*{cha-RechercheCollaborativeDeResidusDansUneMolecule} a souligné l'avantage de la collaboration sur des tâches nécessitant un couplage fort.
		...
		\begin{mysection}[sec-exp3-Resultats]{Résultats}
			\begin{mysubsection}[sse-exp3-EvolutionDesPerformances]{Évolution des performances}
				...
				\begin{mysubsubsection}[sss-exp3-EvolutionDesPerformances-AnalyseEtDiscussion]{Analyse et discussion}
					...
					L'étude précédente présentée dans le \myref{cha-RechercheCollaborativeDeResidusDansUneMolecule} a montré que le travail en configuration \myglos*{glo-Bimanuel} permet de moins bonnes performances qu'un travail collaboratif en configuration \myglos*{glo-Monomanuel}.
