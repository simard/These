...
vmd> set mysel [atomselect "top" "name C or name O or name N or name CA"]
	...
	\begin{mychapter}[cha-LesDynamiquesDeGroupe]{Les dynamiques de groupe}
		\begin{mysection}[sec-exp3-Introduction]{Introduction}
			Les différentes \myacro*{acr-PCV} ont à présent été étudiées dans les précédents chapitres.
			Cependant, l'étude du travail collaboratif ne peut être restreinte à l'étude des \myglos*{glo-Binome}.
			En effet, \mycite[author]{Roethlisberger-1939} sont dans les premiers à mettre en évidence les dynamiques de groupe basés sur les travaux de Elton \myname{Mayo}.
			La dynamique de groupe possède un fonctionnement plus complexe qu'un simple \myglos{glo-Binome}.
			Cependant, ces études consistent à étudier le travail coopératif et pas le travail collaboratif : les sujets se divisent préalablement la tâche en plusieurs sous-tâches.
			Plus récemment, \myInternet a donné naissance à de nombreux outils de collaboration dont les \myWiki* \mycite{Leuf-2001,Wagner-2004} avec le succès de \myWikipedia que l'on connaît.
			On peut également citer les incontournables outils de gestions de versions tels que \myGit \mycite{Git-2011}, \myMercurial \mycite{Mercurial-2011} ou \mySVN \mycite{SVN-2011} qui permettent la collaboration de plusieurs développeur pour la création ou la modification de programmes informatiques.
			Cependant, ces deux exemples permettent seulement une collaboration asynchrone où chaque acteur intervient derrière son prédécesseur pour ajouter, améliorer ou corriger une partie du travail.
			...
			Ce chapitre constitue notre première étude sur le travail collaboratif concernant les groupes d'utilisateurs\footnote{On considère qu'un groupe est constitué au minimum de trois personnes \mycite{Roethlisberger-1939}.}.
			Au regard des travaux existants, une dynamique de groupe va émerger.
			Cependant, nous souhaitons étudier cette dynamique de groupe au sein d'une tâche colocalisée synchrone.
			Parmi les deux études précédentes, les scénarios de déformation nous ont fournis les tâches les plus complexes et les plus étroitement couplées.
			Nous nous placerons donc à nouveau dans un contexte de déformation moléculaire.
			Nous souhaitons tester la mise en place de périodes de \mybrainstorming\footnote{Pour la suite des développements, le mot \mybrainstorming sera utilisé plutôt que le mot-valise \myemph{remue-méninges} car il évoque plus de notions en rapport avec notre sujet.} afin de catalyser le potentiel du groupe.
		...
		\begin{mysection}[sec-exp3-PresentationDeLExperimentation]{Présentation de l'expérimentation}
			...
			\begin{mysubsection}[sse-exp3-SpecificitesDuProtocoleExperimental]{Spécificités du protocole expérimental}
				...
				\begin{mysubsubsection}[sss-exp3-Materiel]{Matériel}
					...
					Deux outils de déformation supplémentaires sont ajoutés à la plate-forme \myref*{sec-pro-MaterielExperimental}.
				...
				\begin{mytable}
					...
					\begin{mytabular}{>{\bfseries}p{\expthreefirstcolumn}p{\expthreesecondcolumn}}
						...
						\mytitlecolumn{2}{Hypothèses}             & \myhypothesis{1} Amélioration des performances en \myglosnl{glo-Quadrinome} \\
						                                          & \myhypothesis{2} Le \mybrainstorming structure le \myglosnl{glo-Quadrinome} \\
						\mymiddlerule
						\mytitlecolumn{3}{Variable indépendantes} & \myvari{1} Nombre de sujets                                                 \\
						                                          & \myvari{2} Complexité de la tâche                                           \\
		...
		\begin{mysection}[sec-exp3-Resultats]{Résultats}
			\begin{mysubsection}[sse-exp3-EvolutionDesPerformances]{Évolution des performances}
				...
				\end{mysubsubsection}
			\end{mysubsection}
			\begin{mysubsection}[sse-exp3-AvantageDuBrainstormingPourLesQuadrinomes]{Avantage du \mybrainstorming pour les \myglosnl*{glo-Quadrinome}}
				\begin{mysubsubsection}[sss-exp3-AvantageDuBrainstormingPourLesQuadrinomes-DonneesEtTestsStatistiques]{Données et tests statistiques}
					\begin{myfigure}
						\psset{xunit=0.274914089\textwidth,yunit=0.005cm}
						\begin{myps}(-0.425,-220)(2,640)
				...
				\end{mysubsubsection}
				\begin{mysubsubsection}[sss-exp3-AvantageDuBrainstormingPourLesQuadrinomes-AnalyseEtDiscussion]{Analyse et discussion}
					La \myref{fig-exp3-NombreDOrdresVerbauxSurLesScenariosEnFonctionDesGroupesAvecOuSansBrainstorming} nous permet de constater une baisse significative du nombre d'échanges verbaux lorsque les sujets dispose d'une période de \mybrainstorming.
					Le \mybrainstorming permet une réflexion préalable sur la tâche afin d'aboutir à une stratégie.
					...
					Cependant, la \myref{fig-exp3-TempsDeRealisationDesScenariosEnFonctionDesGroupesAvecOuSansBrainstorming} et la \myref{fig-exp3-FréquenceDesSelectionsSurLesScenariosEnFonctionDesGroupesAvecOuSansBrainstorming} montrent que seuls les \myglos*{glo-Quadrinome} bénéficient de ce \mybrainstorming.
					En effet, les \myglos*{glo-Binome} n'obtiennent aucune amélioration significative des performances.
					De même, on constate sur la \myref{fig-exp3-VitesseMoyenneSurLesScenariosEnFonctionDesGroupesAvecOuSansBrainstorming} que la vitesse moyenne de l'\myglos{glo-EffecteurTerminal} des \myglos*{glo-Binome} n'évolue pas.
					...
					La présence d'une période de \mybrainstorming n'améliore pas la résolution des \myglos*{glo-ConflitDeCoordination}.
					...
					Dans ce cas, le \mybrainstorming aboutit à une répartition des tâches en deux \myglos*{glo-Binome}.
					...
					En effet, les groupes n'ayant pas de période de \mybrainstorming (\mycondition{1} et \mycondition{3}) tentent tout de même d'élaborer une stratégie pendant la manipulation.
					...
					Cependant, on constate sur la \myref{fig-exp3-VitesseMoyenneSurLesScenariosEnFonctionDesGroupesAvecOuSansBrainstorming} qu'il n'y a pas d'évolution de la vitesse moyenne des \myglos*{glo-EffecteurTerminal} pour les \myglos*{glo-Quadrinome}.
					...
					Le \mybrainstorming ne leur permet d'effectuer les gestes plus rapidement mais ils utilisent maintenant cette vitesse avec des stratégies optimisées.

					Cette section nous a permis de tester et de confirmer l'intérêt d'une période de \mybrainstorming pour structurer les groupes : cette période est bénéfique pour les \myglos*{glo-Quadrinome}.
					Elle permet d'éviter les problèmes de \myglos{glo-ParesseSociale} évoqués par \mycite[author]{Latane-1979}.
					La période de \mybrainstorming permet de faire émerger rapidement les rôles de \myglos{glo-Meneur} et \myglos{glo-Suiveur}.
			...
			\begin{mysubsection}[sse-exp3-DefinitionDUnMeneur]{Définition d'un \myglosnl{glo-Meneur}}
				...
				\begin{mysubsubsection}[sss-exp3-DefinitionDUnMeneur-AnalyseEtDiscussion]{Analyse et discussion}
					...
					L'identification des rôles est nécessaire pour obtenir de bonne performances et éviter le phénomène de \myglos{glo-ParesseSociale} \myref*{sse-exp3-AvantageDuBrainstormingPourLesQuadrinomes}.
		...
		\begin{mysection}[sec-exp3-Synthese]{Synthèse}
			\begin{mysubsection}[sse-exp3-ResumeDesResultats]{Résumé des résultats}
				...
				Cependant, une analyse basée sur la présence ou non d'une période de \mybrainstorming nous a permis d'approfondir cette conclusion.
				Ce \mybrainstorming permet une organisation préalable du groupe afin de produire de meilleures performances en réduisant le nombre de \myglos*{glo-ConflitDeCoordination}.
				...
				Une période de \mybrainstorming préalable à la réalisation de la tâche permet de structurer un groupe.
	...
	\begin{mychapter}[cha-met-MethodeExperimentale]{Méthode expérimentale}
		...
		\begin{mysection}[sec-met-exp3-PremiereExperimentation]{Troisième expérimentation}
			\begin{mysubsection}[sse-met-exp3-Hypotheses]{Hypothèses}
				...
				\end{myparagraph}
				\begin{myparagraph}[par-met-exp3-LeBrainstormingStructureLeQuadrinome]{\myhypothesis{2} Le \mybrainstorming structure le \myglos{glo-Quadrinome}}
