...
\begin{document}
	...
	\begin{mychapter}[cha-DeformationCollaborativeDeMolecule]{Déformation collaborative de molécule}
		...
		\begin{mysection}[sec-exp2-ExperimentationDeDeformationDeMolecule]{Expérimentation de déformation de molécule}
			...
			\begin{mysubsection}[sse-exp2-SpecificitesDuProtocoleExperimental]{Spécificités du protocole expérimental}
				...
				Un résumé de la methode expérimentale se trouve dans la \myref{tab-exp2-SyntheseDeLaProcedureExperimentale} qu'on pourra retrouver de manière détaillée dans la \myref{sec-met-exp2-PremiereExperimentation}.
	...
	\begin{mychapter}[cha-LesDynamiquesDeGroupe]{Les dynamiques de groupe}
		...
		\begin{mysection}[sec-exp3-ExperimentationSurLesDynamiquesDeGroupe]{Expérimentation sur les dynamiques de groupe}
			...
			\begin{mysubsection}[sse-exp3-SpecificitesDuProtocoleExperimental]{Spécificités du protocole expérimental}
				...
				Le protocole expérimental est détaillé dans la \myref{sec-met-exp3-PremiereExperimentation} et résumé dans la \myref{tab-exp3-SyntheseDeLaProcedureExperimentale}.
	...
	\begin{mychapter}[cha-TravailCollaboratifAssisteParHaptique]{Travail collaboratif assisté par haptique}
		...
		\end{mysection}
		\begin{mysection}[sec-exp4-Contexte]{Contexte}
		\end{mysection}
		\begin{mysection}[sec-exp4-ExperimentationAvecAssistanceHaptique]{Expérimentation avec assistance haptique}
			...
			La méthode expérimentale est exposée dans la \myref{sec-met-exp4-PremiereExperimentation}.
	...
	\begin{mychapter}[cha-met-MethodeExperimentale]{Méthode expérimentale}
		\begin{mysection}[sec-met-exp1-PremiereExperimentation]{Première expérimentation}
			...
			\end{mysubsection}
		\end{mysection}
		\begin{mysection}[sec-met-exp2-PremiereExperimentation]{Seconde expérimentation}
			...
			\end{mysubsection}
		\end{mysection}
		\begin{mysection}[sec-met-exp3-PremiereExperimentation]{Troisième expérimentation}
			...
			\end{mysubsection}
		\end{mysection}
		\begin{mysection}[sec-met-exp4-PremiereExperimentation]{Quatrième expérimentation}
			...
			\begin{mysubsection}[sse-met-exp4-Procedure]{Procédure}
				...
				\end{myparagraph}
				\begin{myparagraph}[par-met-exp4-Phase4-Scenario1]{Phase~\mynum{4} : scénario~\myscenario{1}}
				...
				\end{myparagraph}
				\begin{myparagraph}[par-met-exp4-Phase5-OutilDeManipulation]{Phase~\mynum{5} : outil de manipulation}
				...
				\end{myparagraph}
				\begin{myparagraph}[par-met-exp4-phase6-scenario2]{phase~\mynum{6} : scénario~\myscenario{2}}
				...
				\end{myparagraph}
				\begin{myparagraph}[par-met-exp4-phase7-LeQuestionnaire]{phase~\mynum{7} : le questionnaire}
