		...
		\begin{mysection}[sec-pro-DispositifExperimental]{Dispositif expérimental}
			\begin{mysubsection}[sse-pro-PresentationsDesMolecules]{Présentation des molécules}
				\begin{mysubsubsection}[sss-pro-ListeDesMolecules]{Liste des molécules}
					Durant les différentes expérimentations, plusieurs molécules ou complexe de molécules ont été utilisé.
					...
					Chaque molécule est référencée sur la \myPDBbase\footnote{\url{http://www.pdb.org/}} par un identifiant \myPDB.
