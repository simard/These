...
vmd> set mysel [atomselect "top" "name C or name O or name N or name CA"]
	...
	\begin{mychapter}[cha-DeformationCollaborativeDeMolecule]{Déformation collaborative de molécule}
		\begin{mysection}[sec-exp2-Introduction]{Introduction}
			...
			Afin de compléter notre étude du travail collaboratif dans un environnement virtuel complexe, nous souhaitons à présent nous intéresser à la \myacro{acr-PCV} suivante : la \myemph{déformation}.
		...
		\begin{mysection}[sec-exp2-PresentationDeLExperimentation]{Présentation de l'expérimentation}
			\begin{mysubsection}[sse-exp2-DescriptionDeLaTache]{Description de la tâche}
				...
				En effet, la recherche d'un état stable est exactement ce qu'une tâche de \myglos{glo-AmarrageMoleculaire} cherche à réaliser.
				...
				\begin{mysubsubsection}[sss-exp2-DescriptionDesScenarios]{Description des scénarios}
					...
					\begin{myparagraph}[par-exp2-Scenario1a]{Scénario~\myscenario{1a}}
						...
						Un \myglos{glo-Residu} à l'extrémité -- la molécule formant une chaîne -- est fixé afin d'\myemph{ancrer} la molécule dans la scène virtuelle et éviter d'éventuelles dérives hors du champ visuel.
			...
			\begin{mysubsection}[sse-exp2-SpecificitesDuProtocoleExperimental]{Spécificités du protocole expérimental}
				...
				\begin{mysubsubsection}[sss-exp2-Visualisation]{Visualisation}
					...
					Ces molécules ne peuvent pas être représentées avec tous leurs atomes pour deux raisons.
				...
				\begin{mysubsubsection}[sss-exp2-OutilsDeManipulation]{Outils de manipulation}
					...
					En effet, la molécule n'a pas vraiment besoin d'être déplacée à l'écran et c'est surtout la possibilité d'orienter la molécule qui est nécessaire aux sujets.
					Ceci permet également d'éviter des molécules qui sortent de l'espace visuel des sujets (l'écran) à cause d'une mauvaise manipulation.
					De plus, ce choix permet d'enlever une part de la charge cognitive des sujets.
