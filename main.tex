...
\begin{document}
	...
	\begin{mychapter}[cha-LesDynamiquesDeGroupe]{Les dynamiques de groupe}
		\begin{mysection}[sec-exp3-Introduction]{Introduction}
			...
			Les objectifs de cette nouvelle expérimentation sont exposés dans la \myref{sec-exp3-Contexte} accompagnés par les hypothèses.
			La tâche et les modifications apportées à la plate-forme correspondantes sont détaillées dans la \myref{sec-exp3-ExperimentationSurLesDynamiquesDeGroupe}.
		...
		\end{mysection}
		\begin{mysection}[sec-exp3-Contexte]{Contexte}
		...
		\end{mysection}
		\begin{mysection}[sec-exp3-ExperimentationSurLesDynamiquesDeGroupe]{Expérimentation sur les dynamiques de groupe}
			...
			\begin{mysubsection}[sse-exp3-SpecificitesDuProtocoleExperimental]{Spécificités du protocole expérimental}
				...
				Le protocole expérimental est détaillé dans la \myref{sec-pro-exp3-PremiereExperimentation} et résumé dans le \myref{tab-exp3-SyntheseDeLaProcedureExperimentale}.
		...
		\begin{mysection}[sec-exp3-Resultats]{Résultats}
			\begin{mysubsection}[sse-exp3-EvolutionDesPerformances]{Évolution des performances}
				...
				\begin{mysubsubsection}[sss-exp3-EvolutionDesPerformances-AnalyseEtDiscussion]{Analyse et discussion}
					...
					Il faut noter que les molécules n'ont pas été alternées lors de la procédure expérimentale \myref*{sse-met-exp3-Procedure} : c'est toujours la molécule \myPrion qui a été présentée en premier aux sujets.
	...
	\begin{mychapter}[cha-TravailCollaboratifAssisteParHaptique]{Travail collaboratif assisté par haptique}
		...
		\begin{mysection}[sec-exp4-DispositifExperimentalEtMateriel]{Dispositif expérimental et matériel}
			...
			Cette nouvelle étude propose une disposition similaire à la troisième expérimentation \myref*{sse-exp3-SpecificitesDuProtocoleExperimental} avec les matériels suivants :
			\begin{itemize}
	...
	\begin{mychapter}[cha-met-MethodeExperimentale]{Méthode expérimentale}
		...
		\begin{mysection}[sec-pro-exp3-PremiereExperimentation]{Troisième expérimentation}
			\begin{mysubsection}[sse-met-exp3-Hypotheses]{Hypothèses}
				...
				\end{myparagraph}
				\begin{myparagraph}[par-met-exp3-LeRemueMeningesStructureLeQuadrinome]{\myhypothesis{2} Le remue-méninges structure le \myglos{glo-Quadrinome}}
			...
			\begin{mysubsection}[sse-met-exp3-Variables]{Variables}
				\begin{mysubsubsection}[sss-met-exp3-VariablesIndependantes]{Variables indépendantes}
					...
					\end{myparagraph}
					\begin{myparagraph}[par-met-exp3-TempsAllouePourLeRemueMeninges]{\myvari{3} Temps alloué pour le remue-méninges}
