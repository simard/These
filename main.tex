		...
		\begin{mysection}[sec-sota-CollaborationEnEnvironnementVirtuel]{Collaboration en environnement virtuel}
			...
			\begin{mysubsection}[sse-sota-LaCommunicationImpliciteEtExplicite]{La communication implicite et explicite}
				...
				\begin{mysubsubsection}[sss-sota-LInterReferencement]{L'inter-référencement}
					...
					Afin de résoudre cette problématique, \mycite[author]{Chastine-2007a} se propose, dans un contexte de collaboration distante, d'utiliser des techniques de réalité augmentée pour désigner les éléments inter-référencés \myref*{fig-sota-InterReferencementVisuelProposeParChastineALAideDeTechniquesDeRealiteAugmentee}.
					Dans une étude l'année suivante, \mycite[author]{Chastine-2008} montre que les techniques qu'il propose pour améliorer l'inter-référencement permettent de limiter les ambigüités et d'améliorer les performances globales du groupe.
					...
					Cet ensemble de connaissances concernant l'état actuel de chacun des collaborateurs constitue la conscience de la présence.
					Cette notion sera vue dans la section suivante.
				\end{mysubsubsection}
				\begin{mysubsubsection}[sss-sota-LaPresenceDeGroupe]{La présence de groupe}
				\end{mysubsubsection}
			\end{mysubsection}
