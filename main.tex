	...
	\begin{mychapter}[cha-ProtocoleExperimental]{Protocole expérimental}
		\begin{mysection}[sec-pro-DispositifExperimental]{Dispositif expérimental}
			...
			\begin{mysubsection}[sse-pro-PresentationsDesMolecules]{Présentation des molécules}
				...
				\end{mysubsubsection}
			\end{mysubsection}
			\begin{mysubsection}[sse-pro-OutilsDeManipulation]{Outils de manipulation}
				...
				Ce sera par l'intermédiaire d'un outil \mytool{grab} dans la première expérimentation \myref*{sss-pro-exp1-Materiel}, par une souris~\myThreeD dans la seconde \myref*{sss-pro-exp2-Materiel} puis par une simple souris \myUSB dans la dernière expérimentation \myref*{sss-pro-exp4-Materiel}.
			\end{mysubsection}
