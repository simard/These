...
\begin{document}
	...
	\begin{myabstract}[english]
		...
		At first, we study different closely-coupled collaborative configurations through three experiments.
	...
	\begin{mychapter}[cha-sota-EtudeBibliographique]{Étude bibliographique}
		...
		\begin{mysection}[sec-sota-ContexteDeTravail-LaModelisationMoleculaire]{Contexte de travail : la modélisation moléculaire}
			...
			\begin{mysubsection}[sse-sota-PlateformesCollaborativesPourLaBiologieMoleculaire]{Plateformes collaboratives pour la biologie moléculaire}
				...
				Plus récemment, le projet \myeMinerals de \mycite[author]{Dove-2005} fournit une solution pour la collaboration entre biologistes (messagerie instantanée, vidéo-conférence, serveur centralisé, \myetc) comme on peut le voir sur la \myref{fig-sota-PlateformeDeCollaborationInterUniversiteProposeeParDove2005}.
				...
				Afin d'améliorer la communication, ils représentent les mains de chaque utilisateur dans l'environnement virtuel pour que chacun ait conscience des actions des partenaires \myref*{fig-sota-ManipulationCollaborativeDeMoleculeAvecRepresentationDesMainsDesParticipantsChastine2005}.
			...
			\end{mysubsection}
		\end{mysection}
		\begin{mysection}[sec-sota-ApprocheCollaborativePourLaResolutionDesTachesComplexes]{Approche collaborative pour la résolution des tâches complexes}
		...
		\begin{mysection}[sec-sota-CollaborationEnEnvironnementVirtuel]{Collaboration en environnement virtuel}
			...
			\begin{mysubsection}[sse-sota-CommunicationEnEnvironnementVirtuel]{Communication en environnement virtuel}
				...
				\begin{mysubsubsection}[sss-sota-CommunicationEnEnvironnementVirtuel-Grounding]{\myGrounding}
					Les participants doivent posséder un niveau de compréhension commun (même langue parlée, même base culturelle, même jargon, \myetc) afin de se comprendre \mycite{Dix-2004}.
...
vmd> set mysel [atomselect "top" "name C or name O or name N or name CA"]
	...
	\begin{mychapter}[cha-LaDynamiqueDeGroupe]{La dynamique de groupe}
		\begin{mysection}[sec-exp3-Introduction]{Introduction}
			...
			Selon la littérature en psychologie sociale, le travail en groupe provoque des modifications sur l'organisation et la structure \myref*{sec-sota-ApprocheCollaborativePourLaResolutionDesTachesComplexes} qu'on nomme \og dynamique de groupe \fg.
		...
		\begin{mysection}[sec-exp3-CollaborationDeGroupe]{Collaboration de groupe}
			\begin{mysubsection}[sse-exp3-TravauxExistants]{Travaux existants}
				Nous avons déjà vu, dans la \myref{sec-sota-ApprocheCollaborativePourLaResolutionDesTachesComplexes}, les dynamiques de groupe qui se mettent en place lors d'un travail en collaboration.
	...
	\begin{mychapter}[cha-TravailCollaboratifAssisteParHaptique]{Travail collaboratif assisté par haptique}
		...
		\begin{mysection}[sec-exp4-AssistanceHaptiquePourLaCommunication]{Assistance haptique pour la communication}
			...
			\begin{mysubsection}[sse-exp4-TravauxExistants]{Travaux existants}
				...
				Récemment, \mycite[author]{Ullah-2011} s'est intéressé à l'influence de la communication haptique sur le sentiment de présence et sur la conscience périphérique \myref*{sec-sota-ApprocheCollaborativePourLaResolutionDesTachesComplexes}.
