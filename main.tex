...
\begin{document}
	...
	\begin{myabstract}[french]
		...
		Les résultats mettent en avant de nombreux \myglos*{glo-ConflitDeCoordination} liés à des problèmes de communication.

		Sur la base de ces résultats, des outils ont été proposés pour favoriser et améliorer la communication et la coordination haptique.
		Une dernière expérimentation faisant intervenir des biologistes, montre la pertinence de la communication haptique pour améliorer la coordination.
