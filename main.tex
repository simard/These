	...
	\begin{mychapter}[cha-sota-EtudeBibliographique]{Étude bibliographique}
		...
		\begin{mysection}[sec-sota-ContexteDeTravail-LaModelisationMoleculaire]{Contexte de travail : la modélisation moléculaire}
			...
			\begin{mysubsection}[sse-sota-PlateformesCollaborativesPourLaBiologieMoleculaire]{Plateformes collaboratives pour la biologie moléculaire}
				...
				Parmi les applications collaboratives de biologie moléculaire, \mycite[author]{Chastine-2005} sont les premiers à s'intéresser aux problèmes de communication entre les sujets \myref*{sss-sota-LaConscienceDeGroupe}.
		...
		\begin{mysection}[sec-sota-CollaborationEnEnvironnementVirtuel]{Collaboration en environnement virtuel}
			...
			\begin{mysubsection}[sse-sota-OutilsDeLaCommunicationDeGroupe]{Outils de la communication de groupe}
				...
				\begin{mysubsubsection}[sss-sota-LaConscienceDeGroupe]{La conscience de groupe}
					La conscience de groupe, également appelée \myawareness, a été définie par \mycite[author]{Dourish-1992}.
					\begin{myquote}[english]
					...
					La conscience des autres partenaires peut concerner aussi bien l'action réalisée, la position spatiale (réelle ou virtuelle) ou encore des informations durables sur un collaborateur (âge, sexe, spécialité, culture, \myetc) \mycite{Cockburn-1999}.
					...
					Parmi tous ces types de conscience périphérique, seule la conscience de l'espace de travail nécessite une mise à jour en temps-réel des informations environnantes par les membres d'un groupe, surtout dans le cadre d'une collaboration synchrone.
					Chaque collaborateur diffuse des informations le concernant (action en cours, position du curseur, \myetc) de manière consciente ou inconsciente.
					Pour les informations diffusées de manière inconsciente, elles seront plus ou moins visibles des autres collaborateurs qui seront attentifs ou non à ces actions.
					Cependant, lorsqu'un utilisateur souhaite diffuser une information, il faut également qu'il puisse être sûr que l'information a été comprise correctement.
				...
				\end{mysubsubsection}
			\end{mysubsection}
			\begin{mysubsection}[sse-sota-MecanismesDeCommunication]{Mécanismes de communication}
				...
				\begin{description}
					...
					\item[\myFeedthrough] C'est un canal de communication indirect où les participants communiquent entre eux par l'intermédiaire des artefacts \mycite{Dix-2004}.
			...
			\begin{mysubsection}[sse-sota-StrategiesDeCollaboration]{Stratégies de collaboration}
				...
				\begin{mysubsubsection}[sss-sota-CollaborationParManipulateurEtObservateur]{Collaboration par manipulateur et observateur}
					...
					\mycite[author]{Chastine-2007} aborde cette problématique dans ces travaux de thèse : il nomme ce concept inter-référencement \myref*{sss-sota-LaConscienceDeGroupe}.
