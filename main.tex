...
vmd> set mysel [atomselect "top" "name C or name O or name N or name CA"]
	...
	\begin{mychapter}[cha-LaDynamiqueDeGroupe]{La dynamique de groupe}
		\begin{mysection}[sec-exp3-Introduction]{Introduction}
			...
			Ce chapitre constitue notre première étude sur le travail collaboratif concernant des groupes d'utilisateurs\footnote{On considère qu'un groupe est constitué au minimum de trois personnes \mycite{Bales-1950}.}.
		...
		\begin{mysection}[sec-exp3-CollaborationDeGroupe]{Collaboration de groupe}
			\begin{mysubsection}[sse-exp3-TravauxExistants]{Travaux existants}
				...
				Il aborde en particulier les travaux de Elton \myname{Mayo} au sein de l'entreprise \myHawthorne qui constitue une des premières études sur la dynamique de groupe.
				...
				Les résultats de cette étude concernant les groupes de taille importante sont actuellement utilisés dans les techniques modernes de \myemph{management} \mycite{Wood-2004}.
				...
				C'est \mycite[author]{Bales-1950} qui proposent les premières analyses sur ces groupes de \mynum{3} à une vingtaine de partenaires.
				...
				Cependant, \mycite[author]{Zajonc-1965} montre que les groupes seront performants sur des tâches simples mais peu performants sur des tâches complexes.
			...
			\begin{mysubsection}[sse-exp3-Objectifs]{Objectifs}
				...
				Jusqu'à présent, nous avons seulement été confrontés à des \myglos*{glo-Binome}.
				...
				Étant donné les résultats obtenus dans nos précédentes études, nous devrions observer une amélioration des performances pour les groupes (quatre utilisateurs) par rapport aux \myglos*{glo-Binome} sur un scénario nécessitant une collaboration étroitement couplée.
				...
				Étant donné la coordination nécessaire demandée par la tâche, nous pensons que les conclusions obtenues seront différentes de celles obtenues par \mycite[author]{Zajonc-1965} dans le cadre d'une tâche à faible couplage.
				En effet, nous avons vu précédemment que la configuration \myglos*{glo-Bimanuel} menait à une surcharge cognitive difficile à traiter par les sujets et la coordination nécessaire devrait donner un avantage aux groupes restreints.
				...
				Nous émettons l'hypothèse que ces meneurs vont également apparaître dans le cadre d'une collaboration étroitement couplée.

				Finalement, nous souhaitons proposer une solution pour limiter les \myglos*{glo-ConflitDeCoordination} qui devraient être plus nombreux dans le cas de groupes restreints.
				...
				De plus, si l'hypothèse précédente se vérifie, la période de \mybrainstorming devrait permettre d'identifier plus rapidement le ou les meneurs du groupe.
			\end{mysubsection}
		\end{mysection}
