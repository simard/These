...
\begin{document}
	...
	%Assistance haptique pour le travail collaboratif sur des tâches de manipulation moléculaire à fort couplage
	%Communication haptique pour la déformation moléculaire à fort couplage en collaboration
	\section*{Résumé du sujet}
	Le \myemph{docking} moléculaire est une tâche très complexe faisant intervenir des experts de différentes spécialités.
