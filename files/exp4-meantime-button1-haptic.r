...
dat = dat.exp4.ope
bp = boxplot(dat$mean.time.button.1 ~ dat$haptic, plot=FALSE)
...
wilcox = wilcox.test(dat$mean.time.button.1 ~ dat$haptic, paired = TRUE)
...
pop.a = dat[ dat$haptic == "False", ]$mean.time.button.1
pop.b = dat[ dat$haptic == "True", ]$mean.time.button.1
