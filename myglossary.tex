...
{%
	...
	description={En anglais, \myemph{social facilitation}, phénomène de groupe défini dans la \myref{sse-sota-LaFacilitationSociale}},
...
{%
	...
	plural={\textsc{icm}},
	firstplural={\textsc{icm} (\myemph{Iterated Conditional Modes})},%
...
{%
	name={meneur},%
	description={En anglais, \myemph{leader}, personne qui prend les décisions dans un groupe afin d'atteindre des objectifs communs (voir \myglos{glo-Suiveur})},%
	plural={meneurs}%
}
...
{%
	...
	description={La théorie \textsc{mrt} (pour \myemph{Multiple Resource Theory}), élaborée par \mycite[author]{Wickens-1984}, propose un modèle pour la gestion des charges de travail d'un humain}
}
% NNN
\mynewacro{acr-NAMD}%
{%
...
{%
	...
	description={En anglais, \myemph{social loafing}, phénomène de groupe défini dans la \myref{sse-sota-LaParesseSociale}},
...
{%
	name={suiveur},%
	description={En anglais, \myemph{follower}, personne qui se laisse diriger dans un groupe afin d'atteindre des objectifs communs (voir \myglos{glo-Meneur})},%
	plural={suiveurs}%
}
\mynewacro{acr-SUS}%
{%
