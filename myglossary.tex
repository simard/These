...
{%
	name={\textsc{udp}},
	first={protocole de datagramme utilisateur (\textsc{udp} pour \myemph{User Datagram protocol})},%
	plural={\textsc{afm}s},%
	firstplural={protocoles de datagramme utilisateur (\textsc{afm} pour \myemph{User Datagram protocol})},%
